...
export const auditControls: AuditControl[] = [
  ...
  // Section 8.3 - Key Vault
  {
    ...
    framework: 'CIS Benchmark',
    category: 'encryption',
    whatToCheck: 'Verify all Key Vault keys have expiration dates set.',
    ...
    expectedConfig: 'All keys have expiration date set. Key rotation process documented.',
    commonMisconfigs: [
  ...
  },
  {
    ...
    framework: 'CIS Benchmark',
    category: 'encryption',
    whatToCheck: 'Verify all Key Vault secrets have expiration dates set.',
    ...
    expectedConfig: 'All secrets have expiration date set. Secret rotation process documented.',
    commonMisconfigs: [
  ...
  {
    id: 'CIS-AZ-8.3.7',
    title: 'Ensure Key Rotation Reminders Are Configured',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'encryption',
    whatToCheck: 'Verify Key Vault has rotation policies or reminders configured.',
    whyItMatters: 'Rotation reminders ensure keys and secrets are rotated before they become a security risk.',
    consoleSteps: [
      'Go to Key Vault → Keys',
      'Check rotation policy for each key',
      'Verify notification settings',
    ],
    expectedConfig: 'Rotation policies configured. Notifications sent before expiration.',
    commonMisconfigs: [
      'No rotation policies',
      'No expiration notifications',
      'Manual rotation only',
    ],
    fixHint: 'Configure key rotation policies with automatic rotation or notifications before expiration.',
  },
  {
    id: 'CIS-AZ-8.3.8',
