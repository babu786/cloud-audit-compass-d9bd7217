...
export const auditControls: AuditControl[] = [
  ...
  },
  {
    ...
    framework: 'CIS Benchmark',
    category: 'encryption',
    whatToCheck: 'Verify that VM disks for critical VMs use Customer-Supplied Encryption Keys (CSEK) instead of Google-managed keys.',
    whyItMatters: 'By default, Google encrypts all data at rest using Google-managed encryption keys. For additional control over encryption, particularly for sensitive workloads, organizations can provide their own encryption keys. This gives complete control over the key lifecycle and allows meeting specific compliance requirements.',
    consoleSteps: [
      'Go to Compute Engine in GCP Console',
      'Click on Disks in the left menu',
      'For each disk, click to view details',
      'Check the Encryption field - verify it shows "Customer-supplied" for critical disks',
      'Alternatively, check VM instance details for attached disks encryption type',
    ],
    cliCheck: 'gcloud compute disks describe [DISK_NAME] --zone=[ZONE] --format="get(diskEncryptionKey)"',
    expectedConfig: 'Critical VM disks should have diskEncryptionKey.sha256 populated, indicating CSEK is in use.',
    commonMisconfigs: [
      'Using default Google-managed encryption for all disks including sensitive workloads',
      'CSEK not properly secured or rotated',
      'No policy defining which workloads require CSEK',
      'CSEK lost or not properly backed up, making data unrecoverable',
    ],
    fixHint: 'Create new disks with --csek-key-file parameter specifying your encryption key. Note: existing disks cannot be converted - you must create new encrypted disks and migrate data.',
  },
  {
    id: 'CIS-GCP-4.8',
  ...
  // =============================================
  // AWS CIS MONITORING ADDITIONAL CONTROLS (5.x)
  // =============================================
  {
    id: 'CIS-AWS-5.6',
    ...
    framework: 'CIS Benchmark',
    category: 'logging',
    whatToCheck: 'Verify CloudWatch alarms exist for console authentication failures.',
    whyItMatters: 'Monitoring authentication failures helps detect brute force and credential stuffing attacks.',
    consoleSteps: [
      'Go to CloudWatch > Alarms',
      'Search for console authentication failure alarms',
      'Verify metric filter exists for ConsoleLogin with Failed',
      'Check alarm threshold and notification settings',
    ],
    cliCheck: 'aws logs describe-metric-filters --log-group-name <cloudtrail-log-group> --query "metricFilters[?filterPattern==\'{ ($.eventName = ConsoleLogin) && ($.errorMessage = \"Failed authentication\") }\']"',
    expectedConfig: 'Metric filter and alarm configured for console authentication failures.',
    commonMisconfigs: [
      'No metric filter for authentication failures',
      'Alarm not configured',
      'No SNS notification',
    ],
    fixHint: 'Create CloudWatch metric filter for ConsoleLogin failures and configure alarm with SNS notification.',
  },
  {
    id: 'CIS-AWS-5.7',
    ...
    framework: 'CIS Benchmark',
    category: 'logging',
    whatToCheck: 'Verify CloudWatch alarms exist for KMS key disabling or deletion scheduling.',
    whyItMatters: 'Unauthorized key disabling or deletion can lead to permanent data loss.',
    consoleSteps: [
      'Go to CloudWatch > Alarms',
      'Search for KMS key disable/delete alarms',
      'Verify metric filter exists for DisableKey and ScheduleKeyDeletion',
      'Check alarm threshold and notification settings',
    ],
    cliCheck: 'aws logs describe-metric-filters --log-group-name <cloudtrail-log-group> --query "metricFilters[?filterPattern==\'{ ($.eventSource = kms.amazonaws.com) && (($.eventName = DisableKey) || ($.eventName = ScheduleKeyDeletion)) }\']"',
    expectedConfig: 'Metric filter and alarm for KMS DisableKey and ScheduleKeyDeletion events.',
    commonMisconfigs: [
      'No monitoring for key lifecycle events',
      'Alarm threshold too high',
      'Missing ScheduleKeyDeletion monitoring',
    ],
    fixHint: 'Create CloudWatch metric filter for KMS DisableKey and ScheduleKeyDeletion events with alarm.',
  },
  {
    id: 'CIS-AWS-5.8',
    ...
    framework: 'CIS Benchmark',
    category: 'logging',
    whatToCheck: 'Verify CloudWatch alarms exist for S3 bucket policy changes.',
    whyItMatters: 'Unauthorized bucket policy changes can expose sensitive data publicly.',
    consoleSteps: [
      'Go to CloudWatch > Alarms',
      'Search for S3 bucket policy change alarms',
      'Verify metric filter for PutBucketPolicy, DeleteBucketPolicy events',
      'Check alarm threshold and notification settings',
    ],
    cliCheck: 'aws logs describe-metric-filters --log-group-name <cloudtrail-log-group> --query "metricFilters[?filterPattern==\'{ ($.eventSource = s3.amazonaws.com) && (($.eventName = PutBucketPolicy) || ($.eventName = DeleteBucketPolicy)) }\']"',
    expectedConfig: 'Metric filter and alarm for S3 bucket policy modification events.',
    commonMisconfigs: [
      'No S3 policy change monitoring',
      'Missing DeleteBucketPolicy tracking',
      'Alarm not notifying security team',
    ],
    fixHint: 'Create CloudWatch metric filter for S3 bucket policy events and configure alarm.',
  },
  {
    id: 'CIS-AWS-5.9',
    ...
    framework: 'CIS Benchmark',
    category: 'logging',
    whatToCheck: 'Verify CloudWatch alarms exist for AWS Config configuration changes.',
    whyItMatters: 'Changes to Config could disable compliance monitoring and hide policy violations.',
    consoleSteps: [
      'Go to CloudWatch > Alarms',
      'Search for Config configuration change alarms',
      'Verify metric filter for StopConfigurationRecorder, DeleteConfigurationRecorder',
      'Check alarm threshold and notification settings',
    ],
    cliCheck: 'aws logs describe-metric-filters --log-group-name <cloudtrail-log-group> --query "metricFilters[?filterPattern==\'{ ($.eventSource = config.amazonaws.com) && (($.eventName = StopConfigurationRecorder) || ($.eventName = DeleteConfigurationRecorder)) }\']"',
    expectedConfig: 'Metric filter and alarm for AWS Config recorder stop/delete events.',
    commonMisconfigs: [
      'No Config change monitoring',
      'Missing DeleteConfigurationRecorder tracking',
      'Alarm not configured',
    ],
    fixHint: 'Create CloudWatch metric filter for Config recorder events and configure alarm.',
  },
  {
    id: 'CIS-AWS-5.12',
    ...
    framework: 'CIS Benchmark',
    category: 'logging',
    whatToCheck: 'Verify CloudWatch alarms exist for network gateway changes.',
    whyItMatters: 'Unauthorized gateway changes can expose internal networks to the internet.',
    consoleSteps: [
      'Go to CloudWatch > Alarms',
      'Search for network gateway change alarms',
      'Verify metric filter for CreateCustomerGateway, DeleteCustomerGateway, AttachInternetGateway',
      'Check alarm threshold and notification settings',
    ],
    cliCheck: 'aws logs describe-metric-filters --log-group-name <cloudtrail-log-group> --query "metricFilters[?filterPattern==\'{ ($.eventName = CreateCustomerGateway) || ($.eventName = DeleteCustomerGateway) || ($.eventName = AttachInternetGateway) || ($.eventName = DetachInternetGateway) }\']"',
    expectedConfig: 'Metric filter and alarm for gateway creation, deletion, and attachment events.',
    commonMisconfigs: [
      'No gateway monitoring',
      'Missing internet gateway tracking',
      'NAT gateway changes not monitored',
    ],
    fixHint: 'Create CloudWatch metric filter for gateway lifecycle events and configure alarm.',
  },
  {
    id: 'CIS-AWS-5.13',
    ...
    framework: 'CIS Benchmark',
    category: 'logging',
    whatToCheck: 'Verify CloudWatch alarms exist for route table changes.',
    whyItMatters: 'Unauthorized route changes can redirect traffic or expose internal resources.',
    consoleSteps: [
      'Go to CloudWatch > Alarms',
      'Search for route table change alarms',
      'Verify metric filter for CreateRoute, DeleteRoute, ReplaceRoute events',
      'Check alarm threshold and notification settings',
    ],
    cliCheck: 'aws logs describe-metric-filters --log-group-name <cloudtrail-log-group> --query "metricFilters[?filterPattern==\'{ ($.eventName = CreateRoute) || ($.eventName = CreateRouteTable) || ($.eventName = ReplaceRoute) || ($.eventName = DeleteRoute) }\']"',
    expectedConfig: 'Metric filter and alarm for route table modification events.',
    commonMisconfigs: [
      'No route table monitoring',
      'Missing ReplaceRoute tracking',
      'Alarm threshold too high',
    ],
    fixHint: 'Create CloudWatch metric filter for route table events and configure alarm.',
  },

  // =============================================
  // AWS CIS STORAGE ADDITIONAL CONTROLS (3.x)
  // =============================================
  {
    id: 'CIS-AWS-3.2.4',
    title: 'Ensure Multi-AZ deployments are used for enhanced RDS availability',
    severity: 'Medium',
    cloudProvider: 'AWS',
    framework: 'CIS Benchmark',
    category: 'storage',
    whatToCheck: 'Verify RDS instances use Multi-AZ deployment for high availability.',
    whyItMatters: 'Multi-AZ provides automatic failover and data redundancy for database availability.',
    consoleSteps: [
      'Go to RDS > Databases',
      'Select each database instance',
      'Check Multi-AZ deployment status in Configuration tab',
      'Verify standby instance location',
    ],
    cliCheck: 'aws rds describe-db-instances --query "DBInstances[*].{ID:DBInstanceIdentifier,MultiAZ:MultiAZ,Engine:Engine}"',
    expectedConfig: 'MultiAZ: true for production database instances.',
    commonMisconfigs: [
      'Production databases without Multi-AZ',
      'Multi-AZ disabled to save costs',
      'Only dev/test databases with Multi-AZ',
    ],
    fixHint: 'aws rds modify-db-instance --db-instance-identifier <instance-id> --multi-az --apply-immediately',
  },
  {
    id: 'CIS-AWS-3.3.1',
    title: 'Ensure EFS file system encryption is enabled',
    severity: 'High',
    cloudProvider: 'AWS',
    framework: 'CIS Benchmark',
    category: 'encryption',
    whatToCheck: 'Verify EFS file systems have encryption at rest enabled.',
    whyItMatters: 'EFS encryption protects data at rest from unauthorized access to underlying storage.',
    consoleSteps: [
      'Go to EFS > File systems',
      'Select each file system',
      'Check Encrypted status in General settings',
      'Verify KMS key used for encryption',
    ],
    cliCheck: 'aws efs describe-file-systems --query "FileSystems[*].{ID:FileSystemId,Name:Name,Encrypted:Encrypted,KmsKeyId:KmsKeyId}"',
    expectedConfig: 'Encrypted: true with KMS key configured for each EFS file system.',
    commonMisconfigs: [
      'EFS created without encryption',
      'Using AWS managed key instead of CMK',
      'Encryption not enabled at creation time',
    ],
    fixHint: 'EFS encryption must be enabled at creation time. Create new encrypted file system and migrate data.',
  },

  // =============================================
  // AWS CIS NETWORKING ADDITIONAL CONTROLS (6.x)
  // =============================================
  {
    id: 'CIS-AWS-6.1.2',
    ...
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify CIFS/SMB access is restricted to trusted IP ranges only.',
    whyItMatters: 'CIFS/SMB protocols are common attack vectors and should be restricted to known networks.',
    consoleSteps: [
      'Go to VPC > Security Groups',
      'Search for security groups allowing ports 445 or 139',
      'Review source IP ranges for SMB/CIFS rules',
      'Ensure only trusted networks are allowed',
    ],
    cliCheck: 'aws ec2 describe-security-groups --query "SecurityGroups[?IpPermissions[?FromPort==`445` || FromPort==`139`]]"',
    expectedConfig: 'CIFS/SMB ports (445, 139) restricted to specific trusted CIDR ranges only.',
    commonMisconfigs: [
      'CIFS open to 0.0.0.0/0',
      'SMB accessible from internet',
      'Overly permissive source ranges',
    ],
    fixHint: 'Restrict security group rules for ports 445 and 139 to specific trusted CIDR ranges.',
  },
  {
    id: 'CIS-AWS-6.4',
    ...
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify no security groups allow IPv6 ::/0 ingress to SSH (22) or RDP (3389).',
    whyItMatters: 'IPv6 ::/0 allows any IPv6 address to access administrative ports, enabling attacks.',
    consoleSteps: [
      'Go to VPC > Security Groups',
      'Review each security group\'s inbound rules',
      'Check for ::/0 source on ports 22 and 3389',
      'Remove or restrict any such rules',
    ],
    cliCheck: 'aws ec2 describe-security-groups --query "SecurityGroups[?IpPermissions[?Ipv6Ranges[?CidrIpv6==\'::/0\'] && (FromPort==`22` || FromPort==`3389`)]]"',
    expectedConfig: 'No security group rules allow ::/0 ingress to ports 22 or 3389.',
    commonMisconfigs: [
      'IPv6 ::/0 allowed on SSH',
      'IPv6 ::/0 allowed on RDP',
      'IPv6 not reviewed when IPv4 is restricted',
    ],
    fixHint: 'Remove or restrict ::/0 IPv6 source rules on ports 22 and 3389 to specific CIDR ranges.',
  },
  {
    id: 'CIS-AWS-6.6',
    title: 'Ensure VPC peering routing tables are least access',
    severity: 'Medium',
    cloudProvider: 'AWS',
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify VPC peering routes are configured for least privilege access.',
    whyItMatters: 'Overly permissive peering routes can expose resources across VPC boundaries.',
    consoleSteps: [
      'Go to VPC > Route Tables',
      'Identify routes pointing to VPC peering connections',
      'Verify routes use specific CIDR ranges, not entire VPC CIDRs',
      'Check both VPCs in peering relationship',
    ],
    cliCheck: 'aws ec2 describe-route-tables --query "RouteTables[?Routes[?VpcPeeringConnectionId!=null]]"',
    expectedConfig: 'VPC peering routes target specific subnets, not entire VPC CIDR blocks.',
    commonMisconfigs: [
      'Route to entire peered VPC CIDR',
      'Bidirectional full access',
      'Unnecessary routes to all subnets',
    ],
    fixHint: 'Update route tables to use specific subnet CIDRs instead of full VPC CIDR for peering routes.',
  },

  // =============================================
  // AZURE CIS APP SERVICE DEPLOYMENT SLOTS (2.2.x)
  // =============================================
  {
    id: 'CIS-AZ-2.2.1',
    title: 'Ensure App Service Deployment Slots use latest supported Java version',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'compute',
    whatToCheck: 'Verify deployment slots running Java use the latest supported version.',
    whyItMatters: 'Older Java versions may have security vulnerabilities and lack security patches.',
    consoleSteps: [
      'Go to App Services > select app > Deployment slots',
      'Select each slot > Configuration > General settings',
      'Check Java version setting',
      'Verify it matches the latest supported version',
    ],
    cliCheck: 'az webapp deployment slot list --name <app-name> --resource-group <rg> --query "[].{name:name,javaVersion:siteConfig.javaVersion}"',
    expectedConfig: 'Java version set to latest supported LTS version (e.g., Java 17 or 21).',
    commonMisconfigs: [
      'Using deprecated Java versions',
      'Inconsistent versions across slots',
      'EOL Java versions in production',
    ],
    fixHint: 'az webapp config set --name <app-name> --resource-group <rg> --slot <slot-name> --java-version <latest>',
  },
  {
    id: 'CIS-AZ-2.2.2',
    title: 'Ensure App Service Deployment Slots use latest supported Python version',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'compute',
    whatToCheck: 'Verify deployment slots running Python use the latest supported version.',
    whyItMatters: 'Older Python versions may have security vulnerabilities and lack security patches.',
    consoleSteps: [
      'Go to App Services > select app > Deployment slots',
      'Select each slot > Configuration > General settings',
      'Check Python version setting',
      'Verify it matches the latest supported version',
    ],
    cliCheck: 'az webapp deployment slot list --name <app-name> --resource-group <rg> --query "[].{name:name,pythonVersion:siteConfig.pythonVersion}"',
    expectedConfig: 'Python version set to latest supported version (e.g., Python 3.11 or 3.12).',
    commonMisconfigs: [
      'Using Python 2.x',
      'Outdated Python 3.x versions',
      'Inconsistent versions across slots',
    ],
    fixHint: 'az webapp config set --name <app-name> --resource-group <rg> --slot <slot-name> --python-version <latest>',
  },
  {
    id: 'CIS-AZ-2.2.3',
    title: 'Ensure App Service Deployment Slots use latest supported PHP version',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'compute',
    whatToCheck: 'Verify deployment slots running PHP use the latest supported version.',
    whyItMatters: 'Older PHP versions may have security vulnerabilities and lack security patches.',
    consoleSteps: [
      'Go to App Services > select app > Deployment slots',
      'Select each slot > Configuration > General settings',
      'Check PHP version setting',
      'Verify it matches the latest supported version',
    ],
    cliCheck: 'az webapp deployment slot list --name <app-name> --resource-group <rg> --query "[].{name:name,phpVersion:siteConfig.phpVersion}"',
    expectedConfig: 'PHP version set to latest supported version (e.g., PHP 8.2 or 8.3).',
    commonMisconfigs: [
      'Using PHP 7.x or earlier',
      'EOL PHP versions',
      'Inconsistent versions across slots',
    ],
    fixHint: 'az webapp config set --name <app-name> --resource-group <rg> --slot <slot-name> --php-version <latest>',
  },
  {
    id: 'CIS-AZ-2.2.4',
    title: 'Ensure App Service Deployment Slots have Basic Authentication disabled',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify basic authentication is disabled for deployment slot publishing and SCM.',
    whyItMatters: 'Basic auth uses static credentials that can be compromised or brute-forced.',
    consoleSteps: [
      'Go to App Services > select app > Deployment slots',
      'Select each slot > Configuration > General settings',
      'Check SCM Basic Auth and FTP Basic Auth settings',
      'Verify both are set to Off',
    ],
    cliCheck: 'az webapp deployment slot list --name <app-name> --resource-group <rg> --query "[].{name:name,scmBasicAuth:siteConfig.scmMinTlsVersion}"',
    expectedConfig: 'basicPublishingCredentialsPolicies set to disallow basic auth for both FTP and SCM.',
    commonMisconfigs: [
      'Basic auth enabled for convenience',
      'FTP basic auth allowed',
      'SCM basic auth allowed',
    ],
    fixHint: 'az resource update --resource-group <rg> --name scm --namespace Microsoft.Web --resource-type basicPublishingCredentialsPolicies --parent sites/<app-name>/slots/<slot> --set properties.allow=false',
  },
  {
    id: 'CIS-AZ-2.2.5',
    title: 'Ensure App Service Deployment Slots FTP deployments are Disabled',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify FTP state is set to Disabled or FTPS Only for deployment slots.',
    whyItMatters: 'FTP transmits credentials in clear text, FTPS or disabled is required for security.',
    consoleSteps: [
      'Go to App Services > select app > Deployment slots',
      'Select each slot > Configuration > General settings',
      'Check FTP state setting',
      'Verify it is set to Disabled or FTPS Only',
    ],
    cliCheck: 'az webapp deployment slot list --name <app-name> --resource-group <rg> --query "[].{name:name,ftpsState:siteConfig.ftpsState}"',
    expectedConfig: 'ftpsState set to Disabled or FtpsOnly (never AllAllowed).',
    commonMisconfigs: [
      'FTP allowed (AllAllowed)',
      'Plain FTP enabled',
      'FTPS not enforced',
    ],
    fixHint: 'az webapp config set --name <app-name> --resource-group <rg> --slot <slot-name> --ftps-state Disabled',
  },
  {
    id: 'CIS-AZ-2.2.6',
    title: 'Ensure App Service Deployment Slots use HTTP Version 2.0',
    severity: 'Low',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify HTTP 2.0 is enabled for deployment slots.',
    whyItMatters: 'HTTP/2 provides better performance and security features over HTTP/1.1.',
    consoleSteps: [
      'Go to App Services > select app > Deployment slots',
      'Select each slot > Configuration > General settings',
      'Check HTTP version setting',
      'Verify it is set to 2.0',
    ],
    cliCheck: 'az webapp deployment slot list --name <app-name> --resource-group <rg> --query "[].{name:name,http20Enabled:siteConfig.http20Enabled}"',
    expectedConfig: 'http20Enabled: true for all deployment slots.',
    commonMisconfigs: [
      'HTTP/1.1 only enabled',
      'HTTP/2 not configured',
      'Legacy protocol settings',
    ],
    fixHint: 'az webapp config set --name <app-name> --resource-group <rg> --slot <slot-name> --http20-enabled true',
  },
  {
    id: 'CIS-AZ-2.2.7',
    title: 'Ensure App Service Deployment Slots are set to HTTPS Only',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'encryption',
    whatToCheck: 'Verify HTTPS Only is enabled for all deployment slots.',
    whyItMatters: 'HTTPS Only ensures all traffic is encrypted, preventing man-in-the-middle attacks.',
    consoleSteps: [
      'Go to App Services > select app > Deployment slots',
      'Select each slot > Configuration > General settings',
      'Check HTTPS Only setting',
      'Verify it is enabled (On)',
    ],
    cliCheck: 'az webapp deployment slot list --name <app-name> --resource-group <rg> --query "[].{name:name,httpsOnly:httpsOnly}"',
    expectedConfig: 'httpsOnly: true for all deployment slots.',
    commonMisconfigs: [
      'HTTP allowed for testing',
      'HTTPS Only not enforced',
      'Mixed content issues not addressed',
    ],
    fixHint: 'az webapp update --name <app-name> --resource-group <rg> --slot <slot-name> --set httpsOnly=true',
  },
  {
    id: 'CIS-AZ-2.2.8',
    title: 'Ensure App Service Deployment Slots use minimum TLS 1.2',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'encryption',
    whatToCheck: 'Verify minimum TLS version is 1.2 or higher for deployment slots.',
    whyItMatters: 'TLS 1.0 and 1.1 have known vulnerabilities and should not be used.',
    consoleSteps: [
      'Go to App Services > select app > Deployment slots',
      'Select each slot > Configuration > General settings',
      'Check Minimum TLS Version setting',
      'Verify it is set to 1.2 or higher',
    ],
    cliCheck: 'az webapp deployment slot list --name <app-name> --resource-group <rg> --query "[].{name:name,minTlsVersion:siteConfig.minTlsVersion}"',
    expectedConfig: 'minTlsVersion: 1.2 or 1.3 for all deployment slots.',
    commonMisconfigs: [
      'TLS 1.0 allowed for legacy clients',
      'TLS 1.1 enabled',
      'Minimum TLS not configured',
    ],
    fixHint: 'az webapp config set --name <app-name> --resource-group <rg> --slot <slot-name> --min-tls-version 1.2',
  },
  {
    id: 'CIS-AZ-2.2.9',
    title: 'Ensure App Service Deployment Slots use end-to-end TLS encryption',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'encryption',
    whatToCheck: 'Verify end-to-end TLS is enabled between front-ends and workers.',
    whyItMatters: 'End-to-end TLS ensures traffic is encrypted throughout the entire request path.',
    consoleSteps: [
      'Go to App Services > select app > Deployment slots',
      'Select each slot > Configuration > General settings',
      'Check End-to-End TLS setting (if available)',
      'Verify TLS is enforced for backend connections',
    ],
    cliCheck: 'az webapp config show --name <app-name> --resource-group <rg> --slot <slot-name> --query "endToEndEncryptionEnabled"',
    expectedConfig: 'End-to-end TLS encryption enabled for deployment slots.',
    commonMisconfigs: [
      'Backend connections not encrypted',
      'End-to-end TLS not configured',
      'Mixed encryption paths',
    ],
    fixHint: 'Enable end-to-end TLS in App Service configuration or use Application Gateway with end-to-end TLS.',
  },
  {
    id: 'CIS-AZ-2.2.10',
    title: 'Ensure App Service Deployment Slots have Remote Debugging disabled',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'compute',
    whatToCheck: 'Verify remote debugging is disabled for all deployment slots.',
    whyItMatters: 'Remote debugging opens additional ports and can be exploited if left enabled.',
    consoleSteps: [
      'Go to App Services > select app > Deployment slots',
      'Select each slot > Configuration > General settings',
      'Check Remote debugging setting',
      'Verify it is set to Off',
    ],
    cliCheck: 'az webapp deployment slot list --name <app-name> --resource-group <rg> --query "[].{name:name,remoteDebuggingEnabled:siteConfig.remoteDebuggingEnabled}"',
    expectedConfig: 'remoteDebuggingEnabled: false for all deployment slots.',
    commonMisconfigs: [
      'Remote debugging left on after troubleshooting',
      'Enabled in production slots',
      'Auto-disabled timeout not working',
    ],
    fixHint: 'az webapp config set --name <app-name> --resource-group <rg> --slot <slot-name> --remote-debugging-enabled false',
  },
  {
    id: 'CIS-AZ-2.2.11',
    title: 'Ensure App Service Deployment Slots have Client Certificates enabled',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify incoming client certificates are enabled and required for deployment slots.',
    whyItMatters: 'Client certificates provide mutual TLS authentication for sensitive applications.',
    consoleSteps: [
      'Go to App Services > select app > Deployment slots',
      'Select each slot > Configuration > General settings',
      'Check Incoming client certificates setting',
      'Verify it is set to Require or Optional based on needs',
    ],
    cliCheck: 'az webapp deployment slot list --name <app-name> --resource-group <rg> --query "[].{name:name,clientCertEnabled:clientCertEnabled,clientCertMode:clientCertMode}"',
    expectedConfig: 'clientCertEnabled: true with clientCertMode: Required or RequireClientCert.',
    commonMisconfigs: [
      'Client certs not enabled',
      'Set to Ignore',
      'Optional when should be required',
    ],
    fixHint: 'az webapp update --name <app-name> --resource-group <rg> --slot <slot-name> --set clientCertEnabled=true clientCertMode=Required',
  },
  {
    id: 'CIS-AZ-2.2.12',
    title: 'Ensure App Service Deployment Slots use Managed Identity',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify system or user-assigned managed identity is configured for deployment slots.',
    whyItMatters: 'Managed identities eliminate the need for credentials in code and provide secure Azure resource access.',
    consoleSteps: [
      'Go to App Services > select app > Deployment slots',
      'Select each slot > Identity',
      'Check System assigned or User assigned identity',
      'Verify at least one identity type is enabled',
    ],
    cliCheck: 'az webapp identity show --name <app-name> --resource-group <rg> --slot <slot-name>',
    expectedConfig: 'System-assigned or user-assigned managed identity enabled.',
    commonMisconfigs: [
      'No managed identity configured',
      'Using connection strings instead',
      'Credentials stored in app settings',
    ],
    fixHint: 'az webapp identity assign --name <app-name> --resource-group <rg> --slot <slot-name>',
  },
  {
    id: 'CIS-AZ-2.2.13',
    title: 'Ensure App Service Deployment Slots have public network access disabled',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify public network access is disabled for deployment slots.',
    whyItMatters: 'Disabling public access reduces attack surface by requiring private endpoint connections.',
    consoleSteps: [
      'Go to App Services > select app > Deployment slots',
      'Select each slot > Networking',
      'Check Public network access setting',
      'Verify it is set to Disabled',
    ],
    cliCheck: 'az webapp deployment slot list --name <app-name> --resource-group <rg> --query "[].{name:name,publicNetworkAccess:siteConfig.publicNetworkAccess}"',
    expectedConfig: 'publicNetworkAccess: Disabled with private endpoints configured.',
    commonMisconfigs: [
      'Public access enabled',
      'IP restrictions used instead of private endpoints',
      'Public access for staging slots',
    ],
    fixHint: 'az webapp update --name <app-name> --resource-group <rg> --slot <slot-name> --set publicNetworkAccess=Disabled',
  },
  {
    id: 'CIS-AZ-2.2.14',
    title: 'Ensure App Service Deployment Slots are integrated with Virtual Network',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify VNet integration is configured for deployment slots.',
    whyItMatters: 'VNet integration allows secure access to backend resources without exposing them publicly.',
    consoleSteps: [
      'Go to App Services > select app > Deployment slots',
      'Select each slot > Networking > VNet integration',
      'Check if VNet is configured',
      'Verify subnet is properly delegated',
    ],
    cliCheck: 'az webapp vnet-integration list --name <app-name> --resource-group <rg> --slot <slot-name>',
    expectedConfig: 'VNet integration configured with delegated subnet.',
    commonMisconfigs: [
      'No VNet integration',
      'Public endpoints for backend access',
      'Subnet not properly delegated',
    ],
    fixHint: 'az webapp vnet-integration add --name <app-name> --resource-group <rg> --slot <slot-name> --vnet <vnet-name> --subnet <subnet-name>',
  },
  {
    id: 'CIS-AZ-2.2.15',
    title: 'Ensure App Service Deployment Slots route all traffic through VNet',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify all outbound traffic is routed through VNet integration.',
    whyItMatters: 'Routing all traffic through VNet ensures consistent network security policy enforcement.',
    consoleSteps: [
      'Go to App Services > select app > Deployment slots',
      'Select each slot > Networking > VNet integration',
    ...
    cliCheck: 'az webapp config show --name <app-name> --resource-group <rg> --slot <slot-name> --query "vnetRouteAllEnabled"',
    expectedConfig: 'vnetRouteAllEnabled: true for VNet-integrated slots.',
    commonMisconfigs: [
      'Only RFC1918 traffic routed through VNet',
      'Internet traffic bypassing VNet',
      'Route All not enabled',
    ],
    fixHint: 'az webapp config set --name <app-name> --resource-group <rg> --slot <slot-name> --vnet-route-all-enabled true',
  },
  {
    id: 'CIS-AZ-2.2.16',
    title: 'Ensure App Service Deployment Slots have CORS configured properly',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify CORS is not set to allow all origins (*).',
    whyItMatters: 'Overly permissive CORS allows any website to make requests to your API.',
    consoleSteps: [
      'Go to App Services > select app > Deployment slots',
      'Select each slot > API > CORS',
      'Check Allowed Origins list',
      'Verify * is not present',
    ],
    cliCheck: 'az webapp cors show --name <app-name> --resource-group <rg> --slot <slot-name>',
    expectedConfig: 'CORS allowedOrigins contains specific domains, not wildcard (*).',
    commonMisconfigs: [
      'Wildcard (*) in allowed origins',
      'All origins allowed for development',
      'CORS not configured (defaults to allow all)',
    ],
    fixHint: 'az webapp cors remove --name <app-name> --resource-group <rg> --slot <slot-name> --allowed-origins "*" && az webapp cors add --allowed-origins https://yourdomain.com',
  },
  {
    id: 'CIS-AZ-2.2.17',
    title: 'Ensure App Service Deployment Slots use latest .NET version',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'compute',
    whatToCheck: 'Verify deployment slots running .NET use the latest supported version.',
    whyItMatters: 'Older .NET versions may have security vulnerabilities and lack security patches.',
    consoleSteps: [
      'Go to App Services > select app > Deployment slots',
      'Select each slot > Configuration > General settings',
      'Check .NET version setting',
      'Verify it matches the latest supported version',
    ],
    cliCheck: 'az webapp deployment slot list --name <app-name> --resource-group <rg> --query "[].{name:name,netFrameworkVersion:siteConfig.netFrameworkVersion}"',
    expectedConfig: '.NET version set to latest supported LTS version (e.g., .NET 8).',
    commonMisconfigs: [
      'Using deprecated .NET Framework versions',
      'Outdated .NET Core versions',
      'EOL versions in production',
    ],
    fixHint: 'az webapp config set --name <app-name> --resource-group <rg> --slot <slot-name> --net-framework-version v8.0',
  },

  // =============================================
  // AZURE CIS FUNCTION APP DEPLOYMENT SLOTS (2.4.x)
  // =============================================
  {
    id: 'CIS-AZ-2.4.1',
    title: 'Ensure Function App Deployment Slots have Basic Authentication disabled',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify basic authentication is disabled for Function App deployment slot publishing.',
    whyItMatters: 'Basic auth uses static credentials that can be compromised or brute-forced.',
    consoleSteps: [
      'Go to Function Apps > select app > Deployment slots',
      'Select each slot > Configuration > General settings',
      'Check SCM Basic Auth and FTP Basic Auth settings',
      'Verify both are set to Off',
    ],
    cliCheck: 'az functionapp deployment slot list --name <app-name> --resource-group <rg> --query "[].{name:name}"',
    expectedConfig: 'basicPublishingCredentialsPolicies set to disallow basic auth.',
    commonMisconfigs: [
      'Basic auth enabled',
      'FTP basic auth allowed',
      'SCM basic auth allowed',
  ...
  {
    id: 'CIS-AZ-2.4.2',
    title: 'Ensure Function App Deployment Slots FTP deployments are Disabled',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify FTP state is set to Disabled for Function App deployment slots.',
    whyItMatters: 'FTP transmits credentials in clear text and should be disabled.',
    consoleSteps: [
      'Go to Function Apps > select app > Deployment slots',
      'Select each slot > Configuration > General settings',
      'Check FTP state setting',
    ...
    cliCheck: 'az functionapp config show --name <app-name> --resource-group <rg> --slot <slot-name> --query "ftpsState"',
    expectedConfig: 'ftpsState: Disabled for Function App deployment slots.',
    commonMisconfigs: [
      'FTP allowed',
      'FTPS Only instead of Disabled',
      'Plain FTP enabled',
    ],
    fixHint: 'az functionapp config set --name <app-name> --resource-group <rg> --slot <slot-name> --ftps-state Disabled',
  },
  {
    id: 'CIS-AZ-2.4.3',
    title: 'Ensure Function App Deployment Slots use HTTP Version 2.0',
    severity: 'Low',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify HTTP 2.0 is enabled for Function App deployment slots.',
    whyItMatters: 'HTTP/2 provides better performance and security features.',
    consoleSteps: [
      'Go to Function Apps > select app > Deployment slots',
      'Select each slot > Configuration > General settings',
      'Check HTTP version setting',
    ...
    cliCheck: 'az functionapp config show --name <app-name> --resource-group <rg> --slot <slot-name> --query "http20Enabled"',
    expectedConfig: 'http20Enabled: true for all deployment slots.',
    commonMisconfigs: [
      'HTTP/1.1 only',
      'HTTP/2 not configured',
    ],
    fixHint: 'az functionapp config set --name <app-name> --resource-group <rg> --slot <slot-name> --http20-enabled true',
  },
  {
    id: 'CIS-AZ-2.4.4',
    title: 'Ensure Function App Deployment Slots are set to HTTPS Only',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'encryption',
    whatToCheck: 'Verify HTTPS Only is enabled for Function App deployment slots.',
    whyItMatters: 'HTTPS Only ensures all traffic is encrypted.',
    consoleSteps: [
      'Go to Function Apps > select app > Deployment slots',
      'Select each slot > Configuration > General settings',
      'Check HTTPS Only setting',
    ...
    cliCheck: 'az functionapp show --name <app-name> --resource-group <rg> --slot <slot-name> --query "httpsOnly"',
    expectedConfig: 'httpsOnly: true for all deployment slots.',
    commonMisconfigs: [
      'HTTP allowed',
      'HTTPS Only not enforced',
    ],
    fixHint: 'az functionapp update --name <app-name> --resource-group <rg> --slot <slot-name> --set httpsOnly=true',
  },
  {
    id: 'CIS-AZ-2.4.5',
    title: 'Ensure Function App Deployment Slots use minimum TLS 1.2',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'encryption',
    whatToCheck: 'Verify minimum TLS version is 1.2 for Function App deployment slots.',
    whyItMatters: 'TLS 1.0 and 1.1 have known vulnerabilities.',
    consoleSteps: [
      'Go to Function Apps > select app > Deployment slots',
      'Select each slot > Configuration > General settings',
      'Check Minimum TLS Version setting',
      'Verify it is set to 1.2',
    ],
    cliCheck: 'az functionapp config show --name <app-name> --resource-group <rg> --slot <slot-name> --query "minTlsVersion"',
    expectedConfig: 'minTlsVersion: 1.2 for all deployment slots.',
    commonMisconfigs: [
      'TLS 1.0 allowed',
      'TLS 1.1 enabled',
    ],
    fixHint: 'az functionapp config set --name <app-name> --resource-group <rg> --slot <slot-name> --min-tls-version 1.2',
  },
  {
    id: 'CIS-AZ-2.4.6',
    title: 'Ensure Function App Deployment Slots have Remote Debugging disabled',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'compute',
    whatToCheck: 'Verify remote debugging is disabled for Function App deployment slots.',
    whyItMatters: 'Remote debugging opens additional ports and can be exploited.',
    consoleSteps: [
      'Go to Function Apps > select app > Deployment slots',
      'Select each slot > Configuration > General settings',
      'Check Remote debugging setting',
    ...
    cliCheck: 'az functionapp config show --name <app-name> --resource-group <rg> --slot <slot-name> --query "remoteDebuggingEnabled"',
    expectedConfig: 'remoteDebuggingEnabled: false for all deployment slots.',
    commonMisconfigs: [
      'Remote debugging left on',
      'Enabled in production',
    ],
    fixHint: 'az functionapp config set --name <app-name> --resource-group <rg> --slot <slot-name> --remote-debugging-enabled false',
  },
  {
    id: 'CIS-AZ-2.4.7',
    title: 'Ensure Function App Deployment Slots have Client Certificates enabled',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify incoming client certificates are enabled for Function App deployment slots.',
    whyItMatters: 'Client certificates provide mutual TLS authentication.',
    consoleSteps: [
      'Go to Function Apps > select app > Deployment slots',
      'Select each slot > Configuration > General settings',
      'Check Client certificate mode',
      'Verify appropriate setting',
    ],
    cliCheck: 'az functionapp show --name <app-name> --resource-group <rg> --slot <slot-name> --query "{clientCertEnabled:clientCertEnabled,clientCertMode:clientCertMode}"',
    expectedConfig: 'clientCertEnabled: true with appropriate clientCertMode.',
    commonMisconfigs: [
      'Client certs not enabled',
      'Set to Ignore',
    ],
    fixHint: 'az functionapp update --name <app-name> --resource-group <rg> --slot <slot-name> --set clientCertEnabled=true',
  },
  {
    id: 'CIS-AZ-2.4.8',
    title: 'Ensure Function App Deployment Slots use Managed Identity',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify managed identity is configured for Function App deployment slots.',
    whyItMatters: 'Managed identities eliminate the need for credentials in code.',
    consoleSteps: [
      'Go to Function Apps > select app > Deployment slots',
      'Select each slot > Identity',
    ...
    cliCheck: 'az functionapp identity show --name <app-name> --resource-group <rg> --slot <slot-name>',
    expectedConfig: 'System-assigned or user-assigned managed identity enabled.',
    commonMisconfigs: [
      'No managed identity',
      'Using connection strings',
    ],
    fixHint: 'az functionapp identity assign --name <app-name> --resource-group <rg> --slot <slot-name>',
  },
  {
    id: 'CIS-AZ-2.4.9',
    title: 'Ensure Function App Deployment Slots have public network access disabled',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify public network access is disabled for Function App deployment slots.',
    whyItMatters: 'Disabling public access reduces attack surface.',
    consoleSteps: [
      'Go to Function Apps > select app > Deployment slots',
      'Select each slot > Networking',
    ...
    cliCheck: 'az functionapp show --name <app-name> --resource-group <rg> --slot <slot-name> --query "publicNetworkAccess"',
    expectedConfig: 'publicNetworkAccess: Disabled.',
    commonMisconfigs: [
      'Public access enabled',
      'No private endpoints',
    ],
    fixHint: 'az functionapp update --name <app-name> --resource-group <rg> --slot <slot-name> --set publicNetworkAccess=Disabled',
  },
  {
    id: 'CIS-AZ-2.4.10',
    title: 'Ensure Function App Deployment Slots are integrated with Virtual Network',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify VNet integration is configured for Function App deployment slots.',
    whyItMatters: 'VNet integration allows secure access to backend resources.',
    consoleSteps: [
      'Go to Function Apps > select app > Deployment slots',
      'Select each slot > Networking',
    ...
    cliCheck: 'az functionapp vnet-integration list --name <app-name> --resource-group <rg> --slot <slot-name>',
    expectedConfig: 'VNet integration configured.',
    commonMisconfigs: [
      'No VNet integration',
      'Public endpoints used',
    ],
    fixHint: 'az functionapp vnet-integration add --name <app-name> --resource-group <rg> --slot <slot-name> --vnet <vnet> --subnet <subnet>',
  },
  {
    id: 'CIS-AZ-2.4.11',
    title: 'Ensure Function App Deployment Slots route all traffic through VNet',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify all outbound traffic routes through VNet.',
    whyItMatters: 'Routing all traffic through VNet ensures security policy enforcement.',
    consoleSteps: [
      'Go to Function Apps > select app > Deployment slots',
      'Select each slot > Networking > VNet integration',
      'Check Route All',
    ...
    cliCheck: 'az functionapp config show --name <app-name> --resource-group <rg> --slot <slot-name> --query "vnetRouteAllEnabled"',
    expectedConfig: 'vnetRouteAllEnabled: true.',
    commonMisconfigs: [
      'Only RFC1918 routed',
      'Route All disabled',
    ],
    fixHint: 'az functionapp config set --name <app-name> --resource-group <rg> --slot <slot-name> --vnet-route-all-enabled true',
  },
  {
    id: 'CIS-AZ-2.4.12',
    title: 'Ensure Function App Deployment Slots have CORS configured properly',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify CORS is not set to allow all origins.',
    whyItMatters: 'Overly permissive CORS allows any website to access your API.',
    consoleSteps: [
      'Go to Function Apps > select app > Deployment slots',
      'Select each slot > API > CORS',
    ...
    cliCheck: 'az functionapp cors show --name <app-name> --resource-group <rg> --slot <slot-name>',
    expectedConfig: 'CORS allowedOrigins contains specific domains only.',
    commonMisconfigs: [
      'Wildcard (*) allowed',
      'All origins for development',
    ],
    fixHint: 'az functionapp cors remove --allowed-origins "*" && az functionapp cors add --allowed-origins https://yourdomain.com',
  },
  {
    id: 'CIS-AZ-2.4.13',
    title: 'Ensure Function App Deployment Slots use latest supported runtime version',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'compute',
    whatToCheck: 'Verify deployment slots use the latest supported Functions runtime.',
    whyItMatters: 'Older runtime versions may lack security patches.',
    consoleSteps: [
      'Go to Function Apps > select app > Deployment slots',
      'Select each slot > Configuration',
      'Check FUNCTIONS_EXTENSION_VERSION',
      'Verify latest version',
    ],
    cliCheck: 'az functionapp config appsettings list --name <app-name> --resource-group <rg> --slot <slot-name> --query "[?name==\'FUNCTIONS_EXTENSION_VERSION\']"',
    expectedConfig: 'FUNCTIONS_EXTENSION_VERSION set to ~4 or latest.',
    commonMisconfigs: [
      'Using deprecated runtime',
      'Pinned to old version',
    ],
    fixHint: 'az functionapp config appsettings set --name <app-name> --resource-group <rg> --slot <slot-name> --settings FUNCTIONS_EXTENSION_VERSION=~4',
  },

  // =============================================
  // AZURE CIS BATCH CONTROLS (15.x)
  // =============================================
  {
    id: 'CIS-AZ-15.1',
    title: 'Ensure Batch account uses customer-managed key for encryption',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'encryption',
    whatToCheck: 'Verify Batch account data is encrypted with customer-managed key.',
    whyItMatters: 'CMK provides greater control over encryption keys and meets compliance requirements.',
    consoleSteps: [
      'Go to Batch accounts > select account',
      'Check Encryption settings',
      'Verify Customer-managed key is configured',
      'Check Key Vault integration',
    ],
    cliCheck: 'az batch account show --name <account-name> --resource-group <rg> --query "encryption"',
    expectedConfig: 'encryption.keySource: Microsoft.KeyVault with keyVaultProperties configured.',
    commonMisconfigs: [
      'Using Microsoft-managed keys',
      'CMK not configured',
      'Key Vault not integrated',
    ],
    fixHint: 'az batch account create --name <name> --resource-group <rg> --encryption-key-source Microsoft.KeyVault --encryption-key-identifier <key-uri>',
  },
  {
    id: 'CIS-AZ-15.2',
    title: 'Ensure Batch pools disk encryption is enabled',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'encryption',
    whatToCheck: 'Verify Batch pool compute node disks are encrypted.',
    whyItMatters: 'Disk encryption protects data at rest on compute nodes.',
    consoleSteps: [
      'Go to Batch accounts > select account > Pools',
      'Select each pool',
      'Check disk encryption configuration',
      'Verify encryption targets include OsDisk and TemporaryDisk',
    ],
    cliCheck: 'az batch pool show --pool-id <pool-id> --account-name <account> --query "diskEncryptionConfiguration"',
    expectedConfig: 'diskEncryptionConfiguration.targets includes OsDisk and TemporaryDisk.',
    commonMisconfigs: [
      'Disk encryption not enabled',
      'Only OS disk encrypted',
      'Temp disk unencrypted',
    ],
    fixHint: 'Configure diskEncryptionConfiguration in pool creation with targets: OsDisk, TemporaryDisk.',
  },
  {
    id: 'CIS-AZ-15.3',
    title: 'Ensure local authentication for Batch is disabled',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify Batch account has shared key authentication disabled.',
    whyItMatters: 'Disabling local auth forces use of Azure AD, improving security.',
    consoleSteps: [
      'Go to Batch accounts > select account',
      'Check Properties > Authentication',
      'Verify Shared Key authentication is disabled',
      'Confirm Azure AD is required',
    ],
    cliCheck: 'az batch account show --name <account-name> --resource-group <rg> --query "allowedAuthenticationModes"',
    expectedConfig: 'allowedAuthenticationModes contains only AAD, not SharedKey.',
    commonMisconfigs: [
      'Shared key auth enabled',
      'Both auth modes allowed',
      'Local auth for convenience',
    ],
    fixHint: 'az batch account update --name <account> --resource-group <rg> --allowed-authentication-modes AAD',
  },
  {
    id: 'CIS-AZ-15.4',
    title: 'Ensure Private endpoints are configured for Batch accounts',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify Batch account has private endpoint connections.',
    whyItMatters: 'Private endpoints eliminate public internet exposure for Batch management.',
    consoleSteps: [
      'Go to Batch accounts > select account',
      'Go to Networking > Private endpoint connections',
      'Verify private endpoints exist',
      'Check connection state is Approved',
    ],
    cliCheck: 'az batch account show --name <account-name> --resource-group <rg> --query "privateEndpointConnections"',
    expectedConfig: 'privateEndpointConnections array contains approved connections.',
    commonMisconfigs: [
      'No private endpoints',
      'Connections pending approval',
      'Using public endpoints',
    ],
    fixHint: 'az network private-endpoint create --name <pe-name> --resource-group <rg> --vnet-name <vnet> --subnet <subnet> --private-connection-resource-id <batch-id> --group-id batchAccount',
  },
  {
    id: 'CIS-AZ-15.5',
    ...
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify Batch account public network access is disabled.',
    whyItMatters: 'Disabling public access ensures all traffic goes through private endpoints.',
    consoleSteps: [
      'Go to Batch accounts > select account',
      'Go to Networking',
      'Check Public network access setting',
    ...
    cliCheck: 'az batch account show --name <account-name> --resource-group <rg> --query "publicNetworkAccess"',
    expectedConfig: 'publicNetworkAccess: Disabled.',
    commonMisconfigs: [
      'Public access enabled',
      'Selected networks instead of disabled',
      'No network restrictions',
    ],
    fixHint: 'az batch account update --name <account> --resource-group <rg> --public-network-access Disabled',
  },
  {
    id: 'CIS-AZ-15.6',
    title: 'Ensure private DNS zones are configured for Batch private endpoints',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify private DNS zones are properly linked to Batch private endpoints.',
    whyItMatters: 'Private DNS ensures name resolution works correctly for private endpoints.',
    consoleSteps: [
      'Go to Private DNS zones',
      'Search for privatelink.batch.azure.com zone',
      'Verify VNet links exist',
      'Check A records for Batch account',
    ],
    cliCheck: 'az network private-dns zone show --name privatelink.batch.azure.com --resource-group <rg>',
    expectedConfig: 'Private DNS zone privatelink.batch.azure.com linked to VNet with A records.',
    commonMisconfigs: [
      'DNS zone not created',
      'VNet not linked',
      'Missing A records',
    ],
    fixHint: 'az network private-dns zone create --name privatelink.batch.azure.com --resource-group <rg>',
  },
  {
    id: 'CIS-AZ-15.7',
    title: 'Ensure Diagnostics settings are enabled for Batch accounts',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'logging',
    whatToCheck: 'Verify diagnostic settings are configured for Batch account.',
    whyItMatters: 'Diagnostic logs enable monitoring, troubleshooting, and security analysis.',
    consoleSteps: [
      'Go to Batch accounts > select account',
      'Go to Diagnostic settings',
      'Verify diagnostic setting exists',
      'Check all log categories are enabled',
    ],
    cliCheck: 'az monitor diagnostic-settings list --resource <batch-resource-id>',
    expectedConfig: 'Diagnostic settings with ServiceLog, TaskEvents enabled, sent to Log Analytics.',
    commonMisconfigs: [
      'No diagnostic settings',
      'Missing log categories',
      'Logs not retained',
    ],
    fixHint: 'az monitor diagnostic-settings create --name <name> --resource <batch-id> --logs "[{category:ServiceLog,enabled:true}]" --workspace <law-id>',
  },

  // =============================================
  // AZURE CIS VIRTUAL MACHINES ADDITIONAL (20.x)
  // =============================================
  {
    id: 'CIS-AZ-20.1',
    ...
    framework: 'CIS Benchmark',
    category: 'storage',
    whatToCheck: 'Verify all VM disks are Managed Disks, not unmanaged storage blobs.',
    whyItMatters: 'Managed Disks provide better reliability, security, and easier management.',
    consoleSteps: [
      'Go to Virtual Machines',
      'Select each VM > Disks',
      'Verify OS and data disks are Managed Disks',
      'Check no unmanaged disks exist',
    ],
    cliCheck: 'az vm list --query "[].{name:name,osDiskManaged:storageProfile.osDisk.managedDisk.id}"',
    expectedConfig: 'All VMs use Managed Disks (managedDisk.id is not null).',
    commonMisconfigs: [
      'Legacy unmanaged disks',
      'Mixed managed/unmanaged',
      'Storage account-based VHDs',
    ],
    fixHint: 'az vm convert --resource-group <rg> --name <vm-name> (converts unmanaged to managed)',
  },
  {
    id: 'CIS-AZ-20.3',
    ...
    framework: 'CIS Benchmark',
    category: 'encryption',
    whatToCheck: 'Verify unattached managed disks are encrypted with customer-managed keys.',
    whyItMatters: 'Unattached disks may contain sensitive data and should be encrypted.',
    consoleSteps: [
      'Go to Disks',
      'Filter by Disk state = Unattached',
      'Select each disk > Encryption',
      'Verify CMK encryption is enabled',
    ],
    cliCheck: 'az disk list --query "[?diskState==\'Unattached\'].{name:name,encryption:encryption.type}"',
    expectedConfig: 'encryption.type: EncryptionAtRestWithCustomerKey for unattached disks.',
    commonMisconfigs: [
      'Platform-managed keys only',
      'No encryption',
      'CMK not applied',
    ],
    fixHint: 'az disk update --name <disk-name> --resource-group <rg> --encryption-type EncryptionAtRestWithCustomerKey --disk-encryption-set <des-id>',
  },
  {
    id: 'CIS-AZ-20.4',
    title: 'Ensure Disk Network Access is not set to public',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify managed disks do not allow public network access for export/upload.',
    whyItMatters: 'Public network access allows disk export from any internet location.',
    consoleSteps: [
      'Go to Disks',
      'Select each disk > Networking',
      'Check Network access setting',
      'Verify it is not "Enable public access from all networks"',
    ],
    cliCheck: 'az disk list --query "[].{name:name,networkAccessPolicy:networkAccessPolicy,publicNetworkAccess:publicNetworkAccess}"',
    expectedConfig: 'publicNetworkAccess: Disabled or networkAccessPolicy: DenyAll.',
    commonMisconfigs: [
      'Public access enabled',
      'AllowAll policy',
      'No network restrictions',
    ],
    fixHint: 'az disk update --name <disk-name> --resource-group <rg> --network-access-policy DenyAll',
  },
  {
    id: 'CIS-AZ-20.5',
    title: 'Ensure Data Access Authentication Mode is enabled for managed disks',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify Azure AD authentication is required for disk export SAS.',
    whyItMatters: 'Azure AD auth prevents anonymous disk exports using just SAS tokens.',
    consoleSteps: [
      'Go to Disks',
      'Select each disk > Disk Export',
      'Check Data access authentication mode',
      'Verify Azure AD is required',
    ],
    cliCheck: 'az disk list --query "[].{name:name,dataAccessAuthMode:dataAccessAuthMode}"',
    expectedConfig: 'dataAccessAuthMode: AzureActiveDirectory.',
    commonMisconfigs: [
      'No auth mode set',
      'SAS-only access allowed',
      'Anonymous exports possible',
    ],
    fixHint: 'az disk update --name <disk-name> --resource-group <rg> --data-access-auth-mode AzureActiveDirectory',
  },
  {
    id: 'CIS-AZ-20.6',
    title: 'Ensure Only Approved Extensions are installed on VMs',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'compute',
    whatToCheck: 'Verify only approved VM extensions are installed.',
    whyItMatters: 'Unapproved extensions can introduce security vulnerabilities or malware.',
    consoleSteps: [
      'Go to Virtual Machines > select VM',
      'Go to Extensions + applications',
      'Review installed extensions',
      'Verify all extensions are approved',
    ],
    cliCheck: 'az vm extension list --vm-name <vm-name> --resource-group <rg> --query "[].{name:name,publisher:publisher,type:typePropertiesType}"',
    expectedConfig: 'Only organization-approved extensions installed.',
    commonMisconfigs: [
      'Unknown extensions installed',
      'Deprecated extensions',
      'Third-party extensions without approval',
    ],
    fixHint: 'az vm extension delete --vm-name <vm> --resource-group <rg> --name <extension-name>',
  },
  {
    id: 'CIS-AZ-20.7',
    title: 'Ensure Endpoint Protection is installed on all VMs',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'compute',
    whatToCheck: 'Verify endpoint protection solution is installed on all VMs.',
    whyItMatters: 'Endpoint protection detects and prevents malware and threats on VMs.',
    consoleSteps: [
      'Go to Microsoft Defender for Cloud',
      'Check Recommendations for Endpoint protection',
      'Verify all VMs have protection installed',
      'Check extension status on each VM',
    ],
    cliCheck: 'az vm extension list --vm-name <vm-name> --resource-group <rg> --query "[?contains(name,\'Antimalware\') || contains(name,\'EndpointProtection\')]"',
    expectedConfig: 'MicrosoftMonitoringAgent, IaaSAntimalware, or equivalent extension installed.',
    commonMisconfigs: [
      'No antimalware extension',
      'Endpoint protection not running',
      'Outdated definitions',
    ],
    fixHint: 'az vm extension set --vm-name <vm> --resource-group <rg> --name IaaSAntimalware --publisher Microsoft.Azure.Security',
  },
  {
    id: 'CIS-AZ-20.8',
    title: 'Ensure VHDs are encrypted (for legacy unmanaged disks)',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'encryption',
    whatToCheck: 'Verify any legacy VHD files in storage accounts are encrypted.',
    whyItMatters: 'Unencrypted VHDs expose data if storage account is compromised.',
    consoleSteps: [
      'Go to Storage accounts',
      'Search for .vhd files in blob containers',
      'Verify Azure Disk Encryption was applied',
      'Check storage account encryption settings',
    ],
    cliCheck: 'az storage blob list --container-name vhds --account-name <storage-account> --query "[?ends_with(name,\'.vhd\')]"',
    expectedConfig: 'No unmanaged VHDs exist, or storage account has encryption enabled.',
    commonMisconfigs: [
      'Unencrypted VHDs in storage',
      'Legacy disks without ADE',
      'Storage encryption disabled',
    ],
    fixHint: 'Migrate to Managed Disks: az vm convert --resource-group <rg> --name <vm-name>',
  },
  {
    id: 'CIS-AZ-20.9',
    title: 'Ensure only MFA enabled identities can access VMs via JIT',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify JIT VM access requires MFA-enabled identities.',
    whyItMatters: 'MFA prevents unauthorized access even if credentials are compromised.',
    consoleSteps: [
      'Go to Microsoft Defender for Cloud > Just-in-time VM access',
      'Review configured VMs',
      'Check Azure AD Conditional Access policies',
      'Verify MFA is required for JIT requests',
    ],
    cliCheck: 'az security jit-policy list --query "[].{name:name,virtualMachines:virtualMachines}"',
    expectedConfig: 'JIT configured with Conditional Access requiring MFA.',
    commonMisconfigs: [
      'JIT without MFA requirement',
      'No Conditional Access policy',
      'MFA bypassed for admins',
    ],
    fixHint: 'Configure Conditional Access policy requiring MFA for Azure Management access.',
  },
  {
    id: 'CIS-AZ-20.11',
    title: 'Ensure encryption at host is enabled for VMs',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'encryption',
    whatToCheck: 'Verify VM has encryption at host enabled for temp disk and caches.',
    whyItMatters: 'Host encryption protects temp disks, ephemeral OS disks, and disk caches.',
    consoleSteps: [
      'Go to Virtual Machines > select VM',
      'Check Disks > Additional settings',
      'Verify Encryption at host is enabled',
      'Check subscription supports this feature',
    ],
    cliCheck: 'az vm show --name <vm-name> --resource-group <rg> --query "securityProfile.encryptionAtHost"',
    expectedConfig: 'securityProfile.encryptionAtHost: true.',
    commonMisconfigs: [
      'Feature not enabled',
      'VM size does not support it',
      'Subscription not registered',
    ],
    fixHint: 'az vm update --name <vm-name> --resource-group <rg> --set securityProfile.encryptionAtHost=true',
  },

  // =============================================
  // AZURE CIS CONTAINER INSTANCES ADDITIONAL (3.x)
  // =============================================
  {
    id: 'CIS-AZ-3.2',
    title: 'Ensure Managed Identity is enabled for Container Instances',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify container groups have managed identity assigned.',
    whyItMatters: 'Managed identities eliminate secrets in container configurations.',
    consoleSteps: [
      'Go to Container Instances',
      'Select container group',
      'Check Identity settings',
      'Verify system or user-assigned identity',
    ],
    cliCheck: 'az container show --name <container-group> --resource-group <rg> --query "identity"',
    expectedConfig: 'identity.type: SystemAssigned or UserAssigned.',
    commonMisconfigs: [
      'No managed identity',
      'Secrets in environment variables',
      'Connection strings hardcoded',
    ],
    fixHint: 'az container create --assign-identity [system] or --assign-identity <identity-id>',
  },
  {
    id: 'CIS-AZ-3.3',
    title: 'Ensure least privilege for Container Instance Managed Identity',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify container managed identity has minimal required permissions.',
    whyItMatters: 'Over-privileged identities increase blast radius if container is compromised.',
    consoleSteps: [
      'Go to Container Instance > Identity',
      'Click on Azure role assignments',
      'Review assigned roles',
      'Verify least privilege principle',
    ],
    cliCheck: 'az role assignment list --assignee <identity-principal-id> --query "[].{role:roleDefinitionName,scope:scope}"',
    expectedConfig: 'Role assignments limited to specific resources with minimal permissions.',
    commonMisconfigs: [
      'Contributor at subscription level',
      'Owner role assigned',
      'Broad scope assignments',
    ],
    fixHint: 'Review and restrict role assignments to specific resources with minimal permissions.',
  },

  // =============================================
  // AZURE CIS CYCLECLOUD (4.x)
  // =============================================
  {
    id: 'CIS-AZ-4.1',
    title: 'Ensure SSL is configured for Azure CycleCloud',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'encryption',
    whatToCheck: 'Verify CycleCloud web server uses SSL/TLS certificate.',
    whyItMatters: 'SSL ensures encrypted communication with CycleCloud management interface.',
    consoleSteps: [
      'Access CycleCloud web interface',
      'Check browser shows HTTPS with valid certificate',
      'Verify certificate is from trusted CA',
      'Check certificate expiration',
    ],
    cliCheck: 'openssl s_client -connect <cyclecloud-host>:443 -servername <cyclecloud-host> 2>/dev/null | openssl x509 -noout -dates',
    expectedConfig: 'Valid SSL certificate from trusted CA, not self-signed, not expired.',
    commonMisconfigs: [
      'Self-signed certificate',
      'HTTP without SSL',
      'Expired certificate',
    ],
    fixHint: 'Configure CycleCloud with valid SSL certificate: cyclecloud configure_ssl --keystore <path>',
  },

  // =============================================
  // GCP CIS CLOUD SQL ADDITIONAL (6.x)
  // =============================================
  {
    id: 'CIS-GCP-6.5',
    title: 'Ensure Cloud SQL instances do not implicitly whitelist all public IP addresses',
    severity: 'High',
    cloudProvider: 'GCP',
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify authorized networks do not include 0.0.0.0/0.',
    whyItMatters: 'Whitelisting all IPs exposes database to attacks from any internet location.',
    consoleSteps: [
      'Go to SQL > select instance',
      'Click Connections > Authorized networks',
      'Check for 0.0.0.0/0 entry',
      'Remove any overly permissive entries',
    ],
    cliCheck: 'gcloud sql instances describe <instance> --format="json(settings.ipConfiguration.authorizedNetworks)"',
    expectedConfig: 'authorizedNetworks contains specific CIDR ranges, not 0.0.0.0/0.',
    commonMisconfigs: [
      '0.0.0.0/0 whitelisted',
      'Overly broad CIDR ranges',
      'All IPs allowed for testing',
    ],
    fixHint: 'gcloud sql instances patch <instance> --clear-authorized-networks && gcloud sql instances patch <instance> --authorized-networks=<specific-cidr>',
  },
  {
    id: 'CIS-GCP-6.7',
    title: 'Ensure Cloud SQL instances are configured with automated backups',
    severity: 'High',
    cloudProvider: 'GCP',
    framework: 'CIS Benchmark',
    category: 'storage',
    whatToCheck: 'Verify automated backups are enabled for Cloud SQL instances.',
    whyItMatters: 'Automated backups ensure data recovery in case of corruption or accidental deletion.',
    consoleSteps: [
      'Go to SQL > select instance',
      'Click Backups',
      'Verify Automated backups is enabled',
      'Check backup retention and schedule',
    ],
    cliCheck: 'gcloud sql instances describe <instance> --format="json(settings.backupConfiguration)"',
    expectedConfig: 'backupConfiguration.enabled: true with appropriate retainedBackups count.',
    commonMisconfigs: [
      'Automated backups disabled',
      'Insufficient retention',
      'No point-in-time recovery',
    ],
    fixHint: 'gcloud sql instances patch <instance> --backup-start-time=<HH:MM> --enable-bin-log',
  },

  // =============================================
  // INTERNAL BASELINE ADDITIONAL CONTROLS
  // =============================================
  {
    id: 'INT-COMMON-002',
    title: 'Verify VM patching and automatic updates enrollment',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'Internal Baseline',
    category: 'compute',
    whatToCheck: 'Verify VMs are enrolled in automatic patching or have recent patches applied.',
    whyItMatters: 'Unpatched VMs are vulnerable to known exploits and security threats.',
    consoleSteps: [
      'Azure: Check Update Management Center status',
      'AWS: Check Systems Manager Patch Manager compliance',
      'GCP: Check VM Manager patch compliance',
      'Verify patches applied within last 30 days',
    ],
    cliCheck: 'Azure: az vm list --query "[].{name:name,osProfile:osProfile.windowsConfiguration.patchSettings}" | AWS: aws ssm describe-instance-patch-states',
    expectedConfig: 'All VMs enrolled in automatic patching with recent compliance.',
    commonMisconfigs: [
      'VMs not enrolled in patching',
      'Automatic updates disabled',
      'Patches more than 30 days old',
    ],
    fixHint: 'Enroll VMs in Update Management Center (Azure), Patch Manager (AWS), or VM Manager (GCP).',
  },
  {
    id: 'INT-AZ-017',
    title: 'Verify Azure Monitoring Agent installation on all VMs',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'Internal Baseline',
    category: 'logging',
    whatToCheck: 'Verify Azure Monitoring Agent (AMA) is installed and connected.',
    whyItMatters: 'AMA is required for centralized logging and monitoring of VM metrics and logs.',
    consoleSteps: [
      'Go to Virtual Machines > select VM',
      'Check Extensions + applications',
      'Look for AzureMonitorAgent extension',
      'Verify agent status is Succeeded',
    ],
    cliCheck: 'az vm extension list --vm-name <vm-name> --resource-group <rg> --query "[?contains(name,\'AzureMonitor\')]"',
    expectedConfig: 'AzureMonitorAgent extension installed with status Succeeded.',
    commonMisconfigs: [
      'Agent not installed',
      'Legacy MMA instead of AMA',
      'Agent disconnected',
    ],
    fixHint: 'az vm extension set --vm-name <vm> --resource-group <rg> --name AzureMonitorLinuxAgent --publisher Microsoft.Azure.Monitor',
  },
  {
    id: 'INT-COMMON-003',
    title: 'Verify budget rules and overspend notification configuration',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'Internal Baseline',
    category: 'logging',
    whatToCheck: 'Verify budget alerts are configured for subscriptions/projects.',
    whyItMatters: 'Budget alerts prevent unexpected costs and detect potential crypto-mining attacks.',
    consoleSteps: [
      'Azure: Go to Cost Management > Budgets',
      'AWS: Go to Billing > Budgets',
      'GCP: Go to Billing > Budgets & alerts',
      'Verify budgets exist with email notifications',
    ],
    cliCheck: 'Azure: az consumption budget list | AWS: aws budgets describe-budgets | GCP: gcloud billing budgets list',
    expectedConfig: 'Budget configured with alerts at 50%, 75%, 90%, 100% thresholds.',
    commonMisconfigs: [
      'No budgets configured',
      'No email notifications',
      'Thresholds too high',
    ],
    fixHint: 'Create budget with notification thresholds and email/SMS alerts for stakeholders.',
  },
  {
    id: 'INT-COMMON-004',
    title: 'Maintain user access review report documentation',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'Internal Baseline',
    category: 'iam',
    whatToCheck: 'Verify quarterly user access reviews are documented and approved.',
    whyItMatters: 'Regular access reviews ensure terminated employees and unused accounts are removed.',
    consoleSteps: [
      'Obtain latest access review report',
      'Verify review completed within last 90 days',
      'Check all users were reviewed and approved/revoked',
      'Verify manager signoff obtained',
    ],
    cliCheck: 'Azure: az ad access-review list | AWS/GCP: Manual review of IAM users vs HR system',
    expectedConfig: 'Access review completed quarterly with documentation and signoff.',
    commonMisconfigs: [
      'No access review process',
      'Reviews overdue',
      'Orphaned accounts remain',
    ],
    fixHint: 'Implement quarterly access review process using Azure AD Access Reviews or manual process.',
  },
  {
    id: 'INT-COMMON-005',
    title: 'Maintain ACL list for scoped projects and resources',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'Internal Baseline',
    category: 'iam',
    whatToCheck: 'Verify documented ACL matrix exists for all cloud projects/subscriptions.',
    whyItMatters: 'Documented ACLs enable audit trail and help identify unauthorized access.',
    consoleSteps: [
      'Obtain ACL documentation for each project',
      'Compare documented ACLs with actual IAM configuration',
      'Verify changes are tracked and approved',
      'Check documentation is current (updated within 30 days)',
    ],
    cliCheck: 'Compare documented ACL matrix against: az role assignment list | aws iam list-users | gcloud projects get-iam-policy',
    expectedConfig: 'ACL documentation exists and matches actual IAM configuration.',
    commonMisconfigs: [
      'No ACL documentation',
      'Documentation outdated',
      'Undocumented role assignments',
    ],
    fixHint: 'Create and maintain ACL matrix document. Update whenever IAM changes are made.',
  },
  {
    id: 'INT-COMMON-006',
    title: 'Maintain privileged user list with approval documentation',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'Internal Baseline',
    category: 'iam',
    whatToCheck: 'Verify list of privileged users exists with management approval documentation.',
    whyItMatters: 'Privileged access should be documented and approved to ensure accountability.',
    consoleSteps: [
      'Obtain privileged user list documentation',
      'Verify each privileged user has approval on file',
      'Compare list with actual Owner/Admin role assignments',
      'Check approvals are current (renewed annually)',
    ],
    cliCheck: 'Azure: az role assignment list --role Owner | AWS: aws iam list-users (check admin policies) | GCP: gcloud projects get-iam-policy (check roles/owner)',
    expectedConfig: 'Privileged user list matches actual assignments with approval documentation.',
    commonMisconfigs: [
      'Undocumented privileged users',
      'Expired approvals',
      'Missing approval documentation',
    ],
    fixHint: 'Create privileged user register. Obtain management approval for each privileged access grant.',
  },
  {
    id: 'INT-COMMON-007',
    title: 'Audit VPN access firewall rules and security groups',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'Internal Baseline',
    category: 'network',
    whatToCheck: 'Verify VPN access rules are properly configured and documented.',
    whyItMatters: 'VPN rules control remote access to cloud resources and must be secured.',
    consoleSteps: [
      'Review VPN gateway configuration',
      'Check associated NSG/Security Group rules',
      'Verify only necessary ports are allowed',
      'Document and justify each VPN access rule',
    ],
    cliCheck: 'Azure: az network vnet-gateway list | AWS: aws ec2 describe-vpn-gateways | GCP: gcloud compute vpn-gateways list',
    expectedConfig: 'VPN access limited to specific IP ranges with documented justification.',
    commonMisconfigs: [
      'Overly permissive VPN rules',
      'Undocumented access rules',
      'Legacy VPN configurations',
    ],
    fixHint: 'Review and document VPN access rules. Remove unnecessary rules and restrict to specific CIDRs.',
  },
  {
    id: 'INT-COMMON-008',
    title: 'Verify recent backup logs within last 7 days',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'Internal Baseline',
    category: 'storage',
    whatToCheck: 'Verify backup jobs have completed successfully within the last 7 days.',
    whyItMatters: 'Recent backups ensure data can be recovered in case of incident.',
    consoleSteps: [
      'Azure: Check Recovery Services vault backup jobs',
      'AWS: Check AWS Backup job history',
      'GCP: Check Cloud SQL backups and snapshots',
      'Verify all critical resources have recent successful backups',
    ],
    cliCheck: 'Azure: az backup job list --resource-group <rg> --vault-name <vault> | AWS: aws backup list-backup-jobs | GCP: gcloud sql backups list',
    expectedConfig: 'All critical resources have successful backup within last 7 days.',
    commonMisconfigs: [
      'Backup jobs failing',
      'Backups older than 7 days',
      'Critical resources not included in backup',
    ],
    fixHint: 'Investigate failed backup jobs. Ensure all critical resources are included in backup policies.',
  },
  {
    id: 'INT-COMMON-009',
    title: 'Track security score improvement over time',
    severity: 'Low',
    cloudProvider: 'Azure',
    framework: 'Internal Baseline',
    category: 'logging',
    whatToCheck: 'Verify security score is tracked and improving over time.',
    whyItMatters: 'Security score tracking shows progress in security posture improvement.',
    consoleSteps: [
      'Azure: Check Defender for Cloud Secure Score history',
      'AWS: Check Security Hub findings trend',
      'GCP: Check Security Command Center score',
      'Document score and improvement targets',
    ],
    cliCheck: 'Azure: az security secure-score list | AWS: aws securityhub get-findings | GCP: gcloud scc findings list',
    expectedConfig: 'Security score documented with improvement trend over last 90 days.',
    commonMisconfigs: [
      'Security score not monitored',
      'Score declining',
      'No improvement targets set',
    ],
    fixHint: 'Establish baseline security score. Set quarterly improvement targets and track progress.',
  },
  {
    id: 'INT-AZ-018',
    title: 'Verify prod/non-prod subscription network segregation',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'Internal Baseline',
    category: 'network',
    whatToCheck: 'Verify production and non-production workloads are in separate subscriptions with network isolation.',
    whyItMatters: 'Network segregation prevents non-prod issues from affecting production systems.',
    consoleSteps: [
      'List all subscriptions and their purpose (prod/non-prod)',
      'Verify VNets are not peered across prod/non-prod boundaries',
      'Check NSG rules do not allow traffic between environments',
      'Review firewall rules for cross-environment access',
    ],
    cliCheck: 'az account list --query "[].{name:name,id:id}" && az network vnet peering list --vnet-name <vnet> --resource-group <rg>',
    expectedConfig: 'Separate subscriptions for prod/non-prod with no network peering between them.',
    commonMisconfigs: [
      'Shared subscription for prod/non-prod',
      'VNet peering across environments',
      'Firewall rules allowing cross-env traffic',
    ],
    fixHint: 'Migrate workloads to separate subscriptions. Remove cross-environment VNet peerings.',
  },

  // Azure App Service - Additional Controls
  {
    id: 'CIS-AZ-2.1.17',
    ...
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify private endpoints for App Service apps are configured with private DNS zones for proper name resolution.',
    whyItMatters: 'Private DNS zones ensure traffic to private endpoints resolves correctly within the virtual network, preventing exposure to public internet.',
    consoleSteps: [
      'Go to Azure Portal → App Services',
      'Select the App Service → Networking',
      'Click on Private endpoints',
      'For each private endpoint, verify a private DNS zone is linked',
      'Check DNS resolution returns private IP address',
    ],
    cliCheck: 'az network private-endpoint dns-zone-group list --endpoint-name <endpoint> --resource-group <rg>',
    expectedConfig: 'Private DNS zone group configured for each App Service private endpoint.',
    commonMisconfigs: [
      'Private endpoint without DNS zone integration',
      'Custom DNS not configured to forward to Azure DNS',
      'Missing private DNS zone link to VNet',
    ],
    fixHint: 'Create private DNS zone for privatelink.azurewebsites.net and link it to VNet. Add DNS zone group to private endpoint.',
  },

  // Azure Function Apps Controls
  {
    id: 'CIS-AZ-2.3.1',
    title: 'Ensure Function Apps use currently supported Java version',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'compute',
    whatToCheck: 'Verify Function Apps using Java are configured with a supported Java version.',
    whyItMatters: 'Using supported runtime versions ensures security patches and updates are available to protect against known vulnerabilities.',
    consoleSteps: [
      'Go to Azure Portal → Function Apps',
      'Select the Function App → Configuration → General settings',
      'Check the Java version under Stack settings',
      'Verify it is a currently supported version (Java 11, 17, or 21)',
    ],
    cliCheck: 'az functionapp config show --name <app> --resource-group <rg> --query "javaVersion"',
    expectedConfig: 'Java version set to 11, 17, or 21 (currently supported LTS versions).',
    commonMisconfigs: [
      'Java 8 still in use (end of support)',
      'Outdated minor versions',
      'No automatic updates configured',
    ],
    fixHint: 'Update Java version to latest supported LTS version. Test application compatibility before production deployment.',
  },
  {
    id: 'CIS-AZ-2.3.2',
    title: 'Ensure Function Apps use currently supported Python version',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'compute',
    whatToCheck: 'Verify Function Apps using Python are configured with a supported Python version.',
    whyItMatters: 'Using supported runtime versions ensures security patches and updates are available to protect against known vulnerabilities.',
    consoleSteps: [
      'Go to Azure Portal → Function Apps',
      'Select the Function App → Configuration → General settings',
      'Check the Python version under Stack settings',
      'Verify it is a currently supported version (Python 3.9, 3.10, 3.11, or 3.12)',
    ],
    cliCheck: 'az functionapp config show --name <app> --resource-group <rg> --query "pythonVersion"',
    expectedConfig: 'Python version set to 3.9, 3.10, 3.11, or 3.12 (currently supported versions).',
    commonMisconfigs: [
      'Python 3.7 or 3.8 still in use',
      'Outdated minor versions',
      'No version explicitly set',
    ],
    fixHint: 'Update Python version to latest supported version. Test application compatibility before production deployment.',
  },
  {
    id: 'CIS-AZ-2.3.3',
    title: 'Ensure Basic Authentication Publishing Credentials are disabled for Function Apps',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'identity',
    whatToCheck: 'Verify basic authentication is disabled for FTP and SCM/Kudu endpoints.',
    whyItMatters: 'Basic authentication credentials can be compromised through brute force attacks or credential theft. Disabling it enforces stronger authentication methods.',
    consoleSteps: [
      'Go to Azure Portal → Function Apps',
      'Select the Function App → Configuration → General settings',
      'Verify "Basic Auth Publishing Credentials" is set to Off',
      'Check both FTP and SCM endpoints are disabled',
    ],
    cliCheck: 'az functionapp config show --name <app> --resource-group <rg> --query "{ftpPublishingPolicy:ftpPublishingPolicy,scmPublishingPolicy:scmPublishingPolicy}"',
    expectedConfig: 'Both FTP and SCM basic authentication publishing credentials disabled.',
    commonMisconfigs: [
      'FTP basic auth still enabled',
      'SCM/Kudu basic auth enabled',
      'Legacy deployment scripts using basic auth',
    ],
    fixHint: 'Disable basic auth in General settings. Update CI/CD pipelines to use managed identity or service principal authentication.',
  },
  {
    id: 'CIS-AZ-2.3.5',
    title: 'Ensure HTTP version is set to 2.0 for Function Apps',
    severity: 'Low',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify Function Apps are configured to use HTTP/2 protocol.',
    whyItMatters: 'HTTP/2 provides improved performance through multiplexing and header compression, and includes security improvements over HTTP/1.1.',
    consoleSteps: [
      'Go to Azure Portal → Function Apps',
      'Select the Function App → Configuration → General settings',
      'Check HTTP version setting',
    ...
    cliCheck: 'az functionapp config show --name <app> --resource-group <rg> --query "http20Enabled"',
    expectedConfig: 'HTTP version set to 2.0 (http20Enabled: true).',
    commonMisconfigs: [
      'Default HTTP/1.1 still in use',
      'Legacy clients requiring HTTP/1.1',
      'Load balancer not configured for HTTP/2',
    ],
    fixHint: 'Enable HTTP/2 in General settings. Ensure front-end load balancers and clients support HTTP/2.',
  },
  {
    id: 'CIS-AZ-2.3.8',
    title: 'Ensure end-to-end TLS encryption is enabled for Function Apps',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'encryption',
    whatToCheck: 'Verify TLS encryption is enforced for all Function App communications.',
    whyItMatters: 'End-to-end TLS ensures data is encrypted in transit, protecting against man-in-the-middle attacks and eavesdropping.',
    consoleSteps: [
      'Go to Azure Portal → Function Apps',
      'Select the Function App → TLS/SSL settings',
      'Verify Minimum TLS Version is 1.2 or higher',
      'Ensure HTTPS Only is enabled',
      'Check client certificate settings if mutual TLS required',
    ],
    cliCheck: 'az functionapp config show --name <app> --resource-group <rg> --query "{minTlsVersion:minTlsVersion,httpsOnly:httpsOnly}"',
    expectedConfig: 'HTTPS Only enabled, minimum TLS version 1.2 or higher.',
    commonMisconfigs: [
      'HTTP allowed alongside HTTPS',
      'TLS 1.0 or 1.1 still enabled',
      'Self-signed certificates in production',
    ],
    fixHint: 'Enable HTTPS Only and set minimum TLS version to 1.2. Configure valid TLS certificates.',
  },
  {
    id: 'CIS-AZ-2.3.10',
    title: 'Ensure incoming client certificates are enabled and required for Function Apps',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'identity',
    whatToCheck: 'Verify client certificate authentication is configured for Function Apps requiring mutual TLS.',
    whyItMatters: 'Client certificates provide strong authentication ensuring only authorized clients can access the Function App.',
    consoleSteps: [
      'Go to Azure Portal → Function Apps',
      'Select the Function App → Configuration → General settings',
      'Check Client certificate mode setting',
      'Verify it is set to Require for sensitive applications',
    ],
    cliCheck: 'az functionapp show --name <app> --resource-group <rg> --query "clientCertEnabled"',
    expectedConfig: 'Client certificates enabled and required for sensitive Function Apps.',
    commonMisconfigs: [
      'Client certificates not required',
      'Optional mode used when required needed',
      'Certificate validation not implemented in code',
    ],
    fixHint: 'Enable client certificate requirement. Implement certificate validation logic in function code.',
  },
  {
    id: 'CIS-AZ-2.3.14',
    ...
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify Function Apps are integrated with virtual networks for private connectivity.',
    whyItMatters: 'VNet integration allows Function Apps to securely access resources in virtual networks without exposing traffic to the public internet.',
    consoleSteps: [
      'Go to Azure Portal → Function Apps',
      'Select the Function App → Networking',
      'Check VNet integration status',
      'Verify a virtual network and subnet are configured',
    ],
    cliCheck: 'az functionapp vnet-integration list --name <app> --resource-group <rg>',
    expectedConfig: 'Function App integrated with appropriate virtual network and subnet.',
    commonMisconfigs: [
      'No VNet integration configured',
      'Wrong subnet selected',
      'Subnet without sufficient IP addresses',
    ],
    fixHint: 'Configure VNet integration with dedicated subnet. Ensure subnet has /28 or larger address space.',
  },
  {
    id: 'CIS-AZ-2.3.15',
    title: 'Ensure Function App configuration is routed through the virtual network',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify Function App configuration traffic routes through VNet integration.',
    whyItMatters: 'Routing configuration traffic through VNet ensures management operations are protected by network security controls.',
    consoleSteps: [
      'Go to Azure Portal → Function Apps',
      'Select the Function App → Networking → VNet integration',
      'Check "Route All" setting',
      'Verify configuration routing is enabled',
    ],
    cliCheck: 'az functionapp config appsettings list --name <app> --resource-group <rg> --query "[?name==\'WEBSITE_VNET_ROUTE_ALL\']"',
    expectedConfig: 'WEBSITE_VNET_ROUTE_ALL set to 1 or Route All enabled.',
    commonMisconfigs: [
      'Route All not enabled',
      'Only outbound traffic routed',
      'Split tunneling exposing management traffic',
    ],
    fixHint: 'Enable Route All in VNet integration settings or set WEBSITE_VNET_ROUTE_ALL=1 app setting.',
  },
  {
    id: 'CIS-AZ-2.3.16',
    title: 'Ensure all traffic is routed through the virtual network for Function Apps',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify all outbound Function App traffic routes through the virtual network.',
    whyItMatters: 'Routing all traffic through VNet ensures network security controls like NSGs and firewalls can inspect and filter all communications.',
    consoleSteps: [
      'Go to Azure Portal → Function Apps',
      'Select the Function App → Networking',
      'Check VNet integration configuration',
      'Verify "Route All" is enabled for all traffic',
    ],
    cliCheck: 'az functionapp config appsettings list --name <app> --resource-group <rg> --query "[?name==\'WEBSITE_VNET_ROUTE_ALL\'].value"',
    expectedConfig: 'All outbound traffic routed through VNet (WEBSITE_VNET_ROUTE_ALL=1).',
    commonMisconfigs: [
      'Default routing bypassing VNet',
      'Internet-bound traffic not inspected',
      'Data exfiltration possible via direct routes',
    ],
    fixHint: 'Set WEBSITE_VNET_ROUTE_ALL=1. Configure UDRs for traffic inspection through firewall if required.',
  },
  {
    id: 'CIS-AZ-2.3.17',
    title: 'Ensure cross-origin resource sharing does not allow all origins for Function Apps',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify CORS settings do not allow wildcard (*) origins.',
    whyItMatters: 'Allowing all origins enables any website to make requests to your Function App, potentially exposing sensitive data or functionality.',
    consoleSteps: [
      'Go to Azure Portal → Function Apps',
      'Select the Function App → API → CORS',
      'Review allowed origins list',
      'Ensure * (wildcard) is not in the list',
    ],
    cliCheck: 'az functionapp cors show --name <app> --resource-group <rg> --query "allowedOrigins"',
    expectedConfig: 'CORS configured with specific allowed origins, no wildcard (*).',
    commonMisconfigs: [
      'Wildcard (*) in allowed origins',
      'Development origins left in production',
      'No CORS configuration (defaults may be insecure)',
    ],
    fixHint: 'Remove wildcard from CORS origins. Configure only specific, trusted domains that require access.',
  },

  // Azure Virtual Machines - Additional Controls
  {
    id: 'CIS-AZ-20.2',
    title: 'Ensure OS and Data disks are encrypted with Customer Managed Key (CMK)',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'encryption',
    whatToCheck: 'Verify VM disks are encrypted using customer-managed keys stored in Azure Key Vault.',
    whyItMatters: 'CMK encryption provides greater control over encryption keys, enabling key rotation, auditing, and compliance with data sovereignty requirements.',
    consoleSteps: [
      'Go to Azure Portal → Virtual Machines',
      'Select the VM → Disks',
      'For each disk, check Encryption settings',
      'Verify "Encryption type" is set to "Customer-managed key"',
      'Confirm key vault and key are properly configured',
    ],
    cliCheck: 'az disk list --query "[].{name:name,encryption:encryption.type}" --output table',
    expectedConfig: 'All OS and data disks encrypted with EncryptionAtRestWithCustomerKey.',
    commonMisconfigs: [
      'Platform-managed keys used instead of CMK',
      'Disk encryption set not linked to Key Vault',
      'Key Vault access policies not configured',
    ],
    fixHint: 'Create Disk Encryption Set with CMK. Update disk encryption settings to use the encryption set.',
  },
  {
    id: 'CIS-AZ-20.10',
    title: 'Ensure Trusted Launch is enabled on Virtual Machines',
    ...
    framework: 'CIS Benchmark',
    category: 'compute',
    whatToCheck: 'Verify VMs have Trusted Launch enabled with Secure Boot and vTPM.',
    whyItMatters: 'Trusted Launch protects against boot kits, root kits, and kernel-level malware by verifying boot integrity.',
    consoleSteps: [
      'Go to Azure Portal → Virtual Machines',
      'Select the VM → Overview or Properties',
      'Check Security type setting',
      'Verify "Trusted launch virtual machines" is enabled',
      'Confirm both Secure Boot and vTPM are enabled',
    ],
    cliCheck: 'az vm show --name <vm> --resource-group <rg> --query "securityProfile"',
    expectedConfig: 'Security type: Trusted launch, Secure Boot: Enabled, vTPM: Enabled.',
    commonMisconfigs: [
      'Standard security type used',
      'Secure Boot disabled',
      'vTPM not enabled',
      'Legacy VM sizes not supporting Trusted Launch',
    ],
    fixHint: 'Create new VMs with Trusted Launch enabled. For existing VMs, migration may be required as Trusted Launch cannot be enabled post-creation.',
  },
  ...
  {
    id: 'CIS-AZ-2.1.1-DB',
    title: 'Ensure Azure Databricks Workspace is Deployed in a Customer-Managed VNet',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify Databricks workspace is deployed in a customer-managed VNet with proper network isolation.',
    whyItMatters: 'Using customer-managed VNet provides network isolation, enables private connectivity, and allows integration with existing network security controls.',
    consoleSteps: [
      'Go to Azure Portal → Azure Databricks',
      'Select workspace → Settings → Networking',
      'Verify "Deploy Azure Databricks in your own virtual network" is enabled',
      'Check VNet and subnet configurations',
    ],
    cliCheck: 'az databricks workspace show --name <workspace> --resource-group <rg> --query "parameters.customVirtualNetworkId"',
    expectedConfig: 'Workspace deployed in customer-managed VNet with dedicated subnets for private and public clusters.',
    commonMisconfigs: [
      'Using Databricks-managed VNet',
      'No private subnet configured',
      'Missing NSG associations',
    ],
    fixHint: 'Redeploy workspace with VNet injection enabled. Configure dedicated subnets for Databricks clusters.',
  },
  {
    id: 'CIS-AZ-2.1.2-DB',
    title: 'Ensure NSGs Are Configured for Azure Databricks Subnets',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify Network Security Groups are associated with Databricks subnets with proper rules.',
    whyItMatters: 'NSGs provide network-level access control, preventing unauthorized access to Databricks clusters and data.',
    consoleSteps: [
      'Go to Azure Portal → Virtual Networks',
      'Select the Databricks VNet → Subnets',
      'For each Databricks subnet, verify NSG is associated',
      'Review NSG rules for least privilege access',
    ],
    cliCheck: 'az network nsg list --resource-group <rg> --query "[].{Name:name,Subnets:subnets[].id}"',
    expectedConfig: 'NSGs associated with all Databricks subnets. Inbound rules restrict access to required ports only.',
    commonMisconfigs: [
      'No NSG associated with subnets',
      'Overly permissive inbound rules',
      'Missing required Databricks service rules',
    ],
    fixHint: 'Create and associate NSGs with Databricks subnets. Follow Databricks NSG requirements while restricting unnecessary access.',
  },
  {
    id: 'CIS-AZ-2.1.3-DB',
    title: 'Ensure Traffic Between Cluster Worker Nodes Is Encrypted',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'encryption',
    whatToCheck: 'Verify inter-node communication encryption is enabled for Databricks clusters.',
    whyItMatters: 'Encrypting traffic between worker nodes protects data in transit within the cluster, preventing interception of sensitive data.',
    consoleSteps: [
      'Go to Azure Databricks workspace',
      'Check workspace configuration for encryption settings',
      'Review cluster policies for encryption requirements',
      'Verify init scripts enable inter-node encryption',
    ],
    cliCheck: 'az databricks workspace show --name <workspace> --resource-group <rg> --query "encryption"',
    expectedConfig: 'Inter-node encryption enabled. All cluster traffic encrypted in transit.',
    commonMisconfigs: [
      'Default encryption settings used',
      'Inter-node encryption not enabled',
      'Mixed encrypted/unencrypted clusters',
    ],
    fixHint: 'Enable encryption for inter-node traffic in workspace configuration or cluster policies.',
  },
  {
    id: 'CIS-AZ-2.1.4-DB',
    title: 'Ensure Users and Groups Are Synced from Microsoft Entra ID',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify Databricks workspace uses Microsoft Entra ID (Azure AD) for user and group management.',
    whyItMatters: 'Syncing with Entra ID ensures centralized identity management, consistent access policies, and automatic deprovisioning.',
    consoleSteps: [
      'Go to Azure Databricks workspace',
      'Navigate to Admin Console → User Management',
      'Verify users are synced from Entra ID',
      'Check SCIM provisioning is configured',
    ],
    expectedConfig: 'SCIM provisioning enabled. Users and groups synced from Entra ID. Local accounts minimized.',
    commonMisconfigs: [
      'Local Databricks accounts used',
      'SCIM provisioning not configured',
      'Group memberships not synced',
    ],
    fixHint: 'Configure SCIM provisioning from Entra ID to Databricks. Remove local accounts and use Entra ID groups.',
  },
  {
    id: 'CIS-AZ-2.1.5-DB',
    title: 'Ensure Unity Catalog Is Configured for All Databricks Workspaces',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'storage',
    whatToCheck: 'Verify Unity Catalog is enabled and configured for centralized data governance.',
    whyItMatters: 'Unity Catalog provides centralized governance for data assets, fine-grained access control, and audit logging across workspaces.',
    consoleSteps: [
      'Go to Azure Databricks account console',
      'Navigate to Data → Unity Catalog',
      'Verify metastore is created and assigned to workspaces',
      'Check data access policies are defined',
    ],
    expectedConfig: 'Unity Catalog metastore configured. All workspaces assigned to metastore. Data access policies defined.',
    commonMisconfigs: [
      'Unity Catalog not enabled',
      'Legacy Hive metastore used',
      'No data access policies',
      'Workspaces not assigned to metastore',
    ],
    fixHint: 'Create Unity Catalog metastore. Assign workspaces. Migrate from legacy metastore and define access policies.',
  },
  {
    id: 'CIS-AZ-2.1.6-DB',
    title: 'Ensure Personal Access Token Usage Is Restricted with Expiry',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify PAT usage is restricted with mandatory expiration and usage policies.',
    whyItMatters: 'Long-lived PATs pose security risks if compromised. Expiration and usage restrictions limit potential damage.',
    consoleSteps: [
      'Go to Azure Databricks workspace → Admin Console',
      'Navigate to Workspace Settings → Access Tokens',
      'Verify token lifetime restrictions are configured',
      'Check PAT usage policies',
    ],
    expectedConfig: 'Maximum token lifetime configured (e.g., 90 days). Token creation restricted to authorized users.',
    commonMisconfigs: [
      'No token expiration enforced',
      'Unlimited token lifetime allowed',
      'All users can create tokens',
    ],
    fixHint: 'Configure workspace settings to enforce token expiration. Restrict token creation to authorized groups.',
  },
  {
    id: 'CIS-AZ-2.1.7-DB',
    ...
    framework: 'CIS Benchmark',
    category: 'logging',
    whatToCheck: 'Verify diagnostic logs are configured to be delivered to a centralized logging solution.',
    whyItMatters: 'Diagnostic logs provide visibility into workspace activities, enabling security monitoring and incident investigation.',
    consoleSteps: [
      'Go to Azure Databricks workspace → Diagnostic settings',
      'Verify diagnostic settings are configured',
      'Check logs are sent to Log Analytics, Storage, or Event Hub',
      'Verify all relevant log categories are enabled',
    ],
    cliCheck: 'az monitor diagnostic-settings list --resource <workspace-resource-id>',
    expectedConfig: 'Diagnostic settings enabled. Logs sent to Log Analytics workspace. All categories enabled.',
    commonMisconfigs: [
      'No diagnostic settings configured',
      'Only some log categories enabled',
      'Logs not sent to SIEM',
    ],
    fixHint: 'Configure diagnostic settings to send logs to Log Analytics. Enable all log categories for comprehensive monitoring.',
  },
  {
    id: 'CIS-AZ-2.1.8-DB',
    title: 'Ensure Critical Data Is Encrypted with Customer-Managed Keys',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'encryption',
    whatToCheck: 'Verify Databricks workspace uses customer-managed keys for encrypting critical data.',
    whyItMatters: 'CMK provides control over encryption keys, enabling key rotation, audit logging, and compliance with data sovereignty requirements.',
    consoleSteps: [
      'Go to Azure Databricks workspace → Encryption',
      'Verify customer-managed key is configured',
      'Check Key Vault and key configuration',
      'Verify managed services and workspace storage use CMK',
    ],
    cliCheck: 'az databricks workspace show --name <workspace> --resource-group <rg> --query "encryption"',
    expectedConfig: 'CMK configured for managed services and workspace storage. Key Vault integrated.',
    commonMisconfigs: [
      'Using platform-managed keys',
      'CMK only for some components',
      'Key Vault access not configured',
    ],
    fixHint: 'Configure CMK encryption for Databricks workspace. Set up Key Vault with proper access policies.',
  },
  {
    id: 'CIS-AZ-2.1.9-DB',
    title: 'Ensure No Public IP Is Enabled for Databricks Clusters',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify Databricks clusters are configured without public IP addresses.',
    whyItMatters: 'Disabling public IPs reduces attack surface and ensures clusters are only accessible through private connectivity.',
    consoleSteps: [
      'Go to Azure Databricks workspace',
      'Check workspace configuration for "No Public IP" setting',
      'Review cluster configurations',
      'Verify NAT gateway or Private Link is configured for outbound access',
    ],
    cliCheck: 'az databricks workspace show --name <workspace> --resource-group <rg> --query "parameters.enableNoPublicIp"',
    expectedConfig: 'No Public IP enabled (enableNoPublicIp: true). NAT gateway configured for outbound access.',
    commonMisconfigs: [
      'Public IPs enabled on clusters',
      'No NAT gateway for outbound access',
      'Mixed public/private configurations',
    ],
    fixHint: 'Enable No Public IP in workspace configuration. Configure NAT gateway or Azure Firewall for outbound access.',
  },
  {
    id: 'CIS-AZ-2.1.10-DB',
    title: 'Ensure Allow Public Network Access Is Disabled for Databricks',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify public network access is disabled for Databricks workspace.',
    whyItMatters: 'Disabling public access ensures the workspace is only accessible through private endpoints, reducing exposure to internet-based attacks.',
    consoleSteps: [
      'Go to Azure Databricks workspace → Networking',
      'Check "Allow public network access" setting',
      'Verify it is set to Disabled',
      'Confirm private endpoints are configured',
    ],
    cliCheck: 'az databricks workspace show --name <workspace> --resource-group <rg> --query "publicNetworkAccess"',
    expectedConfig: 'Public network access: Disabled. Private endpoints configured for access.',
    commonMisconfigs: [
      'Public network access enabled',
      'No private endpoints configured',
      'IP access rules used instead of private access',
    ],
    fixHint: 'Disable public network access. Configure private endpoints for workspace access.',
  },
  {
    id: 'CIS-AZ-2.1.11-DB',
    title: 'Ensure Private Endpoints Are Used for Databricks Workspace',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify private endpoints are configured for accessing Databricks workspace.',
    whyItMatters: 'Private endpoints provide secure, private connectivity to Databricks without exposing traffic to the public internet.',
    consoleSteps: [
      'Go to Azure Databricks workspace → Networking',
      'Navigate to Private endpoint connections',
      'Verify private endpoints are configured and approved',
      'Check DNS resolution for private endpoints',
    ],
    cliCheck: 'az network private-endpoint list --resource-group <rg> --query "[?contains(privateLinkServiceConnections[].groupIds[], \'databricks_ui_api\')]"',
    expectedConfig: 'Private endpoints configured for UI/API and browser authentication. DNS properly configured.',
    commonMisconfigs: [
      'No private endpoints configured',
      'Private DNS not configured',
      'Only partial endpoint coverage',
    ],
    fixHint: 'Create private endpoints for Databricks workspace. Configure private DNS zones for name resolution.',
  },

  // Section 3.1 - Virtual Machines
  {
    id: 'CIS-AZ-3.1.1',
    title: 'Ensure Only Extensions from Trusted Publishers Are Installed',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'compute',
    whatToCheck: 'Verify only VM extensions from Microsoft or trusted publishers are installed.',
    whyItMatters: 'Untrusted extensions can execute arbitrary code on VMs, potentially compromising workloads and data.',
    consoleSteps: [
      'Go to Azure Portal → Virtual Machines',
      'Select VM → Extensions + applications',
      'Review installed extensions',
      'Verify all publishers are trusted',
    ],
    cliCheck: 'az vm extension list --vm-name <vm> --resource-group <rg> --query "[].{Name:name,Publisher:publisher}"',
    expectedConfig: 'Only extensions from Microsoft or approved publishers. Azure Policy enforcing extension restrictions.',
    commonMisconfigs: [
      'Third-party extensions without approval',
      'Outdated or unsupported extensions',
      'No policy restricting extensions',
    ],
    fixHint: 'Remove untrusted extensions. Implement Azure Policy to allow only approved extension publishers.',
  },

  // Section 5.1 - Security Defaults
  {
    id: 'CIS-AZ-5.1.1',
    title: 'Ensure Security Defaults Are Enabled on Microsoft Entra ID',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify Security Defaults are enabled OR equivalent Conditional Access policies exist.',
    whyItMatters: 'Security Defaults provide baseline protection against identity attacks including MFA for all users and blocking legacy authentication.',
    consoleSteps: [
      'Go to Microsoft Entra admin center',
      'Navigate to Identity → Overview → Properties',
      'Check "Manage Security defaults" at bottom',
      'Verify Security defaults is Enabled (or Conditional Access is used)',
    ],
    cliCheck: 'az rest --method get --uri "https://graph.microsoft.com/v1.0/policies/identitySecurityDefaultsEnforcementPolicy"',
    expectedConfig: 'Security Defaults enabled OR comprehensive Conditional Access policies providing equivalent protection.',
    commonMisconfigs: [
      'Security defaults disabled without CA policies',
      'Partial MFA coverage',
      'Legacy authentication not blocked',
    ],
    fixHint: 'Enable Security Defaults in Entra ID Properties. If using Conditional Access, ensure equivalent protections are configured.',
  },
  {
    id: 'CIS-AZ-5.1.2',
    ...
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify MFA is required for all user sign-ins through Security Defaults or Conditional Access.',
    whyItMatters: 'MFA prevents 99.9% of identity attacks. Users without MFA are highly vulnerable to credential theft and phishing.',
    consoleSteps: [
      'Go to Microsoft Entra admin center',
      'Navigate to Protection → Conditional Access',
      'Check for policies requiring MFA for all users',
      'Or verify Security Defaults is enabled',
    ],
    cliCheck: 'az ad user list --query "[].{UPN:userPrincipalName,MFA:strongAuthenticationDetail}"',
    expectedConfig: 'All users required to use MFA. Security Defaults or CA policy enforcing MFA for all sign-ins.',
    commonMisconfigs: [
      'MFA not required for all users',
      'Exclusions for specific users/groups',
      'MFA only for privileged accounts',
    ],
    fixHint: 'Enable Security Defaults or create Conditional Access policy requiring MFA for all users and all apps.',
  },
  {
    id: 'CIS-AZ-5.1.3',
    title: 'Ensure "Remember MFA on Trusted Devices" Is Disabled',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify users cannot bypass MFA on trusted devices for extended periods.',
    whyItMatters: 'Allowing MFA bypass on trusted devices reduces security if the device is compromised or shared.',
    consoleSteps: [
      'Go to Microsoft Entra admin center',
      'Navigate to Protection → Multifactor authentication',
      'Check Additional cloud-based MFA settings',
      'Verify "Remember multi-factor authentication" is disabled or minimal',
    ],
    expectedConfig: 'Remember MFA disabled or set to minimal period (e.g., 1 day). Compliant devices managed through Conditional Access.',
    commonMisconfigs: [
      'Remember MFA enabled for long periods',
      'No device compliance requirements',
      'Users bypassing MFA on personal devices',
    ],
    fixHint: 'Disable "Remember multi-factor authentication" or set to minimum period. Use device compliance in Conditional Access.',
  },

  // Section 5.2 - Conditional Access
  {
    id: 'CIS-AZ-5.2.1',
    title: 'Ensure Trusted Locations Are Defined for Conditional Access',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify trusted locations (IP ranges, countries) are defined for use in Conditional Access policies.',
    whyItMatters: 'Trusted locations enable location-based access controls, allowing stricter policies for access from untrusted locations.',
    consoleSteps: [
      'Go to Microsoft Entra admin center',
      'Navigate to Protection → Conditional Access → Named locations',
      'Verify corporate IP ranges are defined',
      'Check country-based locations if applicable',
    ],
    expectedConfig: 'Corporate IP ranges defined as trusted locations. Named locations used in Conditional Access policies.',
    commonMisconfigs: [
      'No trusted locations defined',
      'Outdated IP ranges',
      'Overly broad country allowlists',
    ],
    fixHint: 'Define corporate IP ranges as named locations. Create Conditional Access policies using location conditions.',
  },
  {
    id: 'CIS-AZ-5.2.2',
    title: 'Ensure Access from Untrusted Locations Requires Additional Verification',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify Conditional Access policies require additional verification from untrusted locations.',
    whyItMatters: 'Access from untrusted locations poses higher risk and should require stronger authentication or be restricted.',
    consoleSteps: [
      'Go to Microsoft Entra admin center → Conditional Access',
      'Review policies with location conditions',
      'Verify untrusted locations require MFA or are blocked',
      'Check coverage for all users and apps',
    ],
    expectedConfig: 'CA policies requiring MFA or blocking access from untrusted locations.',
    commonMisconfigs: [
      'No location-based policies',
      'Policies not covering all users',
      'Legacy authentication bypassing location controls',
    ],
    fixHint: 'Create Conditional Access policy requiring MFA for access from all locations except trusted named locations.',
  },
  {
    id: 'CIS-AZ-5.2.3',
    title: 'Ensure Conditional Access Policy Restricts Device Code Flow',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify device code flow authentication is blocked or restricted.',
    whyItMatters: 'Device code flow is commonly used in phishing attacks. Attackers trick users into authenticating on attacker-controlled devices.',
    consoleSteps: [
      'Go to Microsoft Entra admin center → Conditional Access',
      'Look for policies blocking device code flow',
      'Verify policy targets all users',
      'Check authentication flows conditions',
    ],
    expectedConfig: 'Conditional Access policy blocking device code flow for all users except those with legitimate need.',
    commonMisconfigs: [
      'Device code flow not restricted',
      'Policy has exceptions for all users',
      'No awareness of device code phishing risk',
    ],
    fixHint: 'Create Conditional Access policy with condition: Authentication flows → Device code flow → Block.',
  },
  {
    id: 'CIS-AZ-5.2.4',
    title: 'Ensure Conditional Access Requires MFA for Privileged Accounts',
    severity: 'Critical',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify MFA is required for all privileged/administrative accounts.',
    whyItMatters: 'Privileged accounts have elevated access and are high-value targets. MFA is essential to protect against credential theft.',
    consoleSteps: [
      'Go to Microsoft Entra admin center → Conditional Access',
      'Review policies targeting administrative roles',
      'Verify MFA is required for all admin sign-ins',
      'Check no exclusions exist',
    ],
    expectedConfig: 'CA policy requiring MFA for directory roles including Global Admin, User Admin, etc.',
    commonMisconfigs: [
      'Emergency access accounts not excluded properly',
      'Some admin roles not covered',
      'MFA optional for admins',
    ],
    fixHint: 'Create CA policy targeting "Directory roles" with all admin roles, requiring MFA. Properly secure break-glass accounts.',
  },
  {
    id: 'CIS-AZ-5.2.5',
    title: 'Ensure Sign-In Risk Policy Requires MFA for Medium and High Risk',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify sign-in risk policy requires MFA for medium and high risk sign-ins.',
    whyItMatters: 'Identity Protection detects risky sign-ins. Requiring MFA for risky attempts prevents unauthorized access.',
    consoleSteps: [
      'Go to Microsoft Entra admin center → Protection → Identity Protection',
      'Check Sign-in risk policy',
      'Verify it applies to All users',
      'Confirm MFA required for Medium and High risk',
    ],
    expectedConfig: 'Sign-in risk policy enabled for all users. MFA required for medium and high risk sign-ins.',
    commonMisconfigs: [
      'Policy not configured',
      'Only high risk covered',
      'User exclusions reducing coverage',
    ],
    fixHint: 'Configure Identity Protection sign-in risk policy to require MFA for medium and high risk sign-ins.',
  },
  {
    id: 'CIS-AZ-5.2.6',
    title: 'Ensure User Risk Policy Requires Password Change for High Risk Users',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify user risk policy requires password change for high risk users.',
    whyItMatters: 'Users flagged as high risk may have compromised credentials. Requiring password change remediates the risk.',
    consoleSteps: [
      'Go to Microsoft Entra admin center → Protection → Identity Protection',
      'Check User risk policy',
      'Verify it applies to All users',
      'Confirm password change required for High risk',
    ],
    expectedConfig: 'User risk policy enabled for all users. Secure password change required for high risk users.',
    commonMisconfigs: [
      'Policy not configured',
      'Block instead of password change',
      'User exclusions reducing coverage',
    ],
    fixHint: 'Configure Identity Protection user risk policy to require secure password change for high risk users.',
  },
  {
    id: 'CIS-AZ-5.2.7',
    title: 'Ensure MFA Is Required to Access Microsoft Azure Management',
    severity: 'Critical',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify MFA is required for access to Azure Portal and Azure management APIs.',
    whyItMatters: 'Azure management access allows creation, modification, and deletion of resources. MFA prevents unauthorized management actions.',
    consoleSteps: [
      'Go to Microsoft Entra admin center → Conditional Access',
      'Look for policy targeting "Microsoft Azure Management" app',
      'Verify MFA is required',
      'Check all users are covered',
    ],
    expectedConfig: 'CA policy requiring MFA for "Microsoft Azure Management" cloud app for all users.',
    commonMisconfigs: [
      'No policy for Azure management',
      'Service principals excluded',
      'Some users exempted',
    ],
    fixHint: 'Create CA policy targeting "Microsoft Azure Management" cloud app, requiring MFA for all users.',
  },
  {
    id: 'CIS-AZ-5.2.8',
    title: 'Ensure MFA Is Required for Microsoft Admin Portals',
    severity: 'Critical',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify MFA is required for access to all Microsoft admin portals.',
    whyItMatters: 'Admin portals provide access to configure security settings and manage users. MFA is essential protection.',
    consoleSteps: [
      'Go to Microsoft Entra admin center → Conditional Access',
      'Look for policy targeting "Microsoft Admin Portals" app',
      'Verify MFA is required',
      'Check all users are covered',
    ],
    expectedConfig: 'CA policy requiring MFA for "Microsoft Admin Portals" for all users.',
    commonMisconfigs: [
      'No specific policy for admin portals',
      'Relying on Security Defaults only',
      'Exclusions for convenience',
    ],
    fixHint: 'Create CA policy targeting "Microsoft Admin Portals" cloud app, requiring MFA for all users.',
  },

  // Section 5.3 - Periodic Identity Reviews
  {
    id: 'CIS-AZ-5.3.1',
    title: 'Ensure Guest Users Are Reviewed at Least Monthly',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify guest user accounts are reviewed regularly and stale guests are removed.',
    whyItMatters: 'Guest accounts can become orphaned when business relationships end. Regular review prevents unauthorized access.',
    consoleSteps: [
      'Go to Microsoft Entra admin center → Users → All users',
      'Filter by User type: Guest',
      'Review each guest for current business need',
      'Configure Access Reviews for automated review',
    ],
    cliCheck: 'az ad user list --filter "userType eq \'Guest\'" --query "[].{UPN:userPrincipalName,Created:createdDateTime}"',
    expectedConfig: 'Access Reviews configured for guest users. Monthly review cadence. Stale guests removed.',
    commonMisconfigs: [
      'No regular guest review',
      'Stale guest accounts remain',
      'No Access Reviews configured',
    ],
    fixHint: 'Configure Access Reviews for guest users with monthly frequency. Remove guests no longer needed.',
  },
  {
    id: 'CIS-AZ-5.3.2',
    title: 'Ensure User Access Administrator Role Is Reviewed Periodically',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify members of User Access Administrator role are reviewed regularly.',
    whyItMatters: 'User Access Administrator can grant access to Azure resources. Unauthorized holders could elevate privileges.',
    consoleSteps: [
      'Go to Azure Portal → Subscriptions → Access control (IAM)',
      'Check role assignments for User Access Administrator',
      'Review each assignment for business justification',
      'Configure Access Reviews for the role',
    ],
    cliCheck: 'az role assignment list --role "User Access Administrator" --query "[].{Principal:principalName,Scope:scope}"',
    expectedConfig: 'Minimal User Access Administrator assignments. Regular review process. PIM used for just-in-time access.',
    commonMisconfigs: [
      'Multiple permanent assignments',
      'No regular review',
      'Service principals with role',
    ],
    fixHint: 'Review and reduce User Access Administrator assignments. Use PIM for just-in-time access.',
  },
  {
    id: 'CIS-AZ-5.3.3',
    title: 'Ensure Privileged Role Assignments Are Reviewed Regularly',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify all privileged Entra ID and Azure RBAC roles are reviewed periodically.',
    whyItMatters: 'Privileged role assignments can drift over time. Regular review ensures only authorized users have elevated access.',
    consoleSteps: [
      'Go to Microsoft Entra admin center → Identity Governance → Access Reviews',
      'Verify reviews exist for privileged roles',
      'Check Global Admin, User Admin, Security Admin, etc.',
      'Confirm reviews are completed on schedule',
    ],
    expectedConfig: 'Access Reviews configured for all privileged roles. Quarterly review minimum. Actions taken on review results.',
    commonMisconfigs: [
      'No Access Reviews configured',
      'Reviews not completed',
      'Findings not remediated',
    ],
    fixHint: 'Create Access Reviews for privileged Entra ID roles. Set quarterly frequency. Assign reviewers and enforce remediation.',
  },
  {
    id: 'CIS-AZ-5.3.4',
    title: 'Ensure Administrative Accounts Use Phishing-Resistant MFA',
    severity: 'Critical',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify admin accounts use phishing-resistant MFA methods like FIDO2 or Windows Hello.',
    whyItMatters: 'SMS and phone call MFA are vulnerable to SIM swapping. Phishing-resistant methods protect privileged accounts.',
    consoleSteps: [
      'Go to Microsoft Entra admin center → Users',
      'Check authentication methods for admin accounts',
      'Verify FIDO2 security keys or Windows Hello are registered',
      'Configure Conditional Access to require phishing-resistant MFA',
    ],
    expectedConfig: 'Admin accounts using FIDO2, Windows Hello, or certificate-based auth. CA policy enforcing authentication strength.',
    commonMisconfigs: [
      'SMS/phone MFA for admins',
      'Authenticator app without number matching',
      'No phishing-resistant requirement',
    ],
    fixHint: 'Register FIDO2 keys for admin accounts. Create CA policy with Authentication Strengths requiring phishing-resistant MFA.',
  },
  {
    id: 'CIS-AZ-5.3.5',
    title: 'Ensure Disabled Accounts Have No Azure RBAC Permissions',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify disabled user accounts have had their Azure RBAC role assignments removed.',
    whyItMatters: 'Disabled accounts with role assignments could be re-enabled and have immediate access. Clean up prevents this risk.',
    consoleSteps: [
      'Identify disabled users in Entra ID',
      'Query Azure RBAC for assignments to disabled users',
      'Remove any role assignments found',
      'Automate this process',
    ],
    cliCheck: 'az role assignment list --all --query "[?principalType==\'User\']" | cross-reference with disabled users',
    expectedConfig: 'No disabled users have Azure RBAC role assignments. Automated cleanup process.',
    commonMisconfigs: [
      'Role assignments remain after disabling',
      'No offboarding process',
      'Manual cleanup missed some assignments',
    ],
    fixHint: 'Query and remove RBAC assignments for disabled users. Implement automation in offboarding workflow.',
  },
  {
    id: 'CIS-AZ-5.3.6',
    title: 'Ensure Tenant Creator Role Is Reviewed and Minimized',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify users with Tenant Creator role are reviewed and justified.',
    whyItMatters: 'Tenant Creator can create new Entra ID tenants. Uncontrolled tenant creation leads to shadow IT.',
    consoleSteps: [
      'Go to Microsoft Entra admin center → Roles and administrators',
      'Search for Tenant Creator role',
      'Review assigned users',
      'Remove unnecessary assignments',
    ],
    expectedConfig: 'Minimal Tenant Creator role assignments. Each assignment documented with business justification.',
    commonMisconfigs: [
      'Default assignments not reviewed',
      'No documentation of assignments',
      'Broad assignment to users',
    ],
    fixHint: 'Review Tenant Creator assignments. Remove unless specifically needed. Document business justification.',
  },
  {
    id: 'CIS-AZ-5.3.7',
    title: 'Ensure Non-Privileged Role Assignments Are Reviewed Annually',
    severity: 'Low',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify non-privileged Azure RBAC assignments are reviewed at least annually.',
    whyItMatters: 'Access can accumulate over time. Annual review ensures users only have currently needed permissions.',
    consoleSteps: [
      'Go to Azure Portal → Management Groups or Subscriptions → Access control',
      'Review role assignments',
      'Configure Access Reviews for broader scope',
      'Document review completion',
    ],
    expectedConfig: 'Annual Access Reviews for Azure RBAC assignments. Documentation of reviews and actions taken.',
    commonMisconfigs: [
      'No regular review process',
      'Reviews only for privileged roles',
      'No documentation of reviews',
    ],
    fixHint: 'Create Access Reviews for Azure resource roles. Set annual frequency for non-privileged roles.',
  },

  // Section 5.4-5.28 - Additional Identity Controls
  {
    id: 'CIS-AZ-5.4',
    title: 'Ensure Non-Admins Cannot Create Tenants',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify only authorized users can create new Entra ID tenants.',
    whyItMatters: 'Unrestricted tenant creation leads to shadow IT, unmanaged identities, and security blind spots.',
    consoleSteps: [
      'Go to Microsoft Entra admin center → User settings',
      'Check "Restrict non-admin users from creating tenants"',
      'Verify it is set to Yes',
    ],
    expectedConfig: 'Tenant creation restricted to admins only. Users cannot create new Entra ID tenants.',
    commonMisconfigs: [
      'Default setting allows tenant creation',
      'Not reviewed after initial setup',
    ],
    fixHint: 'Enable "Restrict non-admin users from creating tenants" in User settings.',
  },
  {
    id: 'CIS-AZ-5.5',
    title: 'Ensure Minimum Password Reset Methods Are Configured',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify self-service password reset requires at least two authentication methods.',
    whyItMatters: 'Requiring multiple methods for password reset prevents account takeover through single compromised factor.',
    consoleSteps: [
      'Go to Microsoft Entra admin center → Protection → Password reset',
      'Check "Number of methods required to reset"',
      'Verify it is set to 2',
    ],
    expectedConfig: 'Password reset requires 2 authentication methods. Secure methods configured.',
    commonMisconfigs: [
      'Only 1 method required',
      'Insecure methods allowed (security questions)',
      'Email only reset enabled',
    ],
    fixHint: 'Set password reset to require 2 methods. Disable security questions and email-only reset.',
  },
  {
    id: 'CIS-AZ-5.6',
    title: 'Ensure Account Lockout Threshold Is Configured',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify smart lockout threshold is configured to prevent brute force attacks.',
    whyItMatters: 'Account lockout prevents automated password guessing attacks while smart lockout minimizes user impact.',
    consoleSteps: [
      'Go to Microsoft Entra admin center → Protection → Authentication methods',
      'Navigate to Password protection',
      'Check Lockout threshold settings',
    ],
    expectedConfig: 'Smart lockout enabled with appropriate threshold (10 or fewer attempts).',
    commonMisconfigs: [
      'Lockout threshold too high',
      'Smart lockout disabled',
      'No lockout duration set',
    ],
    fixHint: 'Configure smart lockout with threshold of 10 attempts and appropriate lockout duration.',
  },
  {
    id: 'CIS-AZ-5.7',
    title: 'Ensure Account Lockout Duration Is Configured',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify lockout duration is set to delay repeated authentication attempts.',
    whyItMatters: 'Lockout duration slows brute force attacks, making them impractical while allowing legitimate users to retry.',
    consoleSteps: [
      'Go to Microsoft Entra admin center → Protection → Authentication methods',
      'Navigate to Password protection',
      'Check Lockout duration in seconds',
    ],
    expectedConfig: 'Lockout duration set to 60 seconds or more. Progressive lockout enabled.',
    commonMisconfigs: [
      'Duration too short',
      'No lockout configured',
      'Immediate unlock allowed',
    ],
    fixHint: 'Configure lockout duration to at least 60 seconds. Enable progressive lockout.',
  },
  {
    id: 'CIS-AZ-5.8',
    title: 'Ensure Custom Banned Password List Is Configured',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify custom banned password list includes organization-specific terms.',
    whyItMatters: 'Custom banned passwords prevent use of easily guessable passwords based on company name, products, or industry terms.',
    consoleSteps: [
      'Go to Microsoft Entra admin center → Protection → Authentication methods',
      'Navigate to Password protection',
      'Check Custom banned password list',
      'Verify relevant terms are included',
    ],
    expectedConfig: 'Custom banned password list enabled with company name, products, locations, and industry terms.',
    commonMisconfigs: [
      'No custom list configured',
      'List not comprehensive',
      'Only default protection used',
    ],
    fixHint: 'Enable custom banned password list. Add company name, products, services, and industry-specific terms.',
  },
  {
    id: 'CIS-AZ-5.9',
    title: 'Ensure Password Protection Is Enforced On-Premises',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify Azure AD Password Protection is deployed for on-premises Active Directory.',
    whyItMatters: 'On-premises password protection ensures banned passwords cannot be used in hybrid environments.',
    consoleSteps: [
      'Go to Microsoft Entra admin center → Protection → Authentication methods',
      'Navigate to Password protection',
      'Check "Enable password protection on Windows Server Active Directory"',
      'Verify agents are deployed and healthy',
    ],
    expectedConfig: 'Password protection enabled for on-premises AD. Agents deployed on all DCs.',
    commonMisconfigs: [
      'Not enabled for on-premises',
      'Agents not deployed on all DCs',
      'Audit mode instead of Enforce',
    ],
    fixHint: 'Deploy Azure AD Password Protection agents on all domain controllers. Enable enforcement mode.',
  },
  {
    id: 'CIS-AZ-5.10',
    title: 'Ensure Notification on Password Reset Is Enabled',
    severity: 'Low',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify users are notified when their password is reset.',
    whyItMatters: 'Password reset notifications alert users to potential account compromise.',
    consoleSteps: [
      'Go to Microsoft Entra admin center → Protection → Password reset',
      'Check Notifications settings',
      'Verify "Notify users on password resets?" is Yes',
    ],
    expectedConfig: 'Users notified on password resets. Admins notified when other admins reset passwords.',
    commonMisconfigs: [
      'Notifications disabled',
      'Admin reset notifications disabled',
    ],
    fixHint: 'Enable password reset notifications for users and admin password resets.',
  },
  {
    id: 'CIS-AZ-5.11',
    title: 'Ensure Admins Are Notified of Admin Password Resets',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify admins are notified when another admin resets their password.',
    whyItMatters: 'Admin password reset notification helps detect unauthorized administrative actions.',
    consoleSteps: [
      'Go to Microsoft Entra admin center → Protection → Password reset',
      'Check Notifications settings',
      'Verify "Notify all admins when other admins reset their password?" is Yes',
    ],
    expectedConfig: 'Admin password reset notifications enabled.',
    commonMisconfigs: [
      'Admin notifications disabled',
      'Only some admins notified',
    ],
    fixHint: 'Enable notification for admin password resets in Password reset settings.',
  },
  {
    id: 'CIS-AZ-5.12',
    title: 'Ensure User Consent to Apps Is Restricted',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify users cannot consent to apps accessing organization data.',
    whyItMatters: 'Unrestricted app consent allows users to grant malicious apps access to organization data.',
    consoleSteps: [
      'Go to Microsoft Entra admin center → Applications → Enterprise applications',
      'Navigate to Consent and permissions',
      'Check user consent settings',
      'Verify consent is restricted or disabled',
    ],
    expectedConfig: 'User consent disabled or limited to verified publishers for low-risk permissions.',
    commonMisconfigs: [
      'Users can consent to any app',
      'No admin consent workflow',
      'Consent for high-risk permissions allowed',
    ],
    fixHint: 'Restrict user consent to verified publishers only. Implement admin consent workflow.',
  },
  {
    id: 'CIS-AZ-5.13',
    title: 'Ensure Admin Consent Workflow Is Configured',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify admin consent workflow is enabled for app consent requests.',
    whyItMatters: 'Admin consent workflow allows controlled app approvals while preventing shadow IT.',
    consoleSteps: [
      'Go to Microsoft Entra admin center → Applications → Enterprise applications',
      'Navigate to Consent and permissions → Admin consent settings',
      'Verify admin consent workflow is enabled',
      'Check designated reviewers',
    ],
    expectedConfig: 'Admin consent workflow enabled. Reviewers designated. Notifications configured.',
    commonMisconfigs: [
      'Workflow not enabled',
      'No reviewers assigned',
      'Requests not reviewed timely',
    ],
    fixHint: 'Enable admin consent requests. Assign reviewers and configure notifications.',
  },
  {
    id: 'CIS-AZ-5.14',
    ...
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify only authorized users can register applications in Entra ID.',
    whyItMatters: 'Unrestricted app registration can lead to over-privileged applications and security blind spots.',
    consoleSteps: [
      'Go to Microsoft Entra admin center → Users → User settings',
      'Check "Users can register applications"',
      'Verify it is set to No',
    ],
    expectedConfig: 'User app registration disabled. Only authorized roles can register applications.',
    commonMisconfigs: [
      'All users can register apps',
      'No governance over app registration',
    ],
    fixHint: 'Set "Users can register applications" to No. Assign Application Developer role to authorized users.',
  },
  {
    id: 'CIS-AZ-5.15',
    ...
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify guest users have limited directory permissions.',
    whyItMatters: 'Guests with broad permissions can enumerate users, groups, and applications, gathering information for attacks.',
    consoleSteps: [
      'Go to Microsoft Entra admin center → Users → User settings',
      'Navigate to External collaboration settings',
      'Check guest user access restrictions',
      'Verify most restrictive setting is applied',
    ],
    expectedConfig: 'Guest user access set to most restrictive. Guests cannot enumerate directory objects.',
    commonMisconfigs: [
      'Guests have same access as members',
      'Guests can enumerate users and groups',
      'No restrictions configured',
    ],
    fixHint: 'Set guest user access to "Guest user access is restricted to properties and memberships of their own directory objects".',
  },
  {
    id: 'CIS-AZ-5.16',
    title: 'Ensure Guest Invite Restrictions Are Configured',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify only admins can invite guest users.',
    whyItMatters: 'Unrestricted guest invitations can lead to unauthorized external users accessing organization resources.',
    consoleSteps: [
      'Go to Microsoft Entra admin center → Users → User settings',
      'Navigate to External collaboration settings',
      'Check guest invite restrictions',
      'Verify appropriate restriction level',
    ],
    expectedConfig: 'Guest invite settings restricted to admins and users with guest inviter role.',
    commonMisconfigs: [
      'Anyone can invite guests',
      'Members can invite guests',
      'Guests can invite other guests',
    ],
    fixHint: 'Set guest invite settings to "Only users assigned to specific admin roles can invite guest users".',
  },
  {
    id: 'CIS-AZ-5.17',
    title: 'Ensure Admin Portal Access Is Restricted',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify non-admin users cannot access Entra admin center.',
    whyItMatters: 'Restricting admin portal access reduces information disclosure and potential attack surface.',
    consoleSteps: [
      'Go to Microsoft Entra admin center → Users → User settings',
      'Check "Restrict access to Microsoft Entra admin center"',
      'Verify it is set to Yes',
    ],
    expectedConfig: 'Admin portal access restricted to admins. Non-admin users cannot access Entra admin center.',
    commonMisconfigs: [
      'All users can access admin portal',
      'Not configured after setup',
    ],
    fixHint: 'Enable "Restrict access to Microsoft Entra admin center" in User settings.',
  },
  {
    id: 'CIS-AZ-5.18',
    title: 'Ensure LinkedIn Integration Is Disabled',
    severity: 'Low',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify LinkedIn account connections are disabled.',
    whyItMatters: 'LinkedIn integration shares organizational data with external service and may expose user information.',
    consoleSteps: [
      'Go to Microsoft Entra admin center → Users → User settings',
      'Check LinkedIn account connections',
      'Verify it is set to No',
    ],
    expectedConfig: 'LinkedIn account connections disabled.',
    commonMisconfigs: [
      'LinkedIn integration enabled by default',
      'Not reviewed during setup',
    ],
    fixHint: 'Disable LinkedIn account connections in User settings.',
  },
  {
    id: 'CIS-AZ-5.19',
    title: 'Ensure Group Owners Cannot Add Guests',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify group owners cannot add guest members to groups.',
    whyItMatters: 'Allowing group owners to add guests can lead to unauthorized external access to group resources.',
    consoleSteps: [
      'Go to Microsoft Entra admin center → Groups → General',
      'Check "Owners can manage group membership requests in My Groups"',
      'Review guest addition capabilities',
    ],
    expectedConfig: 'Group owners cannot add guests. Only admins can add guest members.',
    commonMisconfigs: [
      'Group owners can add any guests',
      'No restrictions on guest additions',
    ],
    fixHint: 'Restrict guest user additions to admins through External collaboration settings.',
  },
  {
    id: 'CIS-AZ-5.20',
    title: 'Ensure M365 Group Creation Is Restricted',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify only authorized users can create Microsoft 365 groups.',
    whyItMatters: 'Unrestricted group creation leads to sprawl, inconsistent naming, and ungoverned resources.',
    consoleSteps: [
      'Go to Microsoft Entra admin center → Groups → General',
      'Check M365 group creation settings',
      'Verify creation is restricted to specific group',
    ],
    expectedConfig: 'M365 group creation restricted to authorized users. Naming policy enforced.',
    commonMisconfigs: [
      'All users can create groups',
      'No naming policy',
      'No group governance',
    ],
    fixHint: 'Restrict M365 group creation to a security group. Implement naming policy.',
  },
  {
    id: 'CIS-AZ-5.21',
    title: 'Ensure Require MFA to Register or Join Devices Is Enabled',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify MFA is required when joining devices to Entra ID.',
    whyItMatters: 'Requiring MFA for device registration prevents unauthorized devices from joining the directory.',
    consoleSteps: [
      'Go to Microsoft Entra admin center → Devices → Device settings',
      'Check "Require Multi-Factor Authentication to register or join devices with Microsoft Entra"',
      'Verify it is set to Yes',
    ],
    expectedConfig: 'MFA required for device registration and join.',
    commonMisconfigs: [
      'MFA not required for device join',
      'Allows unauthorized device enrollment',
    ],
    fixHint: 'Enable "Require Multi-Factor Authentication to register or join devices" in Device settings.',
  },
  {
    id: 'CIS-AZ-5.22',
    title: 'Ensure Custom Role Usage Is Documented',
    severity: 'Low',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify custom roles are documented with justification and reviewed regularly.',
    whyItMatters: 'Custom roles can have overly broad permissions. Documentation and review ensure least privilege.',
    consoleSteps: [
      'Go to Microsoft Entra admin center → Roles and administrators',
      'Filter to show custom roles',
      'Review each custom role definition',
      'Verify documentation exists',
    ],
    cliCheck: 'az role definition list --custom-role-only true',
    expectedConfig: 'All custom roles documented with business justification. Regular review process.',
    commonMisconfigs: [
      'Undocumented custom roles',
      'Overly broad permissions',
      'No regular review',
    ],
    fixHint: 'Document all custom roles with justification. Review quarterly and remove unused roles.',
  },
  {
    id: 'CIS-AZ-5.23',
    title: 'Ensure Resource Locks Are Used for Critical Resources',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'storage',
    whatToCheck: 'Verify resource locks are applied to prevent accidental deletion of critical resources.',
    whyItMatters: 'Resource locks prevent accidental deletion or modification of critical infrastructure.',
    consoleSteps: [
      'Go to Azure Portal → Resource Groups or Resources',
      'Check Locks section',
      'Verify CanNotDelete or ReadOnly locks on critical resources',
    ],
    cliCheck: 'az lock list --resource-group <rg>',
    expectedConfig: 'CanNotDelete locks on critical resources. Process to unlock documented.',
    commonMisconfigs: [
      'No locks on critical resources',
      'Only some resources protected',
      'No unlock process documented',
    ],
    fixHint: 'Apply CanNotDelete locks to critical resources: az lock create --name <lock-name> --resource-group <rg> --lock-type CanNotDelete',
  },
  {
    id: 'CIS-AZ-5.24',
    title: 'Ensure Subscription Entering AAD Tenant Policy Is Configured',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify policy controls which subscriptions can be associated with the tenant.',
    whyItMatters: 'Controlling subscription association prevents unauthorized subscriptions from being linked to the tenant.',
    consoleSteps: [
      'Go to Azure Portal → Microsoft Entra ID → Properties',
      'Check "Manage tenant settings"',
      'Review subscription entering and leaving policies',
    ],
    expectedConfig: 'Subscription transfer policies configured. Only authorized subscriptions can enter tenant.',
    commonMisconfigs: [
      'No policy configured',
      'Any subscription can be transferred',
    ],
    fixHint: 'Configure subscription directory changing policies to require admin approval.',
  },
  {
    id: 'CIS-AZ-5.25',
    title: 'Ensure Global Admin Count Is Minimized',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify Global Administrator role assignments are minimized (2-4 recommended).',
    whyItMatters: 'Global Admins have unrestricted access. Minimizing count reduces risk of compromise and abuse.',
    consoleSteps: [
      'Go to Microsoft Entra admin center → Roles and administrators',
      'Select Global Administrator role',
      'Count assigned users',
      'Review each for justification',
    ],
    cliCheck: 'az ad directory-role show --id <global-admin-role-id> --query members',
    expectedConfig: '2-4 Global Administrators. Each with documented justification. PIM used where possible.',
    commonMisconfigs: [
      'More than 4 Global Admins',
      'Service accounts as Global Admin',
      'No justification documented',
    ],
    fixHint: 'Reduce Global Admin count. Use specific admin roles instead. Implement PIM for just-in-time access.',
  },
  {
    id: 'CIS-AZ-5.26',
    title: 'Ensure Subscription Owner Count Is Appropriate',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify subscription Owner role assignments are minimized (3 or fewer).',
    whyItMatters: 'Subscription Owners have full control. Limiting count reduces risk and ensures accountability.',
    consoleSteps: [
      'Go to Azure Portal → Subscriptions → Access control (IAM)',
      'Filter by Owner role',
      'Count owners and review justifications',
    ],
    cliCheck: 'az role assignment list --role Owner --scope /subscriptions/<subscription-id>',
    expectedConfig: '3 or fewer subscription Owners. Each with documented business need.',
    commonMisconfigs: [
      'More than 3 Owners',
      'Service principals as Owner',
      'No regular review of Owners',
    ],
    fixHint: 'Reduce Owner count. Use specific roles (Contributor, Reader) instead. Document remaining Owners.',
  },
  {
    id: 'CIS-AZ-5.27',
    title: 'Ensure Passkey/FIDO2 Authentication Is Available',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify FIDO2 security key authentication is enabled and available.',
    whyItMatters: 'FIDO2 provides phishing-resistant authentication, protecting against credential theft attacks.',
    consoleSteps: [
      'Go to Microsoft Entra admin center → Protection → Authentication methods',
      'Check FIDO2 security key settings',
      'Verify it is enabled for users',
      'Check key restrictions',
    ],
    expectedConfig: 'FIDO2 enabled for all users or specific groups. Supported key types defined.',
    commonMisconfigs: [
      'FIDO2 not enabled',
      'Only enabled for admins',
      'No attestation requirements',
    ],
    fixHint: 'Enable FIDO2 security keys in Authentication methods. Define allowed key types if needed.',
  },
  {
    id: 'CIS-AZ-5.28',
    title: 'Ensure Microsoft Authenticator Is Configured with Number Matching',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify Microsoft Authenticator requires number matching for push notifications.',
    whyItMatters: 'Number matching prevents MFA fatigue attacks where users accidentally approve malicious requests.',
    consoleSteps: [
      'Go to Microsoft Entra admin center → Protection → Authentication methods',
      'Check Microsoft Authenticator settings',
      'Verify number matching is required',
      'Check additional context is shown',
    ],
    expectedConfig: 'Number matching required for Microsoft Authenticator. Additional context enabled.',
    commonMisconfigs: [
      'Simple approve/deny still allowed',
      'Number matching not enforced',
      'No additional context shown',
    ],
    fixHint: 'Enable number matching and additional context in Microsoft Authenticator settings.',
  },

  // Section 6.1.1 - Diagnostic Settings
  {
    id: 'CIS-AZ-6.1.1.1',
    title: 'Ensure Subscription Activity Logs Are Exported',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'logging',
    whatToCheck: 'Verify Activity Logs are exported to Log Analytics, Storage, or Event Hub.',
    whyItMatters: 'Activity Log export enables long-term retention, analysis, and SIEM integration for security monitoring.',
    consoleSteps: [
      'Go to Azure Portal → Monitor → Activity log',
      'Click "Export Activity Logs"',
      'Verify diagnostic setting exists',
      'Check destination (Log Analytics, Storage, Event Hub)',
    ],
    cliCheck: 'az monitor diagnostic-settings subscription list',
    expectedConfig: 'Activity Log exported to Log Analytics workspace. All categories enabled. Retention configured.',
    commonMisconfigs: [
      'No diagnostic setting configured',
      'Only some categories exported',
      'No retention policy',
    ],
    fixHint: 'Create diagnostic setting to export Activity Logs to Log Analytics workspace with all categories enabled.',
  },
  {
    id: 'CIS-AZ-6.1.1.2',
    title: 'Ensure Appropriate Log Categories Are Enabled',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'logging',
    whatToCheck: 'Verify all security-relevant Activity Log categories are exported.',
    whyItMatters: 'Missing log categories create visibility gaps in security monitoring.',
    consoleSteps: [
      'Go to Azure Portal → Monitor → Diagnostic settings',
      'Check subscription-level diagnostic setting',
      'Verify Administrative, Security, Alert, and Policy categories are enabled',
    ],
    expectedConfig: 'Administrative, Security, Alert, and Policy categories exported at minimum.',
    commonMisconfigs: [
      'Only Administrative category enabled',
      'Security category missing',
      'Selective category export',
    ],
    fixHint: 'Update diagnostic setting to include Administrative, Security, Alert, Policy, and Autoscale categories.',
  },
  {
    id: 'CIS-AZ-6.1.1.3',
    title: 'Ensure Logs Are Encrypted with Customer-Managed Keys',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'encryption',
    whatToCheck: 'Verify Log Analytics workspace uses customer-managed keys for encryption.',
    whyItMatters: 'CMK encryption provides control over log data encryption and meets compliance requirements.',
    consoleSteps: [
      'Go to Log Analytics workspace → Properties',
      'Check encryption configuration',
      'Verify CMK is configured',
    ],
    cliCheck: 'az monitor log-analytics workspace show --workspace-name <name> --resource-group <rg> --query "features.clusterResourceId"',
    expectedConfig: 'Log Analytics workspace using CMK encryption through dedicated cluster.',
    commonMisconfigs: [
      'Using Microsoft-managed keys',
      'No dedicated cluster for CMK',
      'CMK not configured',
    ],
    fixHint: 'Create Log Analytics cluster with CMK. Link workspace to cluster for CMK encryption.',
  },
  {
    id: 'CIS-AZ-6.1.1.4',
    title: 'Ensure Key Vault Logging Is Enabled',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'logging',
    whatToCheck: 'Verify diagnostic settings are enabled for all Key Vaults.',
    whyItMatters: 'Key Vault logs capture all operations on secrets, keys, and certificates for audit and security monitoring.',
    consoleSteps: [
      'Go to Azure Portal → Key Vaults',
      'Select each Key Vault → Diagnostic settings',
      'Verify AuditEvent and AllMetrics are enabled',
      'Check destination configuration',
    ],
    cliCheck: 'az monitor diagnostic-settings list --resource <key-vault-resource-id>',
    expectedConfig: 'Diagnostic settings enabled with AuditEvent logs sent to Log Analytics.',
    commonMisconfigs: [
      'No diagnostic settings',
      'Logging only to storage',
      'AllMetrics not enabled',
    ],
    fixHint: 'Enable diagnostic settings on all Key Vaults with AuditEvent logs to Log Analytics workspace.',
  },
  {
    id: 'CIS-AZ-6.1.1.5',
    ...
    framework: 'CIS Benchmark',
    category: 'logging',
    whatToCheck: 'Verify NSG Flow Logs are enabled for all Network Security Groups.',
    whyItMatters: 'NSG Flow Logs capture network traffic metadata for security analysis and forensics.',
    consoleSteps: [
      'Go to Azure Portal → Network Watcher → NSG flow logs',
      'Verify flow logs are enabled for all NSGs',
      'Check retention and version settings',
    ],
    cliCheck: 'az network watcher flow-log list --location <location>',
    expectedConfig: 'Flow logs enabled on all NSGs. Version 2 used. 90+ day retention. Traffic Analytics enabled.',
    commonMisconfigs: [
      'Flow logs not enabled',
      'Using Version 1',
      'Insufficient retention',
    ...
    fixHint: 'Enable NSG flow logs version 2 with Traffic Analytics and 90+ day retention.',
  },
  {
    id: 'CIS-AZ-6.1.1.6',
    title: 'Ensure App Service HTTP Logging Is Enabled',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'logging',
    whatToCheck: 'Verify HTTP logging is enabled for App Services.',
    whyItMatters: 'HTTP logs provide visibility into web requests for security analysis and troubleshooting.',
    consoleSteps: [
      'Go to Azure Portal → App Services',
      'Select App Service → App Service logs',
      'Verify Web server logging is enabled',
      'Check retention settings',
    ],
    cliCheck: 'az webapp log show --name <app> --resource-group <rg>',
    expectedConfig: 'HTTP logging enabled. Logs retained for minimum 90 days. Logs sent to Log Analytics.',
    commonMisconfigs: [
      'HTTP logging disabled',
      'Short retention period',
      'Logs only in file system',
    ],
    fixHint: 'Enable HTTP logging in App Service logs. Configure Log Analytics integration.',
  },
  {
    id: 'CIS-AZ-6.1.1.7',
    title: 'Ensure VNet Flow Logs Are Enabled',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'logging',
    whatToCheck: 'Verify VNet Flow Logs are enabled for virtual networks.',
    whyItMatters: 'VNet flow logs capture traffic data for security monitoring and capacity planning.',
    consoleSteps: [
      'Go to Azure Portal → Network Watcher → VNet flow logs',
      'Verify flow logs are enabled for VNets',
      'Check retention and destination settings',
    ],
    cliCheck: 'az network watcher flow-log list --location <location>',
    expectedConfig: 'VNet flow logs enabled on all production VNets. 90+ day retention.',
    commonMisconfigs: [
      'VNet flow logs not enabled',
      'Insufficient retention',
      'Not all VNets covered',
    ],
    fixHint: 'Enable VNet flow logs with 90-day retention. Configure Traffic Analytics for analysis.',
  },
  {
    id: 'CIS-AZ-6.1.1.8',
    title: 'Ensure Microsoft Graph Activity Logs Are Exported',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'logging',
    whatToCheck: 'Verify Microsoft Graph activity logs are collected and exported.',
    whyItMatters: 'Graph activity logs capture API calls to Microsoft 365 and Entra ID for security analysis.',
    consoleSteps: [
      'Go to Microsoft Entra admin center → Monitoring → Diagnostic settings',
      'Check for Microsoft Graph activity logs configuration',
      'Verify export to Log Analytics',
    ],
    expectedConfig: 'Microsoft Graph activity logs exported to Log Analytics or SIEM.',
    commonMisconfigs: [
      'Graph activity logs not collected',
      'Logs not exported to SIEM',
      'Short retention period',
    ],
    fixHint: 'Configure diagnostic settings to export Microsoft Graph activity logs to Log Analytics.',
  },
  {
    id: 'CIS-AZ-6.1.1.9',
    title: 'Ensure Entra ID Activity Logs Are Exported',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'logging',
    whatToCheck: 'Verify Entra ID sign-in and audit logs are exported.',
    whyItMatters: 'Entra ID logs are critical for detecting identity-based attacks and compliance reporting.',
    consoleSteps: [
      'Go to Microsoft Entra admin center → Monitoring → Diagnostic settings',
      'Verify sign-in logs and audit logs are enabled',
      'Check export destination',
    ],
    cliCheck: 'az monitor diagnostic-settings list --resource /providers/Microsoft.aadiam',
    expectedConfig: 'Sign-in logs, audit logs, and provisioning logs exported to Log Analytics.',
    commonMisconfigs: [
      'Logs not exported',
      'Only audit logs exported',
      'Sign-in logs missing',
    ],
    fixHint: 'Configure Entra ID diagnostic settings to export all log categories to Log Analytics.',
  },
  {
    id: 'CIS-AZ-6.1.1.10',
    title: 'Ensure Intune Logs Are Exported',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'logging',
    whatToCheck: 'Verify Microsoft Intune logs are exported for device management visibility.',
    whyItMatters: 'Intune logs provide visibility into device compliance and management activities.',
    consoleSteps: [
      'Go to Intune admin center → Reports → Diagnostic settings',
      'Verify logs are configured for export',
      'Check destination settings',
    ],
    expectedConfig: 'Intune operational logs and audit logs exported to Log Analytics.',
    commonMisconfigs: [
      'Intune logging not configured',
      'Only compliance logs exported',
      'No SIEM integration',
    ],
    fixHint: 'Configure Intune diagnostic settings to export logs to Log Analytics workspace.',
  },

  // Section 6.1.2 - Activity Log Alerts
  {
    id: 'CIS-AZ-6.1.2.1',
    title: 'Ensure Alert Exists for Create Policy Assignment',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'logging',
    whatToCheck: 'Verify Activity Log alert exists for policy assignment creation.',
    whyItMatters: 'Policy changes can weaken security posture. Alerts enable rapid response to unauthorized changes.',
    consoleSteps: [
      'Go to Azure Portal → Monitor → Alerts',
      'Check for Activity Log alerts',
      'Verify alert for "Create policy assignment" operation',
    ],
    cliCheck: 'az monitor activity-log alert list',
    expectedConfig: 'Alert configured for Microsoft.Authorization/policyAssignments/write operation.',
    commonMisconfigs: [
      'No alert configured',
      'Alert not triggering notifications',
      'Wrong action group',
    ],
    fixHint: 'Create Activity Log alert for Microsoft.Authorization/policyAssignments/write with appropriate action group.',
  },
  {
    id: 'CIS-AZ-6.1.2.2',
    title: 'Ensure Alert Exists for Delete Policy Assignment',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'logging',
    whatToCheck: 'Verify Activity Log alert exists for policy assignment deletion.',
    whyItMatters: 'Deleting policy assignments can disable security controls. Alerts detect unauthorized removal.',
    consoleSteps: [
      'Go to Azure Portal → Monitor → Alerts',
      'Check for Activity Log alerts',
      'Verify alert for "Delete policy assignment" operation',
    ],
    cliCheck: 'az monitor activity-log alert list',
    expectedConfig: 'Alert configured for Microsoft.Authorization/policyAssignments/delete operation.',
    commonMisconfigs: [
      'No alert configured',
      'Alert disabled',
      'Notifications not sent',
    ],
    fixHint: 'Create Activity Log alert for policy assignment delete operation.',
  },
  {
    id: 'CIS-AZ-6.1.2.3',
    title: 'Ensure Alert Exists for Create/Update NSG',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'logging',
    whatToCheck: 'Verify Activity Log alert exists for NSG creation and modification.',
    whyItMatters: 'NSG changes can open network access. Alerts enable rapid detection of unauthorized rule changes.',
    consoleSteps: [
      'Go to Azure Portal → Monitor → Alerts',
      'Check for Activity Log alerts',
      'Verify alert for NSG write operations',
    ],
    cliCheck: 'az monitor activity-log alert list',
    expectedConfig: 'Alert configured for Microsoft.Network/networkSecurityGroups/write operation.',
    commonMisconfigs: [
      'No NSG change alerts',
      'Only delete alerts configured',
      'Alerts not sent to security team',
    ],
    fixHint: 'Create Activity Log alert for Microsoft.Network/networkSecurityGroups/write with security team notification.',
  },
  {
    id: 'CIS-AZ-6.1.2.4',
    title: 'Ensure Alert Exists for Delete NSG',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'logging',
    whatToCheck: 'Verify Activity Log alert exists for NSG deletion.',
    whyItMatters: 'NSG deletion removes network protection. Immediate alerting enables rapid remediation.',
    consoleSteps: [
      'Go to Azure Portal → Monitor → Alerts',
      'Check for Activity Log alerts',
      'Verify alert for NSG delete operations',
    ],
    cliCheck: 'az monitor activity-log alert list',
    expectedConfig: 'Alert configured for Microsoft.Network/networkSecurityGroups/delete operation.',
    commonMisconfigs: [
      'No delete alert',
      'Alert not properly configured',
      'Wrong severity level',
    ],
    fixHint: 'Create Activity Log alert for Microsoft.Network/networkSecurityGroups/delete operation.',
  },
  {
    id: 'CIS-AZ-6.1.2.5',
    title: 'Ensure Alert Exists for Create/Update Security Solution',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'logging',
    whatToCheck: 'Verify Activity Log alert exists for security solution changes.',
    whyItMatters: 'Changes to security solutions can weaken protection. Alerts detect potential security degradation.',
    consoleSteps: [
      'Go to Azure Portal → Monitor → Alerts',
      'Check for Activity Log alerts',
      'Verify alert for security solution write operations',
    ],
    expectedConfig: 'Alert configured for Microsoft.Security/securitySolutions/write operation.',
    commonMisconfigs: [
      'No security solution alerts',
      'Alerts not monitored',
      'No action group configured',
    ],
    fixHint: 'Create Activity Log alert for security solution create/update operations.',
  },
  {
    id: 'CIS-AZ-6.1.2.6',
    title: 'Ensure Alert Exists for Delete Security Solution',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'logging',
    whatToCheck: 'Verify Activity Log alert exists for security solution deletion.',
    whyItMatters: 'Deleting security solutions removes protection. Alerts enable rapid response.',
    consoleSteps: [
      'Go to Azure Portal → Monitor → Alerts',
      'Check for Activity Log alerts',
      'Verify alert for security solution delete operations',
    ],
    expectedConfig: 'Alert configured for Microsoft.Security/securitySolutions/delete operation.',
    commonMisconfigs: [
      'No delete alert for security solutions',
      'Alert disabled',
    ],
    fixHint: 'Create Activity Log alert for security solution delete operation.',
  },
  {
    id: 'CIS-AZ-6.1.2.7',
    title: 'Ensure Alert Exists for Create/Update SQL Firewall Rule',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'logging',
    whatToCheck: 'Verify Activity Log alert exists for SQL firewall rule changes.',
    whyItMatters: 'SQL firewall rule changes can expose databases. Alerts detect potentially dangerous access changes.',
    consoleSteps: [
      'Go to Azure Portal → Monitor → Alerts',
      'Check for Activity Log alerts',
      'Verify alert for SQL firewall rule write operations',
    ],
    expectedConfig: 'Alert configured for Microsoft.Sql/servers/firewallRules/write operation.',
    commonMisconfigs: [
      'No SQL firewall alerts',
      'Only server-level alerts',
      'Database-level rules not monitored',
    ],
    fixHint: 'Create Activity Log alert for Microsoft.Sql/servers/firewallRules/write operation.',
  },
  {
    id: 'CIS-AZ-6.1.2.8',
    title: 'Ensure Alert Exists for Delete SQL Firewall Rule',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'logging',
    whatToCheck: 'Verify Activity Log alert exists for SQL firewall rule deletion.',
    whyItMatters: 'While deletion might indicate cleanup, it could also signal an attacker covering tracks.',
    consoleSteps: [
      'Go to Azure Portal → Monitor → Alerts',
      'Check for Activity Log alerts',
      'Verify alert for SQL firewall rule delete operations',
    ],
    expectedConfig: 'Alert configured for Microsoft.Sql/servers/firewallRules/delete operation.',
    commonMisconfigs: [
      'No delete alert',
      'Only creation monitored',
    ],
    fixHint: 'Create Activity Log alert for SQL firewall rule delete operation.',
  },
  {
    id: 'CIS-AZ-6.1.2.9',
    title: 'Ensure Alert Exists for Create/Update Public IP',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'logging',
    whatToCheck: 'Verify Activity Log alert exists for public IP address creation/modification.',
    whyItMatters: 'New public IPs increase attack surface. Alerts enable tracking of internet exposure.',
    consoleSteps: [
      'Go to Azure Portal → Monitor → Alerts',
      'Check for Activity Log alerts',
      'Verify alert for public IP write operations',
    ],
    expectedConfig: 'Alert configured for Microsoft.Network/publicIPAddresses/write operation.',
    commonMisconfigs: [
      'No public IP alerts',
      'Alerts not sent to security team',
    ],
    fixHint: 'Create Activity Log alert for Microsoft.Network/publicIPAddresses/write operation.',
  },
  {
    id: 'CIS-AZ-6.1.2.10',
    title: 'Ensure Alert Exists for Delete Public IP',
    severity: 'Low',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'logging',
    whatToCheck: 'Verify Activity Log alert exists for public IP address deletion.',
    whyItMatters: 'Public IP deletion reduces exposure but may also indicate resource removal.',
    consoleSteps: [
      'Go to Azure Portal → Monitor → Alerts',
      'Verify alert for public IP delete operations',
    ],
    expectedConfig: 'Alert configured for Microsoft.Network/publicIPAddresses/delete operation.',
    commonMisconfigs: [
      'No delete alert configured',
    ],
    fixHint: 'Create Activity Log alert for public IP delete operation.',
  },
  {
    id: 'CIS-AZ-6.1.2.11',
    title: 'Ensure Service Health Alerts Are Configured',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'logging',
    whatToCheck: 'Verify Service Health alerts are configured for relevant Azure services.',
    whyItMatters: 'Service Health alerts provide early warning of Azure platform issues affecting your resources.',
    consoleSteps: [
      'Go to Azure Portal → Monitor → Service Health',
      'Check Health alerts configuration',
      'Verify alerts cover critical services',
    ],
    expectedConfig: 'Service Health alerts configured for all critical Azure services used.',
    commonMisconfigs: [
      'No Service Health alerts',
      'Not all regions covered',
      'Not all service types covered',
    ],
    fixHint: 'Configure Service Health alerts for all Azure services used in your subscriptions.',
  },

  // Section 6.1.3-6.2 - Monitoring & Locks
  {
    id: 'CIS-AZ-6.1.3.1',
    title: 'Ensure Application Insights Is Configured',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'logging',
    whatToCheck: 'Verify Application Insights is configured for web applications.',
    whyItMatters: 'Application Insights provides deep visibility into application performance and security.',
    consoleSteps: [
      'Go to Azure Portal → Application Insights',
      'Verify App Insights instances exist for each application',
      'Check data collection settings',
    ],
    cliCheck: 'az monitor app-insights component list',
    expectedConfig: 'Application Insights configured for all web applications with appropriate sampling.',
    commonMisconfigs: [
      'No Application Insights',
      'Sampling rate too aggressive',
      'No alerting configured',
    ],
    fixHint: 'Create Application Insights resource and configure SDK in applications.',
  },
  {
    id: 'CIS-AZ-6.1.4',
    title: 'Ensure Resource Logging Is Enabled for All Services',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'logging',
    whatToCheck: 'Verify diagnostic settings are enabled for all Azure resources.',
    whyItMatters: 'Resource logging provides visibility into resource operations for security monitoring.',
    consoleSteps: [
      'Go to Azure Portal → Monitor → Diagnostic settings',
      'Review settings for each resource type',
      'Verify logs are sent to Log Analytics',
    ],
    expectedConfig: 'Diagnostic settings enabled on all resources. Logs sent to central Log Analytics workspace.',
    commonMisconfigs: [
      'Many resources without logging',
      'Logs not centralized',
      'Inconsistent retention',
    ],
    fixHint: 'Deploy Azure Policy to enforce diagnostic settings on all resource types.',
  },
  {
    id: 'CIS-AZ-6.1.5',
    title: 'Ensure SKU Basic Is Not Used for Production',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'compute',
    whatToCheck: 'Verify production resources do not use Basic SKU tiers.',
    whyItMatters: 'Basic SKUs often lack security features, SLAs, and enterprise capabilities required for production.',
    consoleSteps: [
      'Review Azure resources for SKU type',
      'Identify resources using Basic tier',
      'Verify no production workloads use Basic',
    ],
    expectedConfig: 'All production resources use Standard tier or higher. Basic tier only for development.',
    commonMisconfigs: [
      'Production VMs on Basic tier',
      'Basic load balancers in production',
      'Basic storage accounts',
    ],
    fixHint: 'Upgrade production resources to Standard tier or higher for enterprise features and SLA.',
  },
  {
    id: 'CIS-AZ-6.2',
    title: 'Ensure Resource Locks Exist for Critical Resources',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'storage',
    whatToCheck: 'Verify resource locks protect critical Azure resources from accidental deletion.',
    whyItMatters: 'Resource locks prevent accidental or malicious deletion of critical infrastructure.',
    consoleSteps: [
      'Go to Azure Portal → Resource Groups',
      'Check Locks section for each critical resource',
      'Verify CanNotDelete or ReadOnly locks',
    ],
    cliCheck: 'az lock list --resource-group <rg>',
    expectedConfig: 'CanNotDelete locks on all critical resources. Documentation for lock removal process.',
    commonMisconfigs: [
      'No locks on critical resources',
      'Inconsistent lock coverage',
      'No unlock process documented',
    ],
    fixHint: 'Apply CanNotDelete locks to critical resources. Document the unlock process for authorized changes.',
  },
  ...
  // Section 7 - Networking Services
  {
    ...
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify no NSG rules allow RDP (port 3389) from the internet.',
    whyItMatters: 'Internet-exposed RDP is a primary attack vector for brute force and credential stuffing attacks.',
    consoleSteps: [
      'Go to Azure Portal → Network Security Groups',
      'Review inbound rules for each NSG',
      'Check for rules allowing port 3389 from 0.0.0.0/0 or Internet',
    ],
    cliCheck: 'az network nsg rule list --nsg-name <nsg> --resource-group <rg> --query "[?destinationPortRange==\'3389\' && sourceAddressPrefix==\'*\']"',
    expectedConfig: 'No NSG rules allow RDP from Internet. Use Azure Bastion or VPN for RDP access.',
    commonMisconfigs: [
      'RDP open to 0.0.0.0/0',
      'RDP open from Any source',
      'No JIT access configured',
    ],
    fixHint: 'Remove or restrict RDP rules. Use Azure Bastion, JIT access, or VPN for RDP connectivity.',
  },
  {
    id: 'CIS-AZ-7.2',
    title: 'Ensure SSH Access Is Restricted from the Internet',
    ...
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify no NSG rules allow SSH (port 22) from the internet.',
    whyItMatters: 'Internet-exposed SSH is targeted by automated attacks for credential brute forcing.',
    consoleSteps: [
      'Go to Azure Portal → Network Security Groups',
      'Review inbound rules for each NSG',
      'Check for rules allowing port 22 from 0.0.0.0/0 or Internet',
    ],
    cliCheck: 'az network nsg rule list --nsg-name <nsg> --resource-group <rg> --query "[?destinationPortRange==\'22\' && sourceAddressPrefix==\'*\']"',
    expectedConfig: 'No NSG rules allow SSH from Internet. Use Azure Bastion or VPN for SSH access.',
    commonMisconfigs: [
      'SSH open to 0.0.0.0/0',
      'SSH open from Any source',
      'No JIT access configured',
    ],
    fixHint: 'Remove or restrict SSH rules. Use Azure Bastion, JIT access, or VPN for SSH connectivity.',
  },
  {
    id: 'CIS-AZ-7.3',
    title: 'Ensure UDP Access Is Restricted from the Internet',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify no NSG rules allow unrestricted UDP from the internet.',
    whyItMatters: 'UDP services are often used in amplification attacks and can be vectors for exploitation.',
    consoleSteps: [
      'Go to Azure Portal → Network Security Groups',
      'Review inbound rules for UDP protocol',
      'Check for rules allowing UDP from 0.0.0.0/0 or Internet',
    ],
    cliCheck: 'az network nsg rule list --nsg-name <nsg> --resource-group <rg> --query "[?protocol==\'UDP\' && sourceAddressPrefix==\'*\']"',
    expectedConfig: 'UDP access restricted to specific sources and ports. No unrestricted UDP from Internet.',
    commonMisconfigs: [
      'UDP open to all ports',
      'UDP from Any source',
      'DNS/NTP exposed unnecessarily',
    ],
    fixHint: 'Restrict UDP rules to specific ports and source IP ranges required for business.',
  },
  {
    id: 'CIS-AZ-7.4',
    title: 'Ensure HTTP(S) Access Is Restricted from the Internet Where Not Required',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify HTTP/HTTPS is only allowed where public access is required.',
    whyItMatters: 'Unnecessary HTTP exposure increases attack surface for web application vulnerabilities.',
    consoleSteps: [
      'Review NSG rules allowing ports 80 and 443 from Internet',
      'Verify each rule corresponds to a public-facing application',
      'Check for backend services unnecessarily exposed',
    ],
    expectedConfig: 'HTTP/HTTPS only allowed for intentionally public services. Backend services use private endpoints.',
    commonMisconfigs: [
      'All services exposed via HTTP',
      'Backend APIs publicly accessible',
      'No WAF protection',
    ],
    fixHint: 'Restrict HTTP/HTTPS to public-facing applications only. Use private endpoints for backend services.',
  },
  {
    id: 'CIS-AZ-7.5',
    title: 'Ensure NSG Flow Log Retention Is At Least 90 Days',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'logging',
    whatToCheck: 'Verify NSG Flow Logs have retention of at least 90 days.',
    whyItMatters: '90-day retention ensures logs are available for security investigation and compliance audits.',
    consoleSteps: [
      'Go to Azure Portal → Network Watcher → NSG flow logs',
      'Check retention settings for each flow log',
      'Verify retention is 90 days or more',
    ],
    cliCheck: 'az network watcher flow-log show --name <flow-log> --location <location> --query "retentionPolicy"',
    expectedConfig: 'NSG Flow Log retention set to 90 days minimum. Archival to storage for longer retention.',
    commonMisconfigs: [
      'Default 0 day retention',
      'Less than 90 days',
      'No archival strategy',
    ],
    fixHint: 'Update NSG Flow Log retention to 90 days. Configure archival to storage for compliance retention.',
  },
  {
    id: 'CIS-AZ-7.6',
    ...
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify Network Watcher is enabled for all regions with resources.',
    whyItMatters: 'Network Watcher provides network monitoring, diagnostics, and flow logging capabilities.',
    consoleSteps: [
      'Go to Azure Portal → Network Watcher',
      'Check status for each region',
      'Verify enabled for all regions with VNets',
    ],
    cliCheck: 'az network watcher list --query "[].{Region:location,State:provisioningState}"',
    expectedConfig: 'Network Watcher enabled in all regions with Azure resources.',
    commonMisconfigs: [
      'Network Watcher not enabled',
      'Only some regions enabled',
      'Disabled after initial setup',
    ],
    fixHint: 'Enable Network Watcher: az network watcher configure --locations <region> --enabled true --resource-group NetworkWatcherRG',
  },
  {
    id: 'CIS-AZ-7.7',
    title: 'Ensure Public IP Addresses Are Reviewed Periodically',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify public IP addresses are reviewed regularly for necessity.',
    whyItMatters: 'Unused or unnecessary public IPs increase attack surface. Regular review reduces exposure.',
    consoleSteps: [
      'Go to Azure Portal → Public IP addresses',
      'Review all public IPs and their associations',
      'Identify unused or unnecessary public IPs',
    ],
    cliCheck: 'az network public-ip list --query "[].{Name:name,IPAddress:ipAddress,Associated:ipConfiguration.id}"',
    expectedConfig: 'All public IPs documented with business justification. Regular review process in place.',
    commonMisconfigs: [
      'Orphaned public IPs',
      'No inventory of public IPs',
      'No regular review process',
    ],
    fixHint: 'Document all public IPs with justification. Remove unused IPs. Implement quarterly review.',
  },
  {
    id: 'CIS-AZ-7.8',
    title: 'Ensure VNet Flow Log Retention Is At Least 90 Days',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'logging',
    whatToCheck: 'Verify VNet Flow Logs have retention of at least 90 days.',
    whyItMatters: '90-day retention ensures network traffic data is available for investigation.',
    consoleSteps: [
      'Go to Azure Portal → Network Watcher → VNet flow logs',
      'Check retention settings',
      'Verify 90 day minimum retention',
    ],
    expectedConfig: 'VNet Flow Log retention set to 90 days minimum.',
    commonMisconfigs: [
      'Short retention period',
      'No VNet flow logs',
    ],
    fixHint: 'Configure VNet Flow Logs with 90-day retention.',
  },
  {
    id: 'CIS-AZ-7.9',
    title: 'Ensure Azure AD Authentication Is Used for VPN Gateway',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify VPN Gateway uses Azure AD authentication instead of certificate-based auth.',
    whyItMatters: 'Azure AD authentication provides MFA, conditional access, and centralized identity management for VPN.',
    consoleSteps: [
      'Go to Azure Portal → VPN Gateways',
      'Check Point-to-site configuration',
      'Verify Azure AD authentication is configured',
    ],
    expectedConfig: 'VPN Gateway configured with Azure AD authentication. OpenVPN protocol used.',
    commonMisconfigs: [
      'Certificate-based authentication only',
      'RADIUS without MFA',
      'IKEv2 without Azure AD',
    ],
    fixHint: 'Configure VPN Gateway for Azure AD authentication with OpenVPN protocol.',
  },
  {
    id: 'CIS-AZ-7.10',
    title: 'Ensure Web Application Firewall Is Enabled on Application Gateway',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify WAF is enabled and configured on Application Gateway for public applications.',
    whyItMatters: 'WAF protects web applications from common attacks like SQL injection and XSS.',
    consoleSteps: [
      'Go to Azure Portal → Application Gateways',
      'Check WAF configuration',
      'Verify WAF mode is Prevention',
      'Review WAF policy rules',
    ],
    cliCheck: 'az network application-gateway waf-config show --gateway-name <name> --resource-group <rg>',
    expectedConfig: 'WAF enabled in Prevention mode. OWASP 3.2 rule set. Custom rules for application-specific protection.',
    commonMisconfigs: [
      'WAF not enabled',
      'Detection mode only',
      'Outdated rule set',
    ],
    fixHint: 'Enable WAF in Prevention mode with OWASP 3.2 rule set. Configure custom rules as needed.',
  },
  {
    id: 'CIS-AZ-7.11',
    ...
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify all subnets have an associated Network Security Group.',
    whyItMatters: 'NSGs provide network-level access control. Subnets without NSGs have no network protection.',
    consoleSteps: [
      'Go to Azure Portal → Virtual Networks',
      'Check each subnet for NSG association',
      'Verify NSGs have appropriate rules',
    ],
    cliCheck: 'az network vnet subnet list --vnet-name <vnet> --resource-group <rg> --query "[].{Subnet:name,NSG:networkSecurityGroup.id}"',
    expectedConfig: 'All subnets (except GatewaySubnet) have NSG associated.',
    commonMisconfigs: [
      'Subnets without NSGs',
      'Empty NSGs',
      'Overly permissive default rules',
    ],
    fixHint: 'Associate NSGs with all subnets. Configure appropriate inbound and outbound rules.',
  },
  {
    id: 'CIS-AZ-7.12',
    title: 'Ensure TLS 1.2 or Higher Is Used on Application Gateway',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'encryption',
    whatToCheck: 'Verify Application Gateway uses TLS 1.2 or higher.',
    whyItMatters: 'TLS 1.0 and 1.1 have known vulnerabilities. TLS 1.2+ provides secure communication.',
    consoleSteps: [
      'Go to Azure Portal → Application Gateways',
      'Check SSL/TLS settings',
      'Verify minimum TLS version is 1.2',
    ],
    cliCheck: 'az network application-gateway ssl-policy show --gateway-name <name> --resource-group <rg>',
    expectedConfig: 'Minimum TLS version 1.2. Strong cipher suites configured.',
    commonMisconfigs: [
      'TLS 1.0/1.1 enabled',
      'Weak cipher suites',
      'Default SSL policy used',
    ],
    fixHint: 'Configure custom SSL policy with minimum TLS 1.2 and strong cipher suites.',
  },
  {
    id: 'CIS-AZ-7.13',
    ...
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify HTTP/2 is enabled on Application Gateway.',
    whyItMatters: 'HTTP/2 provides performance improvements and enhanced security features over HTTP/1.1.',
    consoleSteps: [
      'Go to Azure Portal → Application Gateways',
      'Check Configuration settings',
      'Verify HTTP/2 is enabled',
    ],
    cliCheck: 'az network application-gateway show --name <name> --resource-group <rg> --query "http2Enabled"',
    expectedConfig: 'HTTP/2 enabled (http2Enabled: true).',
    commonMisconfigs: [
      'HTTP/2 not enabled',
      'Legacy HTTP/1.1 only',
    ],
    fixHint: 'Enable HTTP/2 in Application Gateway configuration settings.',
  },
  {
    id: 'CIS-AZ-7.14',
    title: 'Ensure Request Body Inspection Is Enabled in WAF',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify WAF inspects request bodies for malicious content.',
    whyItMatters: 'Request body inspection detects attacks hidden in POST data and file uploads.',
    consoleSteps: [
      'Go to Azure Portal → Web Application Firewall policies',
      'Check policy settings',
      'Verify request body inspection is enabled',
    ],
    expectedConfig: 'Request body inspection enabled. Max request body size configured appropriately.',
    commonMisconfigs: [
      'Body inspection disabled',
      'Size limit too small',
      'File upload inspection disabled',
    ],
    fixHint: 'Enable request body inspection in WAF policy. Configure appropriate size limits.',
  },
  {
    id: 'CIS-AZ-7.15',
    title: 'Ensure Bot Protection Is Enabled in WAF',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify WAF has bot protection rules enabled.',
    whyItMatters: 'Bot protection blocks malicious automated traffic and credential stuffing attacks.',
    consoleSteps: [
      'Go to Azure Portal → Web Application Firewall policies',
      'Check managed rules',
      'Verify Bot Manager rule set is enabled',
    ],
    expectedConfig: 'Bot Manager rule set enabled. Bad bot actions set to Block.',
    commonMisconfigs: [
      'No bot protection',
      'Bot rules in detection only',
      'Good bots not allowed',
    ],
    fixHint: 'Enable Bot Manager rule set in WAF policy. Configure actions for bad bots.',
  },
  {
    id: 'CIS-AZ-7.16',
    title: 'Ensure Network Security Perimeter Is Configured for PaaS',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify Network Security Perimeter is configured for PaaS resources.',
    whyItMatters: 'Network Security Perimeter provides network isolation for PaaS services.',
    consoleSteps: [
      'Go to Azure Portal → Network Security Perimeters',
      'Check perimeter configurations',
      'Verify PaaS resources are associated',
    ],
    expectedConfig: 'Network Security Perimeter configured for sensitive PaaS resources.',
    commonMisconfigs: [
      'No network perimeter',
      'PaaS resources publicly accessible',
      'Inconsistent network controls',
    ],
    fixHint: 'Create Network Security Perimeter and associate PaaS resources requiring network isolation.',
  },

  // Section 8.1 - Microsoft Defender for Cloud
  {
    id: 'CIS-AZ-8.1.1.1',
    title: 'Ensure Microsoft Defender CSPM Is Enabled',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'logging',
    whatToCheck: 'Verify Defender Cloud Security Posture Management (CSPM) is enabled.',
    whyItMatters: 'Defender CSPM provides advanced security posture assessment and attack path analysis.',
    consoleSteps: [
      'Go to Azure Portal → Microsoft Defender for Cloud',
      'Navigate to Environment settings',
      'Check CSPM plan status',
      'Verify Defender CSPM is enabled',
    ],
    cliCheck: 'az security pricing show --name CloudPosture',
    expectedConfig: 'Defender CSPM enabled with all features activated.',
    commonMisconfigs: [
      'Only foundational CSPM',
      'CSPM not enabled',
      'Features not fully configured',
    ],
    fixHint: 'Enable Defender CSPM plan in Environment settings. Configure all CSPM features.',
  },
  {
    id: 'CIS-AZ-8.1.2.1',
    title: 'Ensure Defender for APIs Is Enabled',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'logging',
    whatToCheck: 'Verify Defender for APIs is enabled for API Management.',
    whyItMatters: 'Defender for APIs provides threat detection for API traffic and endpoints.',
    consoleSteps: [
      'Go to Azure Portal → Microsoft Defender for Cloud',
      'Navigate to Environment settings',
      'Check Defender for APIs status',
    ],
    cliCheck: 'az security pricing show --name Api',
    expectedConfig: 'Defender for APIs enabled for all API Management instances.',
    commonMisconfigs: [
      'APIs not protected',
      'Only some APIs covered',
    ],
    fixHint: 'Enable Defender for APIs in Microsoft Defender for Cloud settings.',
  },
  {
    id: 'CIS-AZ-8.1.3.1',
    title: 'Ensure Defender for Servers Is Enabled',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'compute',
    whatToCheck: 'Verify Defender for Servers is enabled for all VMs.',
    whyItMatters: 'Defender for Servers provides threat detection, vulnerability assessment, and endpoint protection for VMs.',
    consoleSteps: [
      'Go to Azure Portal → Microsoft Defender for Cloud',
      'Navigate to Environment settings',
      'Check Defender for Servers plan',
      'Verify Plan 2 is recommended',
    ],
    cliCheck: 'az security pricing show --name VirtualMachines',
    expectedConfig: 'Defender for Servers Plan 2 enabled. All VMs protected.',
    commonMisconfigs: [
      'Servers plan not enabled',
      'Plan 1 without full features',
      'Some VMs not protected',
    ],
    fixHint: 'Enable Defender for Servers Plan 2 in Environment settings.',
  },
  {
    id: 'CIS-AZ-8.1.3.2',
    title: 'Ensure Vulnerability Assessment Is Enabled on Virtual Machines',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'compute',
    whatToCheck: 'Verify vulnerability assessment solution is deployed to VMs.',
    whyItMatters: 'Vulnerability assessment identifies security weaknesses requiring remediation.',
    consoleSteps: [
      'Go to Microsoft Defender for Cloud → Recommendations',
      'Search for vulnerability assessment recommendations',
      'Verify all VMs have vulnerability scanning enabled',
    ],
    expectedConfig: 'Vulnerability assessment deployed to all VMs. Regular scans configured.',
    commonMisconfigs: [
      'No vulnerability scanning',
      'Only some VMs scanned',
      'Scan results not reviewed',
    ],
    fixHint: 'Enable vulnerability assessment in Defender for Servers settings. Review and remediate findings.',
  },
  {
    id: 'CIS-AZ-8.1.3.3',
    title: 'Ensure Endpoint Protection Is Installed on Virtual Machines',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'compute',
    whatToCheck: 'Verify endpoint protection is installed and healthy on all VMs.',
    whyItMatters: 'Endpoint protection detects and prevents malware and threats on VMs.',
    consoleSteps: [
      'Go to Microsoft Defender for Cloud → Recommendations',
      'Check endpoint protection recommendations',
      'Verify all VMs have healthy endpoint protection',
    ],
    cliCheck: 'az vm extension list --vm-name <vm> --resource-group <rg> --query "[?contains(name, \'Antimalware\')]"',
    expectedConfig: 'Microsoft Defender for Endpoint or equivalent installed on all VMs. Real-time protection enabled.',
    commonMisconfigs: [
      'No endpoint protection',
      'Endpoint protection disabled',
      'Definitions out of date',
    ],
    fixHint: 'Deploy Microsoft Defender for Endpoint through Defender for Servers. Ensure real-time protection.',
  },
  {
    id: 'CIS-AZ-8.1.3.4',
    title: 'Ensure Agentless Scanning Is Enabled for Virtual Machines',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'compute',
    whatToCheck: 'Verify agentless scanning is enabled for VM vulnerability assessment.',
    whyItMatters: 'Agentless scanning provides vulnerability visibility without requiring agent deployment.',
    consoleSteps: [
      'Go to Microsoft Defender for Cloud → Environment settings',
      'Check Defender for Servers configuration',
      'Verify Agentless scanning is enabled',
    ],
    expectedConfig: 'Agentless scanning enabled for VMs. Disk scanning configured.',
    commonMisconfigs: [
      'Agentless scanning disabled',
      'Only agent-based scanning',
    ],
    fixHint: 'Enable agentless scanning in Defender for Servers Plan 2 settings.',
  },
  {
    id: 'CIS-AZ-8.1.3.5',
    title: 'Ensure File Integrity Monitoring Is Enabled',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'compute',
    whatToCheck: 'Verify File Integrity Monitoring (FIM) is configured for critical VMs.',
    whyItMatters: 'FIM detects unauthorized changes to critical system and application files.',
    consoleSteps: [
      'Go to Microsoft Defender for Cloud → Workload protections',
      'Check File Integrity Monitoring status',
      'Verify critical paths are monitored',
    ],
    expectedConfig: 'FIM enabled for critical VMs. System and application paths monitored.',
    commonMisconfigs: [
      'FIM not configured',
      'Only some servers monitored',
      'Critical paths not included',
    ],
    fixHint: 'Configure File Integrity Monitoring in Defender for Cloud. Add critical file paths to monitoring.',
  },
  {
    id: 'CIS-AZ-8.1.4.1',
    title: 'Ensure Defender for Containers Is Enabled',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'compute',
    whatToCheck: 'Verify Defender for Containers is enabled for AKS and container registries.',
    whyItMatters: 'Defender for Containers provides runtime protection and vulnerability scanning for container workloads.',
    consoleSteps: [
      'Go to Microsoft Defender for Cloud → Environment settings',
      'Check Defender for Containers status',
      'Verify all AKS clusters are protected',
    ],
    cliCheck: 'az security pricing show --name Containers',
    expectedConfig: 'Defender for Containers enabled. AKS clusters and registries protected.',
    commonMisconfigs: [
      'Containers plan disabled',
      'Some clusters not protected',
      'Registry scanning not enabled',
    ],
    fixHint: 'Enable Defender for Containers in Environment settings. Deploy Defender profile to AKS clusters.',
  },
  {
    id: 'CIS-AZ-8.1.5.1',
    title: 'Ensure Defender for Storage Is Enabled',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'storage',
    whatToCheck: 'Verify Defender for Storage is enabled for storage accounts.',
    whyItMatters: 'Defender for Storage detects unusual access, data exfiltration, and malware uploads.',
    consoleSteps: [
      'Go to Microsoft Defender for Cloud → Environment settings',
      'Check Defender for Storage status',
      'Verify all storage accounts are protected',
    ],
    cliCheck: 'az security pricing show --name StorageAccounts',
    expectedConfig: 'Defender for Storage enabled with malware scanning. All storage accounts protected.',
    commonMisconfigs: [
      'Storage plan disabled',
      'Malware scanning not enabled',
      'Some accounts not protected',
    ],
    fixHint: 'Enable Defender for Storage in Environment settings. Enable malware scanning for blob storage.',
  },
  {
    id: 'CIS-AZ-8.1.5.2',
    title: 'Ensure Storage Account Threat Protection Alerts Are Enabled',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'storage',
    whatToCheck: 'Verify threat protection alerts are configured for storage accounts.',
    whyItMatters: 'Alerts enable rapid response to detected storage threats.',
    consoleSteps: [
      'Go to Storage Account → Security',
      'Check threat protection status',
      'Verify alerts are configured',
    ],
    expectedConfig: 'Threat protection enabled with alerts sent to security team.',
    commonMisconfigs: [
      'No alerts configured',
      'Alerts not sent to security team',
    ],
    fixHint: 'Configure security alerts in Defender for Storage to notify security team.',
  },
  {
    id: 'CIS-AZ-8.1.6.1',
    title: 'Ensure Defender for App Services Is Enabled',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'compute',
    whatToCheck: 'Verify Defender for App Services is enabled.',
    whyItMatters: 'Defender for App Services detects attacks targeting web applications and APIs.',
    consoleSteps: [
      'Go to Microsoft Defender for Cloud → Environment settings',
      'Check Defender for App Service status',
    ],
    cliCheck: 'az security pricing show --name AppServices',
    expectedConfig: 'Defender for App Services enabled. All App Services protected.',
    commonMisconfigs: [
      'App Services plan disabled',
      'Some apps not protected',
    ],
    fixHint: 'Enable Defender for App Services in Environment settings.',
  },
  {
    id: 'CIS-AZ-8.1.7.1',
    title: 'Ensure Defender for Cosmos DB Is Enabled',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'storage',
    whatToCheck: 'Verify Defender for Cosmos DB is enabled.',
    whyItMatters: 'Defender for Cosmos DB detects suspicious database access patterns and potential attacks.',
    consoleSteps: [
      'Go to Microsoft Defender for Cloud → Environment settings',
      'Check Defender for Cosmos DB status',
    ],
    cliCheck: 'az security pricing show --name CosmosDbs',
    expectedConfig: 'Defender for Cosmos DB enabled.',
    commonMisconfigs: [
      'Plan not enabled',
      'Some databases not covered',
    ],
    fixHint: 'Enable Defender for Cosmos DB in Environment settings.',
  },
  {
    id: 'CIS-AZ-8.1.7.2',
    title: 'Ensure Defender for Open-Source Databases Is Enabled',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'storage',
    whatToCheck: 'Verify Defender for open-source databases (MySQL, PostgreSQL, MariaDB) is enabled.',
    whyItMatters: 'Provides threat detection for managed open-source database services.',
    consoleSteps: [
      'Go to Microsoft Defender for Cloud → Environment settings',
      'Check Defender for Open-source relational databases status',
    ],
    cliCheck: 'az security pricing show --name OpenSourceRelationalDatabases',
    expectedConfig: 'Defender for Open-source databases enabled.',
    commonMisconfigs: [
      'Plan not enabled',
      'Only SQL databases protected',
    ],
    fixHint: 'Enable Defender for Open-source relational databases in Environment settings.',
  },
  {
    id: 'CIS-AZ-8.1.7.3',
    title: 'Ensure Defender for Azure SQL Managed Instances Is Enabled',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'storage',
    whatToCheck: 'Verify Defender is enabled for SQL Managed Instances.',
    whyItMatters: 'Provides advanced threat protection for managed SQL instances.',
    consoleSteps: [
      'Go to SQL Managed Instance → Security',
      'Check Defender status',
      'Verify Advanced Threat Protection is enabled',
    ],
    expectedConfig: 'Defender for SQL enabled on all Managed Instances.',
    commonMisconfigs: [
      'Defender not enabled',
      'Some instances not protected',
    ],
    fixHint: 'Enable Microsoft Defender for SQL on all Managed Instances.',
  },
  {
    id: 'CIS-AZ-8.1.7.4',
    title: 'Ensure Defender for SQL Servers Is Enabled',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'storage',
    whatToCheck: 'Verify Defender for Azure SQL is enabled.',
    whyItMatters: 'Defender for SQL provides vulnerability assessment and advanced threat protection for SQL databases.',
    consoleSteps: [
      'Go to Microsoft Defender for Cloud → Environment settings',
      'Check Azure Defender for SQL servers status',
    ],
    cliCheck: 'az security pricing show --name SqlServers',
    expectedConfig: 'Defender for Azure SQL enabled. All SQL resources protected.',
    commonMisconfigs: [
      'SQL plan disabled',
      'Some databases not covered',
      'Vulnerability assessment not enabled',
    ],
    fixHint: 'Enable Defender for Azure SQL in Environment settings.',
  },
  {
    id: 'CIS-AZ-8.1.8.1',
    title: 'Ensure Defender for Key Vault Is Enabled',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'encryption',
    whatToCheck: 'Verify Defender for Key Vault is enabled.',
    whyItMatters: 'Defender for Key Vault detects unusual secret access patterns and potential key theft.',
    consoleSteps: [
      'Go to Microsoft Defender for Cloud → Environment settings',
      'Check Defender for Key Vault status',
    ],
    cliCheck: 'az security pricing show --name KeyVaults',
    expectedConfig: 'Defender for Key Vault enabled. All Key Vaults protected.',
    commonMisconfigs: [
      'Key Vault plan disabled',
      'Some Key Vaults not protected',
    ],
    fixHint: 'Enable Defender for Key Vault in Environment settings.',
  },
  {
    id: 'CIS-AZ-8.1.9.1',
    title: 'Ensure Defender for Resource Manager Is Enabled',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify Defender for Resource Manager is enabled.',
    whyItMatters: 'Detects suspicious resource management operations that may indicate compromise.',
    consoleSteps: [
      'Go to Microsoft Defender for Cloud → Environment settings',
      'Check Defender for Resource Manager status',
    ],
    cliCheck: 'az security pricing show --name Arm',
    expectedConfig: 'Defender for Resource Manager enabled.',
    commonMisconfigs: [
      'Plan not enabled',
      'Alerts not monitored',
    ],
    fixHint: 'Enable Defender for Resource Manager in Environment settings.',
  },
  {
    id: 'CIS-AZ-8.1.10',
    title: 'Ensure VM OS Updates Are Enabled and Monitored',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'compute',
    whatToCheck: 'Verify VMs have OS updates assessment enabled.',
    whyItMatters: 'Missing OS updates leave VMs vulnerable to known exploits.',
    consoleSteps: [
      'Go to Microsoft Defender for Cloud → Recommendations',
      'Check system updates recommendations',
      'Verify all VMs are assessed for updates',
    ],
    expectedConfig: 'Update assessment enabled. Update management configured. Critical updates applied timely.',
    commonMisconfigs: [
      'Updates not monitored',
      'Update management not configured',
      'Missing critical updates',
    ],
    fixHint: 'Enable Azure Update Management. Configure automatic patching for critical updates.',
  },
  {
    id: 'CIS-AZ-8.1.11',
    title: 'Ensure Azure Security Benchmark Policy Is Assigned',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'logging',
    whatToCheck: 'Verify Azure Security Benchmark initiative is assigned to subscriptions.',
    whyItMatters: 'Security Benchmark provides comprehensive security recommendations aligned with best practices.',
    consoleSteps: [
      'Go to Microsoft Defender for Cloud → Environment settings',
      'Check Security policies',
      'Verify Azure Security Benchmark is assigned',
    ],
    expectedConfig: 'Azure Security Benchmark assigned to all subscriptions. Recommendations actively managed.',
    commonMisconfigs: [
      'Benchmark not assigned',
      'Recommendations not reviewed',
      'Custom policies override benchmark',
    ],
    fixHint: 'Assign Azure Security Benchmark initiative to all subscriptions through Defender for Cloud.',
  },
  {
    id: 'CIS-AZ-8.1.12',
    title: 'Ensure Security Alerts Are Sent to Subscription Owners',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'logging',
    whatToCheck: 'Verify subscription owners receive security alerts.',
    whyItMatters: 'Owners need awareness of security alerts to take appropriate action.',
    consoleSteps: [
      'Go to Microsoft Defender for Cloud → Environment settings',
      'Check Email notifications',
      'Verify owners are notified for high severity',
    ],
    expectedConfig: 'Subscription owners receive high severity alerts. Additional roles as appropriate.',
    commonMisconfigs: [
      'No notifications to owners',
      'Only specific emails configured',
    ],
    fixHint: 'Configure email notifications to include subscription owners for high severity alerts.',
  },
  {
    id: 'CIS-AZ-8.1.13',
    title: 'Ensure Security Contact Email Is Configured',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'logging',
    whatToCheck: 'Verify security contact email is configured.',
    whyItMatters: 'Security contact enables Microsoft to reach the right team during security incidents.',
    consoleSteps: [
      'Go to Microsoft Defender for Cloud → Environment settings',
      'Check Email notifications',
      'Verify security contact email is set',
    ],
    cliCheck: 'az security contact list',
    expectedConfig: 'Security team email configured. Phone number for critical issues.',
    commonMisconfigs: [
      'No security contact',
      'Personal email instead of team',
      'Outdated contact information',
    ],
    fixHint: 'Configure security contact with team email and phone in Defender for Cloud settings.',
  },
  {
    id: 'CIS-AZ-8.1.14',
    title: 'Ensure Notifications for High Severity Alerts Are Enabled',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'logging',
    whatToCheck: 'Verify email notifications are enabled for high severity alerts.',
    whyItMatters: 'High severity alerts require immediate attention. Email ensures timely notification.',
    consoleSteps: [
      'Go to Microsoft Defender for Cloud → Environment settings',
      'Check Email notifications',
      'Verify "Notify about alerts with severity" includes High',
    ],
    expectedConfig: 'Email notifications enabled for High and Critical severity alerts.',
    commonMisconfigs: [
      'Notifications disabled',
      'Only critical alerts notified',
      'Notifications going to wrong team',
    ],
    fixHint: 'Enable email notifications for high severity alerts in Defender for Cloud settings.',
  },
  {
    id: 'CIS-AZ-8.1.15',
    title: 'Ensure Attack Path Notifications Are Configured',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'logging',
    whatToCheck: 'Verify attack path analysis notifications are enabled.',
    whyItMatters: 'Attack path analysis identifies critical security risks requiring immediate attention.',
    consoleSteps: [
      'Go to Microsoft Defender for Cloud → Attack path analysis',
      'Check notification settings',
      'Verify critical attack paths trigger alerts',
    ],
    expectedConfig: 'Attack path notifications enabled. Critical paths send immediate alerts.',
    commonMisconfigs: [
      'Attack path analysis not reviewed',
      'No notifications configured',
    ],
    fixHint: 'Configure notifications for critical attack paths in Defender CSPM settings.',
  },
  {
    id: 'CIS-AZ-8.1.16',
    title: 'Ensure External Attack Surface Management Is Configured',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify Defender EASM is configured to monitor external attack surface.',
    whyItMatters: 'EASM provides visibility into internet-exposed assets that attackers can discover.',
    consoleSteps: [
      'Go to Microsoft Defender External Attack Surface Management',
      'Verify discovery is configured',
      'Check monitored assets',
    ],
    expectedConfig: 'EASM configured with all relevant domains. Regular review of discovered assets.',
    commonMisconfigs: [
      'EASM not configured',
      'Not all domains included',
      'Findings not reviewed',
    ],
    fixHint: 'Configure Defender EASM with organization domains. Review and track discovered assets.',
  },

  // Section 8.2 - Defender for IoT
  {
    id: 'CIS-AZ-8.2.1',
    title: 'Ensure Defender for IoT Hub Is Enabled',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'compute',
    whatToCheck: 'Verify Defender for IoT is enabled for IoT Hubs.',
    whyItMatters: 'IoT devices are often targets for attacks. Defender provides threat detection for IoT workloads.',
    consoleSteps: [
      'Go to IoT Hub → Security',
      'Check Defender for IoT status',
      'Verify it is enabled',
    ],
    expectedConfig: 'Defender for IoT enabled for all IoT Hubs.',
    commonMisconfigs: [
      'Defender for IoT not enabled',
      'Only some hubs protected',
    ],
    fixHint: 'Enable Defender for IoT on all IoT Hubs.',
  },

  // Section 8.3 - Key Vault
  {
    id: 'CIS-AZ-8.3.1',
    title: 'Ensure Key Expiration Is Set for Keys (RBAC)',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'encryption',
    whatToCheck: 'Verify all keys in RBAC-enabled Key Vaults have expiration dates set.',
    whyItMatters: 'Key rotation through expiration reduces risk from compromised keys.',
    consoleSteps: [
      'Go to Azure Portal → Key Vaults',
      'Verify vault uses RBAC (Access configuration)',
      'Select Key Vault → Keys',
      'Check expiration date for each key',
    ],
    cliCheck: 'az keyvault key list --vault-name <vault> --query "[].{Name:name,Expires:attributes.expires}"',
    expectedConfig: 'All keys have expiration date set in RBAC-enabled vaults. Key rotation process documented.',
    commonMisconfigs: [
      'Keys without expiration',
      'No rotation process',
      'Expired keys not rotated',
    ],
    fixHint: 'Set expiration dates on all keys. Implement key rotation process before expiration.',
  },
  {
    id: 'CIS-AZ-8.3.2',
    title: 'Ensure Key Expiration Is Set for Keys (Non-RBAC)',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'encryption',
    whatToCheck: 'Verify all keys in Non-RBAC (access policy) Key Vaults have expiration dates set.',
    whyItMatters: 'Key rotation through expiration reduces risk from compromised keys, even in legacy access policy vaults.',
    consoleSteps: [
      'Go to Azure Portal → Key Vaults',
      'Identify vaults using Access Policies (not RBAC)',
      'Select Key Vault → Keys',
      'Check expiration date for each key',
    ],
    cliCheck: 'az keyvault key list --vault-name <vault> --query "[].{Name:name,Expires:attributes.expires}"',
    expectedConfig: 'All keys have expiration date set in access policy-based vaults.',
    commonMisconfigs: [
      'Keys without expiration in legacy vaults',
      'No rotation process',
      'Mixed RBAC and policy vaults',
    ],
    fixHint: 'Set expiration dates on all keys. Consider migrating to RBAC-based vaults.',
  },
  {
    id: 'CIS-AZ-8.3.3',
    title: 'Ensure Secret Expiration Is Set for Secrets (RBAC)',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'encryption',
    whatToCheck: 'Verify all secrets in RBAC-enabled Key Vaults have expiration dates set.',
    whyItMatters: 'Secret rotation through expiration limits exposure from compromised secrets.',
    consoleSteps: [
      'Go to Azure Portal → Key Vaults',
      'Verify vault uses RBAC (Access configuration)',
      'Select Key Vault → Secrets',
      'Check expiration date for each secret',
    ],
    cliCheck: 'az keyvault secret list --vault-name <vault> --query "[].{Name:name,Expires:attributes.expires}"',
    expectedConfig: 'All secrets have expiration date set in RBAC-enabled vaults. Secret rotation process documented.',
    commonMisconfigs: [
      'Secrets without expiration',
      'No rotation process',
      'Expired secrets still active',
    ],
    fixHint: 'Set expiration dates on all secrets. Implement rotation before expiration.',
  },
  {
    id: 'CIS-AZ-8.3.4',
    title: 'Ensure Secret Expiration Is Set for Secrets (Non-RBAC)',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'encryption',
    whatToCheck: 'Verify all secrets in Non-RBAC (access policy) Key Vaults have expiration dates set.',
    whyItMatters: 'Secret rotation limits exposure from compromised secrets in legacy vaults.',
    consoleSteps: [
      'Go to Azure Portal → Key Vaults',
      'Identify vaults using Access Policies (not RBAC)',
      'Select Key Vault → Secrets',
    ...
    cliCheck: 'az keyvault secret list --vault-name <vault> --query "[].{Name:name,Expires:attributes.expires}"',
    expectedConfig: 'All secrets have expiration date set in access policy-based vaults.',
    commonMisconfigs: [
      'Secrets without expiration',
      'No rotation in legacy vaults',
      'Mixed RBAC and policy vaults',
    ],
    fixHint: 'Set expiration dates on all secrets. Consider migrating to RBAC-based vaults.',
  },
  {
    id: 'CIS-AZ-8.3.5',
    title: 'Ensure Purge Protection Is Enabled for Key Vault',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'encryption',
    whatToCheck: 'Verify purge protection is enabled for Key Vaults.',
    whyItMatters: 'Purge protection prevents permanent deletion of keys and secrets, protecting against malicious deletion.',
    consoleSteps: [
      'Go to Azure Portal → Key Vaults',
      'Check Properties for each Key Vault',
      'Verify Purge protection is enabled',
    ],
    cliCheck: 'az keyvault show --name <vault> --query "properties.enablePurgeProtection"',
    expectedConfig: 'Purge protection enabled on all Key Vaults (enablePurgeProtection: true).',
    commonMisconfigs: [
      'Purge protection not enabled',
      'Only soft delete enabled',
    ],
    fixHint: 'Enable purge protection when creating Key Vault. Note: Cannot be enabled on existing vault.',
  },
  {
    id: 'CIS-AZ-8.3.6',
    title: 'Ensure RBAC Is Enabled for Key Vault Access',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify Key Vault uses Azure RBAC instead of access policies.',
    whyItMatters: 'RBAC provides unified access management with conditional access and audit capabilities.',
    consoleSteps: [
      'Go to Azure Portal → Key Vaults',
      'Check Access configuration',
      'Verify "Azure role-based access control" is selected',
    ],
    cliCheck: 'az keyvault show --name <vault> --query "properties.enableRbacAuthorization"',
    expectedConfig: 'RBAC authorization enabled (enableRbacAuthorization: true).',
    commonMisconfigs: [
      'Using vault access policies',
      'RBAC not enabled',
      'Mixed RBAC and policy',
    ],
    fixHint: 'Enable RBAC authorization for Key Vault. Migrate from access policies to RBAC roles.',
  },
  {
    id: 'CIS-AZ-8.3.7',
    ...
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify Key Vault is not accessible from public internet.',
    whyItMatters: 'Disabling public access reduces exposure to internet-based attacks.',
    consoleSteps: [
      'Go to Azure Portal → Key Vaults',
      'Check Networking settings',
      'Verify public network access is disabled',
    ],
    cliCheck: 'az keyvault show --name <vault> --query "properties.publicNetworkAccess"',
    expectedConfig: 'Public network access disabled. Private endpoints configured.',
    commonMisconfigs: [
      'Public access allowed',
      'Firewall rules too permissive',
      'No private endpoints',
    ],
    fixHint: 'Disable public network access. Configure private endpoints for Key Vault access.',
  },
  {
    id: 'CIS-AZ-8.3.8',
    ...
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify private endpoints are configured for Key Vault access.',
    whyItMatters: 'Private endpoints provide secure connectivity without public internet exposure.',
    consoleSteps: [
      'Go to Azure Portal → Key Vaults → Networking',
      'Check Private endpoint connections',
      'Verify private endpoints are configured',
    ],
    cliCheck: 'az network private-endpoint list --query "[?contains(privateLinkServiceConnections[].groupIds[], \'vault\')]"',
    expectedConfig: 'Private endpoints configured. Private DNS zones integrated.',
    commonMisconfigs: [
      'No private endpoints',
      'DNS not configured',
      'Only firewall rules used',
    ],
    fixHint: 'Create private endpoints for Key Vault. Configure private DNS zones for resolution.',
  },
  {
    id: 'CIS-AZ-8.3.9',
    title: 'Ensure Automatic Key Rotation Is Enabled in Key Vault',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'encryption',
    whatToCheck: 'Verify automatic key rotation is enabled for Key Vault keys.',
    whyItMatters: 'Automatic rotation ensures keys are regularly rotated without manual intervention, reducing risk from key compromise.',
    consoleSteps: [
      'Go to Azure Portal → Key Vaults',
      'Select Key Vault → Keys',
      'For each key, click to view rotation policy',
      'Verify automatic rotation is enabled',
    ],
    cliCheck: 'az keyvault key rotation-policy show --vault-name <vault> --name <key>',
    expectedConfig: 'Rotation policy configured with automatic rotation enabled. Rotation period appropriate for key usage.',
    commonMisconfigs: [
      'No rotation policy configured',
      'Only notifications without automatic rotation',
      'Rotation period too long',
    ],
    fixHint: 'Configure automatic key rotation policy with appropriate rotation period (e.g., 90 days).',
  },
  {
    id: 'CIS-AZ-8.3.10',
    title: 'Ensure Managed HSM Is Used for Sensitive Keys',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'encryption',
    whatToCheck: 'Verify Managed HSM is used for highly sensitive cryptographic keys.',
    whyItMatters: 'Managed HSM provides FIPS 140-2 Level 3 validated hardware protection for keys.',
    consoleSteps: [
      'Identify highly sensitive encryption use cases',
      'Verify Managed HSM is configured for these keys',
      'Check HSM pool configuration',
    ],
    expectedConfig: 'Managed HSM used for sensitive keys requiring hardware protection.',
    commonMisconfigs: [
      'Standard Key Vault for sensitive keys',
      'HSM not configured',
      'Mixed key storage',
    ],
    fixHint: 'Provision Managed HSM for highly sensitive keys. Migrate keys from standard vault.',
  },
  {
    id: 'CIS-AZ-8.3.11',
    title: 'Ensure Certificate Validity Period Is Within 12 Months',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'encryption',
    whatToCheck: 'Verify Key Vault certificates have validity periods of 12 months or less.',
    whyItMatters: 'Shorter validity periods reduce risk from compromised certificates.',
    consoleSteps: [
      'Go to Key Vault → Certificates',
      'Check validity period for each certificate',
      'Verify renewal policies',
    ],
    cliCheck: 'az keyvault certificate list --vault-name <vault> --query "[].{Name:name,Expires:attributes.expires}"',
    expectedConfig: 'Certificates valid for 12 months or less. Auto-renewal configured.',
    commonMisconfigs: [
      'Long validity periods',
      'No auto-renewal',
      'Expired certificates',
    ],
    fixHint: 'Configure certificate issuance policies with 12-month maximum validity. Enable auto-renewal.',
  },

  // Section 8.4 - Azure Bastion
  {
    id: 'CIS-AZ-8.4.1',
    title: 'Ensure Azure Bastion Is Deployed for Secure RDP/SSH',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify Azure Bastion is deployed for secure management access.',
    whyItMatters: 'Azure Bastion provides secure RDP/SSH without exposing VMs to the internet.',
    consoleSteps: [
      'Go to Azure Portal → Bastions',
      'Verify Bastion hosts exist for VNets with VMs',
      'Check Bastion configuration',
    ],
    cliCheck: 'az network bastion list',
    expectedConfig: 'Azure Bastion deployed in VNets with VMs. No public IPs on VMs for management.',
    commonMisconfigs: [
      'No Bastion deployed',
      'VMs with public IPs for RDP/SSH',
      'Basic SKU without all features',
    ],
    fixHint: 'Deploy Azure Bastion Standard SKU. Remove public IPs from VMs used only for management access.',
  },

  // Section 8.5 - DDoS Protection
  {
    id: 'CIS-AZ-8.5',
    title: 'Ensure DDoS Network Protection Is Enabled',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify DDoS Network Protection is enabled for VNets with public IPs.',
    whyItMatters: 'DDoS protection defends against volumetric and protocol attacks targeting public IPs.',
    consoleSteps: [
      'Go to Azure Portal → DDoS protection plans',
      'Verify protection plan exists',
      'Check VNets are associated with the plan',
    ],
    cliCheck: 'az network ddos-protection list',
    expectedConfig: 'DDoS Network Protection plan enabled. All VNets with public IPs protected.',
    commonMisconfigs: [
      'No DDoS protection',
      'Only Basic protection (default)',
      'Some VNets not protected',
    ],
    fixHint: 'Create DDoS Network Protection plan. Associate with VNets containing public IP addresses.',
  },

  // Section 9.1 - Azure Files
  {
    id: 'CIS-AZ-9.1.1',
    title: 'Ensure Soft Delete Is Enabled for Azure File Shares',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'storage',
    whatToCheck: 'Verify soft delete is enabled for Azure File shares.',
    whyItMatters: 'Soft delete allows recovery of accidentally or maliciously deleted file shares.',
    consoleSteps: [
      'Go to Storage Account → Data protection',
      'Check "Enable soft delete for file shares"',
      'Verify retention period',
    ],
    cliCheck: 'az storage account file-service-properties show --account-name <account> --query "shareDeleteRetentionPolicy"',
    expectedConfig: 'Soft delete enabled with 14+ day retention period.',
    commonMisconfigs: [
      'Soft delete not enabled',
      'Short retention period',
    ],
    fixHint: 'Enable soft delete for file shares with minimum 14-day retention.',
  },
  {
    id: 'CIS-AZ-9.1.2',
    title: 'Ensure SMB Version 3.1.1 or Higher Is Used',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'encryption',
    whatToCheck: 'Verify Azure Files requires SMB 3.1.1 or higher.',
    whyItMatters: 'SMB 3.1.1 provides enhanced security including preauthentication integrity.',
    consoleSteps: [
      'Go to Storage Account → File shares',
      'Check SMB settings',
      'Verify minimum SMB version',
    ],
    cliCheck: 'az storage account show --name <account> --query "fileServices"',
    expectedConfig: 'Minimum SMB version set to 3.1.1. SMB 2.1 and 3.0 disabled.',
    commonMisconfigs: [
      'Legacy SMB versions allowed',
      'SMB 2.1 enabled for compatibility',
    ],
    fixHint: 'Set minimum SMB version to 3.1.1 in storage account configuration.',
  },
  {
    id: 'CIS-AZ-9.1.3',
    title: 'Ensure AES-256-GCM Encryption Is Used for SMB',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'encryption',
    whatToCheck: 'Verify Azure Files SMB uses AES-256-GCM encryption.',
    whyItMatters: 'AES-256-GCM provides strong encryption for SMB traffic.',
    consoleSteps: [
      'Go to Storage Account → File shares',
      'Check encryption settings',
      'Verify AES-256-GCM is required',
    ],
    expectedConfig: 'AES-256-GCM encryption required for SMB connections.',
    commonMisconfigs: [
      'Weaker encryption allowed',
      'AES-128 used instead',
    ],
    fixHint: 'Configure SMB multichannel and AES-256-GCM encryption requirements.',
  },

  // Section 9.2 - Azure Blob Storage
  {
    id: 'CIS-AZ-9.2.1',
    title: 'Ensure Soft Delete Is Enabled for Blobs',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'storage',
    whatToCheck: 'Verify soft delete is enabled for blob storage.',
    whyItMatters: 'Soft delete allows recovery of deleted blobs and versions.',
    consoleSteps: [
      'Go to Storage Account → Data protection',
      'Check "Enable soft delete for blobs"',
      'Verify retention period',
    ],
    cliCheck: 'az storage account blob-service-properties show --account-name <account> --query "deleteRetentionPolicy"',
    expectedConfig: 'Blob soft delete enabled with 7+ day retention.',
    commonMisconfigs: [
      'Soft delete not enabled',
      'Short retention period',
    ],
    fixHint: 'Enable soft delete for blobs with minimum 7-day retention.',
  },
  {
    id: 'CIS-AZ-9.2.2',
    ...
    framework: 'CIS Benchmark',
    category: 'storage',
    whatToCheck: 'Verify soft delete is enabled for containers.',
    whyItMatters: 'Container soft delete allows recovery of accidentally deleted containers.',
    consoleSteps: [
      'Go to Storage Account → Data protection',
      'Check "Enable soft delete for containers"',
      'Verify retention period',
    ],
    cliCheck: 'az storage account blob-service-properties show --account-name <account> --query "containerDeleteRetentionPolicy"',
    expectedConfig: 'Container soft delete enabled with 7+ day retention.',
    commonMisconfigs: [
      'Container soft delete not enabled',
      'Short retention period',
    ],
    fixHint: 'Enable soft delete for containers with minimum 7-day retention.',
  },
  {
    id: 'CIS-AZ-9.2.3',
    title: 'Ensure Versioning Is Enabled for Blob Storage',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'storage',
    whatToCheck: 'Verify blob versioning is enabled for important data.',
    whyItMatters: 'Versioning maintains previous versions of blobs for recovery and audit.',
    consoleSteps: [
      'Go to Storage Account → Data protection',
      'Check "Enable versioning for blobs"',
    ],
    cliCheck: 'az storage account blob-service-properties show --account-name <account> --query "isVersioningEnabled"',
    expectedConfig: 'Blob versioning enabled for data requiring version history.',
    commonMisconfigs: [
      'Versioning not enabled',
      'No lifecycle policy for old versions',
    ],
    fixHint: 'Enable blob versioning. Configure lifecycle management to manage version retention.',
  },

  // Section 9.3 - Storage Accounts
  {
    id: 'CIS-AZ-9.3.1.1',
    title: 'Ensure Key Rotation Reminders Are Configured for Storage',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'encryption',
    whatToCheck: 'Verify storage account key rotation reminders or automatic rotation are configured.',
    whyItMatters: 'Regular key rotation limits exposure from compromised storage keys.',
    consoleSteps: [
      'Go to Storage Account → Access keys',
      'Check key rotation settings',
      'Verify rotation reminder or automation',
    ],
    expectedConfig: 'Key rotation reminders or automatic rotation configured. Keys rotated every 90 days.',
    commonMisconfigs: [
      'No rotation reminders',
      'Keys never rotated',
      'Manual rotation only',
    ],
    fixHint: 'Configure key rotation policy or use Azure Key Vault managed keys.',
  },
  {
    id: 'CIS-AZ-9.3.1.2',
    title: 'Ensure Storage Account Keys Are Regenerated Periodically',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'encryption',
    whatToCheck: 'Verify storage account keys are regenerated periodically.',
    whyItMatters: 'Regular key regeneration limits risk from compromised keys.',
    consoleSteps: [
      'Go to Storage Account → Access keys',
      'Check last regeneration date',
      'Verify within rotation policy',
    ],
    expectedConfig: 'Storage keys regenerated within 90 days. Rotation documented.',
    commonMisconfigs: [
      'Keys not rotated',
      'No rotation schedule',
      'Applications break on rotation',
    ],
    fixHint: 'Regenerate storage account keys every 90 days. Use Key Vault for automated rotation.',
  },
  {
    id: 'CIS-AZ-9.3.1.3',
    title: 'Ensure Shared Key Access Is Disabled Where Possible',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify shared key authorization is disabled for storage accounts.',
    whyItMatters: 'Disabling shared keys enforces Azure AD authentication, providing better security and auditing.',
    consoleSteps: [
      'Go to Storage Account → Configuration',
      'Check "Allow storage account key access"',
      'Verify it is disabled',
    ],
    cliCheck: 'az storage account show --name <account> --query "allowSharedKeyAccess"',
    expectedConfig: 'Shared key access disabled. All access via Azure AD authentication.',
    commonMisconfigs: [
      'Shared key access enabled',
      'Applications using access keys',
    ],
    fixHint: 'Migrate applications to Azure AD authentication. Disable shared key access.',
  },
  {
    id: 'CIS-AZ-9.3.2.1',
    ...
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify private endpoints are configured for storage account access.',
    whyItMatters: 'Private endpoints provide secure connectivity without public internet exposure.',
    consoleSteps: [
      'Go to Storage Account → Networking',
      'Check Private endpoint connections',
      'Verify private endpoints for each service (blob, file, etc.)',
    ],
    cliCheck: 'az network private-endpoint list --query "[?contains(privateLinkServiceConnections[].groupIds[], \'blob\')]"',
    expectedConfig: 'Private endpoints configured for all required services. Private DNS integrated.',
    commonMisconfigs: [
      'No private endpoints',
      'Only public access',
      'DNS not configured',
    ],
    fixHint: 'Create private endpoints for storage services. Configure private DNS zones.',
  },
  {
    id: 'CIS-AZ-9.3.2.2',
    title: 'Ensure Public Network Access Is Disabled for Storage',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify public network access is disabled for storage accounts.',
    whyItMatters: 'Disabling public access ensures storage is only accessible through private endpoints.',
    consoleSteps: [
      'Go to Storage Account → Networking',
      'Check Public network access setting',
      'Verify it is disabled',
    ],
    cliCheck: 'az storage account show --name <account> --query "publicNetworkAccess"',
    expectedConfig: 'Public network access disabled. Access only via private endpoints.',
    commonMisconfigs: [
      'Public access enabled',
      'All networks allowed',
      'Overly permissive firewall',
    ],
    fixHint: 'Disable public network access. Configure private endpoints for required access.',
  },
  {
    id: 'CIS-AZ-9.3.2.3',
    title: 'Ensure Default Network Rule Is Set to Deny',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify storage account default network rule is set to deny.',
    whyItMatters: 'Deny by default ensures only explicitly allowed networks can access storage.',
    consoleSteps: [
      'Go to Storage Account → Networking',
      'Check default action',
      'Verify it is set to Deny',
    ],
    cliCheck: 'az storage account show --name <account> --query "networkRuleSet.defaultAction"',
    expectedConfig: 'Default action set to Deny. Only required networks in allowlist.',
    commonMisconfigs: [
      'Default action is Allow',
      'All networks permitted',
    ],
    fixHint: 'Set default network rule to Deny. Add only required VNets and IPs to allowlist.',
  },
  {
    id: 'CIS-AZ-9.3.3.1',
    title: 'Ensure Default Entra ID Authorization Is Enabled',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'iam',
    whatToCheck: 'Verify default Azure AD authorization is enabled in Azure Portal.',
    whyItMatters: 'Default Entra ID authorization ensures consistent authentication method.',
    consoleSteps: [
      'Go to Storage Account → Configuration',
      'Check "Default to Azure Active Directory authorization in the Azure portal"',
      'Verify it is enabled',
    ],
    cliCheck: 'az storage account show --name <account> --query "defaultToOAuthAuthentication"',
    expectedConfig: 'Default to Azure AD authorization enabled in portal.',
    commonMisconfigs: [
      'Default to access key in portal',
      'Inconsistent auth methods',
    ],
    fixHint: 'Enable "Default to Azure Active Directory authorization in the Azure portal" in configuration.',
  },
  {
    id: 'CIS-AZ-9.3.4',
    title: 'Ensure Secure Transfer Is Required for Storage Accounts',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'encryption',
    whatToCheck: 'Verify secure transfer (HTTPS only) is required.',
    whyItMatters: 'Requiring HTTPS ensures all data in transit is encrypted.',
    consoleSteps: [
      'Go to Storage Account → Configuration',
      'Check "Secure transfer required"',
      'Verify it is enabled',
    ],
    cliCheck: 'az storage account show --name <account> --query "enableHttpsTrafficOnly"',
    expectedConfig: 'Secure transfer required (enableHttpsTrafficOnly: true).',
    commonMisconfigs: [
      'HTTP allowed',
      'Secure transfer disabled',
    ],
    fixHint: 'Enable "Secure transfer required" in storage account configuration.',
  },
  {
    id: 'CIS-AZ-9.3.5',
    title: 'Ensure Trusted Microsoft Services Are Allowed',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'network',
    whatToCheck: 'Verify trusted Microsoft services can bypass network rules.',
    whyItMatters: 'Allowing trusted services enables Azure services to access storage securely.',
    consoleSteps: [
      'Go to Storage Account → Networking',
      'Check "Allow Azure services on the trusted services list to access this storage account"',
      'Verify it is enabled',
    ],
    cliCheck: 'az storage account show --name <account> --query "networkRuleSet.bypass"',
    expectedConfig: 'Trusted Microsoft services bypass enabled (bypass includes AzureServices).',
    commonMisconfigs: [
      'Trusted services blocked',
      'Azure services cannot access storage',
    ],
    fixHint: 'Enable "Allow trusted Microsoft services" in storage account networking.',
  },
  {
    id: 'CIS-AZ-9.3.6',
    title: 'Ensure TLS 1.2 Is Minimum Version for Storage',
    severity: 'High',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'encryption',
    whatToCheck: 'Verify minimum TLS version is 1.2 for storage accounts.',
    whyItMatters: 'TLS 1.0 and 1.1 have known vulnerabilities. TLS 1.2 is the minimum secure version.',
    consoleSteps: [
      'Go to Storage Account → Configuration',
      'Check minimum TLS version',
      'Verify it is set to 1.2',
    ],
    cliCheck: 'az storage account show --name <account> --query "minimumTlsVersion"',
    expectedConfig: 'Minimum TLS version set to TLS1_2.',
    commonMisconfigs: [
      'TLS 1.0 or 1.1 allowed',
      'No TLS version enforcement',
    ],
    fixHint: 'Set minimum TLS version to TLS1_2 in storage account configuration.',
  },
  {
    id: 'CIS-AZ-9.3.7',
    ...
    framework: 'CIS Benchmark',
    category: 'storage',
    whatToCheck: 'Verify cross-tenant replication is disabled for storage accounts.',
    whyItMatters: 'Disabling cross-tenant replication prevents data from being replicated to external tenants.',
    consoleSteps: [
      'Go to Storage Account → Object replication',
      'Check cross-tenant replication setting',
      'Verify it is disabled',
    ],
    cliCheck: 'az storage account show --name <account> --query "allowCrossTenantReplication"',
    expectedConfig: 'Cross-tenant replication disabled (allowCrossTenantReplication: false).',
    commonMisconfigs: [
      'Cross-tenant replication enabled',
      'Data replicated to external tenant',
    ],
    fixHint: 'Disable cross-tenant replication in storage account settings.',
  },
  {
    id: 'CIS-AZ-9.3.8',
    title: 'Ensure Anonymous Blob Access Is Disabled',
    severity: 'Critical',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'storage',
    whatToCheck: 'Verify anonymous (public) blob access is disabled at account level.',
    whyItMatters: 'Anonymous access allows anyone on the internet to read blobs. This is a major data exposure risk.',
    consoleSteps: [
      'Go to Storage Account → Configuration',
      'Check "Allow Blob anonymous access"',
      'Verify it is disabled',
    ],
    cliCheck: 'az storage account show --name <account> --query "allowBlobPublicAccess"',
    expectedConfig: 'Blob public access disabled (allowBlobPublicAccess: false).',
    commonMisconfigs: [
      'Public access enabled',
      'Containers with public access',
      'Anonymous blob exposure',
    ],
    fixHint: 'Disable "Allow Blob anonymous access" at storage account level.',
  },
  {
    id: 'CIS-AZ-9.3.9',
    title: 'Ensure Delete Locks Are Applied to Critical Storage',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'storage',
    whatToCheck: 'Verify delete locks protect critical storage accounts.',
    whyItMatters: 'Delete locks prevent accidental or malicious deletion of critical storage.',
    consoleSteps: [
      'Go to Storage Account → Locks',
      'Verify CanNotDelete lock exists',
    ],
    cliCheck: 'az lock list --resource-group <rg> --resource-name <account> --resource-type Microsoft.Storage/storageAccounts',
    expectedConfig: 'CanNotDelete lock applied to critical storage accounts.',
    commonMisconfigs: [
      'No locks on critical storage',
      'Locks easily removed',
    ],
    fixHint: 'Apply CanNotDelete lock to critical storage accounts.',
  },
  {
    id: 'CIS-AZ-9.3.10',
    title: 'Ensure Read-Only Locks Are Considered for Immutable Data',
    severity: 'Low',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'storage',
    whatToCheck: 'Verify read-only locks are applied where immutability is required.',
    whyItMatters: 'Read-only locks prevent any modifications, ensuring data integrity.',
    consoleSteps: [
      'Identify storage requiring immutability',
      'Check for ReadOnly locks',
      'Verify immutable blob storage policies',
    ],
    expectedConfig: 'ReadOnly locks or immutable blob storage configured for compliance data.',
    commonMisconfigs: [
      'No immutability protection',
      'Compliance data modifiable',
    ],
    fixHint: 'Apply ReadOnly locks or configure immutable blob storage for compliance requirements.',
  },
  {
    id: 'CIS-AZ-9.3.11',
    title: 'Ensure Geo-Redundant Storage Is Used for Critical Data',
    severity: 'Medium',
    cloudProvider: 'Azure',
    framework: 'CIS Benchmark',
    category: 'storage',
    whatToCheck: 'Verify geo-redundant storage (GRS/GZRS) is used for critical data.',
    whyItMatters: 'Geo-redundancy protects against regional failures and ensures data durability.',
    consoleSteps: [
      'Go to Storage Account → Overview',
      'Check replication type',
      'Verify GRS, RA-GRS, GZRS, or RA-GZRS',
    ],
    cliCheck: 'az storage account show --name <account> --query "sku.name"',
    expectedConfig: 'Critical storage using GRS, RA-GRS, GZRS, or RA-GZRS replication.',
    commonMisconfigs: [
      'LRS for critical data',
      'No geo-redundancy',
      'Cost optimization over durability',
    ],
    fixHint: 'Change replication type to GRS or GZRS for critical data storage accounts.',
  },
];
